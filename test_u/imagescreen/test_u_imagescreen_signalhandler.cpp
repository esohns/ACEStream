...
Stream_ImageScreen_SignalHandler::Stream_ImageScreen_SignalHandler (enum Common_SignalDispatchType dispatchMode_in,
                                                            ACE_SYNCH_RECURSIVE_MUTEX* lock_in)
: inherited (dispatchMode_in,
             lock_in,
             this) // event handler handle
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_SignalHandler::Stream_ImageScreen_SignalHandler"));

}

void
Stream_ImageScreen_SignalHandler::handle (const struct Common_Signal& signal_in)
{
