...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
         struct Stream_ImageScreen_DirectShow_Configuration& directShowConfiguration_in,
         struct Stream_ImageScreen_MediaFoundation_Configuration& mediaFoundationConfiguration_in,
#else
         struct Stream_ImageScreen_Configuration& configuration_in,
#endif // ACE_WIN32 || ACE_WIN64
#if defined (GUI_SUPPORT)
         const std::string& UIDefinitionFilename_in,
#if defined (ACE_WIN32) || defined (ACE_WIN64)
         struct Stream_ImageScreen_DirectShow_UI_CBData& directShowCBData_in,
         struct Stream_ImageScreen_MediaFoundation_UI_CBData& mediaFoundationCBData_in,
#else
         struct Stream_ImageScreen_V4L_UI_CBData& CBData_in,
#endif // ACE_WIN32 || ACE_WIN64
#if defined (WXWIDGETS_USE)
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  struct Stream_ImageScreen_DirectShow_ModuleHandlerConfiguration directshow_modulehandler_configuration;
#if defined (GUI_SUPPORT)
  Stream_ImageScreen_DirectShow_EventHandler_t directshow_ui_event_handler (&directShowCBData_in
#if defined (GTK_USE)
                                                                       );
#elif defined (WXWIDGETS_USE)
                                                                        ,iapplication_in);
#endif
#else
  Stream_ImageScreen_DirectShow_EventHandler_t directshow_ui_event_handler;
#endif // GUI_SUPPORT
  struct Stream_ImageScreen_MediaFoundation_ModuleHandlerConfiguration mediafoundation_modulehandler_configuration;
#if defined (GUI_SUPPORT)
  Stream_ImageScreen_MediaFoundation_EventHandler_t mediafoundation_ui_event_handler (&mediaFoundationCBData_in
#if defined (GTK_USE)
                                                                                 );
#elif defined (WXWIDGETS_USE)
                                                                                  ,iapplication_in);
#endif
#else
  Stream_ImageScreen_MediaFoundation_EventHandler_t mediafoundation_ui_event_handler;
#endif // GUI_SUPPORT
#else
  struct Stream_ImageScreen_V4L_ModuleHandlerConfiguration modulehandler_configuration;
  Stream_ImageScreen_V4L_EventHandler_t ui_event_handler (
#if defined (GUI_SUPPORT)
                                                      &CBData_in
#if defined (GTK_USE)
#elif defined (WXWIDGETS_USE)
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  Stream_ImageScreen_DirectShow_StreamConfiguration_t::ITERATOR_T directshow_stream_iterator;
  Stream_ImageScreen_DirectShow_StreamConfiguration_t::ITERATOR_T directshow_stream_iterator_2;
  Stream_ImageScreen_MediaFoundation_StreamConfiguration_t::ITERATOR_T mediafoundation_stream_iterator;
  Stream_ImageScreen_MediaFoundation_StreamConfiguration_t::ITERATOR_T mediafoundation_stream_iterator_2;
...
#else
  Stream_ImageScreen_V4L_StreamConfiguration_t::ITERATOR_T v4l_stream_iterator;
  Stream_ImageScreen_V4L_StreamConfiguration_t::ITERATOR_T v4l_stream_iterator_2;
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  Stream_ImageScreen_DirectShow_MessageAllocator_t directshow_message_allocator (TEST_U_MAX_MESSAGES, // maximum #buffers
                                                                             &heap_allocator,     // heap allocator handle
                                                                             true);               // block ?
  Stream_ImageScreen_DirectShow_Stream directshow_stream;
  Stream_ImageScreen_DirectShow_MessageHandler_Module directshow_message_handler (&directshow_stream,
                                                                              ACE_TEXT_ALWAYS_CHAR (STREAM_MISC_MESSAGEHANDLER_DEFAULT_NAME_STRING));

  Stream_ImageScreen_MediaFoundation_MessageAllocator_t mediafoundation_message_allocator (TEST_U_MAX_MESSAGES, // maximum #buffers
                                                                                       &heap_allocator,     // heap allocator handle
                                                                                       true);               // block ?
  Stream_ImageScreen_MediaFoundation_Stream mediafoundation_stream;
  Stream_ImageScreen_MediaFoundation_MessageHandler_Module mediafoundation_message_handler (&mediafoundation_stream,
                                                                                        ACE_TEXT_ALWAYS_CHAR (STREAM_MISC_MESSAGEHANDLER_DEFAULT_NAME_STRING));
  switch (mediaFramework_in)
  {
    case STREAM_MEDIAFRAMEWORK_DIRECTSHOW:
...
#else
  Stream_ImageScreen_V4L_MessageAllocator_t message_allocator (TEST_U_MAX_MESSAGES, // maximum #buffers
                                                           &heap_allocator,     // heap allocator handle
                                                           true);               // block ?
...
clean:
  ...
  switch (mediaFramework_in)
  {
    ...
    case STREAM_MEDIAFRAMEWORK_MEDIAFOUNDATION:
    {
      Stream_ImageScreen_MediaFoundation_StreamConfiguration_t::ITERATOR_T iterator =
      mediaFoundationConfiguration_in.streamConfiguration.find (ACE_TEXT_ALWAYS_CHAR (""));
           ...
           ACE_TCHAR* argv_in[])
{
  ...
  // step1a set defaults
  //unsigned int buffer_size = TEST_U_Stream_ImageScreen_DEFAULT_BUFFER_SIZE;
  std::string capture_device_identifier;
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  switch (STREAM_LIB_DEFAULT_MEDIAFRAMEWORK)
  {
...
#if defined (GUI_SUPPORT)
  struct Stream_ImageScreen_UI_CBData* ui_cb_data_p = NULL;
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  struct Stream_ImageScreen_DirectShow_Configuration directshow_configuration;
  struct Stream_ImageScreen_DirectShow_UI_CBData directshow_ui_cb_data;
  struct Stream_ImageScreen_MediaFoundation_Configuration mediafoundation_configuration;
  struct Stream_ImageScreen_MediaFoundation_UI_CBData mediafoundation_ui_cb_data;
  ...
  struct Stream_ImageScreen_V4L_UI_CBData ui_cb_data;
  ...
  switch (media_framework_e)
  {
    case STREAM_MEDIAFRAMEWORK_DIRECTSHOW:
    {
      ACE_NEW_NORETURN (iapplication_p,
                        Stream_ImageScreen_DirectShow_WxWidgetsApplication_t (toplevel_widget_name_string_,
                                                                          argc_in,
                                                                          Common_UI_WxWidgets_Tools::convertArgV (argc_in, argv_in),
                                                                          COMMON_UI_WXWIDGETS_APP_CMDLINE_DEFAULT_PARSE));
      Stream_ImageScreen_DirectShow_WxWidgetsApplication_t::IINITIALIZE_T* iinitialize_p =
        dynamic_cast<Stream_ImageScreen_DirectShow_WxWidgetsApplication_t::IINITIALIZE_T*> (iapplication_p);
      iinitialize_p->initialize (directshow_ui_cb_data);
      Stream_ImageScreen_DirectShow_WxWidgetsIApplication_t* iapplication_2 =
        dynamic_cast<Stream_ImageScreen_DirectShow_WxWidgetsIApplication_t*> (iapplication_p);
      ACE_ASSERT (iapplication_2);
      Stream_ImageScreen_DirectShow_WxWidgetsApplication_t::STATE_T& state_r =
        const_cast<Stream_ImageScreen_DirectShow_WxWidgetsApplication_t::STATE_T&> (iapplication_2->getR ());
      Stream_ImageScreen_DirectShow_WxWidgetsApplication_t::CONFIGURATION_T& configuration_r =
        const_cast<Stream_ImageScreen_DirectShow_WxWidgetsApplication_t::CONFIGURATION_T&> (iapplication_2->getR_2 ());
      configuration_r.UIState = &state_r;
      ACE_ASSERT (configuration_r.UIState);
      ui_state_p =
        const_cast<Stream_ImageScreen_DirectShow_WxWidgetsApplication_t::CONFIGURATION_T&> (configuration_r).UIState;
      break;
    }
    case STREAM_MEDIAFRAMEWORK_MEDIAFOUNDATION:
    {
      ACE_NEW_NORETURN (iapplication_p,
                        Stream_ImageScreen_MediaFoundation_WxWidgetsApplication_t (toplevel_widget_name_string_,
                                                                               argc_in,
                                                                               Common_UI_WxWidgets_Tools::convertArgV (argc_in,
                                                                                                                       argv_in),
                                                                               COMMON_UI_WXWIDGETS_APP_CMDLINE_DEFAULT_PARSE));
      Stream_ImageScreen_MediaFoundation_WxWidgetsApplication_t::IINITIALIZE_T* iinitialize_p =
        dynamic_cast<Stream_ImageScreen_MediaFoundation_WxWidgetsApplication_t::IINITIALIZE_T*> (iapplication_p);
      iinitialize_p->initialize (mediafoundation_ui_cb_data);
      Stream_ImageScreen_MediaFoundation_WxWidgetsIApplication_t* iapplication_2 =
        dynamic_cast<Stream_ImageScreen_MediaFoundation_WxWidgetsIApplication_t*> (iapplication_p);
      ACE_ASSERT (iapplication_2);
      const Stream_ImageScreen_MediaFoundation_WxWidgetsApplication_t::CONFIGURATION_T& configuration_r =
        iapplication_2->getR_2 ();
      ACE_ASSERT (configuration_r.UIState);
      ui_state_p =
        const_cast<Stream_ImageScreen_MediaFoundation_WxWidgetsApplication_t::CONFIGURATION_T&> (configuration_r).UIState;
      break;
    }
    default:
    {
...
//  GError* error_p = NULL;
  ...
  css_profile_path += ACE_DIRECTORY_SEPARATOR_STR;
  css_profile_path +=ACE_TEXT_ALWAYS_CHAR (TEST_U_Stream_ImageScreen_UI_CSS_FILE);
...
//                                             GTK_STYLE_PROVIDER_PRIORITY_APPLICATION);
  ...
  ACE_NEW_NORETURN (iapplication_p,
                    Stream_ImageScreen_V4L_WxWidgetsApplication_t (toplevel_widget_name_string_,
                                                               argc_in,
                                                               Common_UI_WxWidgets_Tools::convertArgV (argc_in,
                                                                                                       argv_in),
                                                               COMMON_UI_WXWIDGETS_APP_CMDLINE_DEFAULT_PARSE));
  Stream_ImageScreen_V4L_WxWidgetsApplication_t::IINITIALIZE_T* iinitialize_p =
    dynamic_cast<Stream_ImageScreen_V4L_WxWidgetsApplication_t::IINITIALIZE_T*> (iapplication_p);
  // *NOTE*: this sets ui_cb_data.UIState
  iinitialize_p->initialize (ui_cb_data);
  Stream_ImageScreen_V4L_WxWidgetsIApplication_t* iapplication_2 =
    dynamic_cast<Stream_ImageScreen_V4L_WxWidgetsIApplication_t*> (iapplication_p);
  ACE_ASSERT (iapplication_2);
  const Stream_ImageScreen_V4L_WxWidgetsApplication_t::CONFIGURATION_T& configuration_r =
    iapplication_2->getR_2 ();
  ACE_ASSERT (configuration_r.UIState);
  ui_state_p =
    const_cast<Stream_ImageScreen_V4L_WxWidgetsApplication_t::CONFIGURATION_T&> (configuration_r).UIState;
#endif // ACE_WIN32 || ACE_WIN64
  if (!iapplication_p)
  {
    ACE_DEBUG ((LM_CRITICAL,
