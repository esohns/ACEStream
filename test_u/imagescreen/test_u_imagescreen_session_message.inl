...
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_SessionMessage_T::duplicate"));

  OWN_TYPE_T* message_p = NULL;

  // create a new <Stream_ImageScreen_SessionMessage_T> that contains unique copies of
  ...
  // *WARNING*: the allocator returns a Stream_ImageScreen_SessionMessage_Base_T<ConfigurationType>
