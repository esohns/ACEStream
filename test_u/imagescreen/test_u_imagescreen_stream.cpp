...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Stream_ImageScreen_DirectShow_Stream::Stream_ImageScreen_DirectShow_Stream ()
 : inherited ()
 , source_ (this,
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_DirectShow_Stream::Stream_ImageScreen_DirectShow_Stream"));
...
bool
Stream_ImageScreen_DirectShow_Stream::load (Stream_ModuleList_t& modules_out,
                                        bool& delete_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_DirectShow_Stream::load"));
...
bool
Stream_ImageScreen_DirectShow_Stream::initialize (const inherited::CONFIGURATION_T& configuration_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_DirectShow_Stream::initialize"));
  ...
  Stream_ImageScreen_DirectShow_SessionData* session_data_p = NULL;
  inherited::CONFIGURATION_T::ITERATOR_T iterator, iterator_2;
  Stream_ImageScreen_DirectShow_Source* source_impl_p = NULL;
...
continue_:
  ...
  session_data_p =
    &const_cast<Stream_ImageScreen_DirectShow_SessionData&> (inherited::sessionData_->getR ());
  ...
  // ******************* Camera Source ************************
  source_impl_p =
    dynamic_cast<Stream_ImageScreen_DirectShow_Source*> (source_.writer ());
  if (!source_impl_p)
  {
    ACE_DEBUG ((LM_ERROR,
...
Stream_ImageScreen_MediaFoundation_Stream::Stream_ImageScreen_MediaFoundation_Stream ()
 : inherited ()
 , source_ (this,
 ...
 , referenceCount_ (1)
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_MediaFoundation_Stream::Stream_ImageScreen_MediaFoundation_Stream"));
...
Stream_ImageScreen_MediaFoundation_Stream::find (const std::string& name_in) const
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_MediaFoundation_Stream::find"));

  //if (!ACE_OS::strcmp (name_in.c_str (),
  //                     ACE_TEXT_ALWAYS_CHAR (STREAM_VIS_RENDERER_NULL_MODULE_NAME)))
  //  return const_cast<Stream_ImageScreen_MediaFoundation_DisplayNull_Module*> (&displayNull_);

  return inherited::find (name_in);
}

void
Stream_ImageScreen_MediaFoundation_Stream::start ()
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_MediaFoundation_Stream::start"));
...
void
Stream_ImageScreen_MediaFoundation_Stream::stop (bool waitForCompletion_in,
                                             bool recurseUpstream_in,
                                             bool lockedAccess_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_MediaFoundation_Stream::stop"));
...
HRESULT
Stream_ImageScreen_MediaFoundation_Stream::QueryInterface (const IID& IID_in,
                                                       void** interface_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_MediaFoundation_Stream::QueryInterface"));

  static const QITAB query_interface_table[] =
  {
    QITABENT (Stream_ImageScreen_MediaFoundation_Stream, IMFAsyncCallback),
    { 0 },
  };
...
ULONG
Stream_ImageScreen_MediaFoundation_Stream::AddRef ()
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_MediaFoundation_Stream::AddRef"));

  return InterlockedIncrement (&referenceCount_);
}
ULONG
Stream_ImageScreen_MediaFoundation_Stream::Release ()
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_MediaFoundation_Stream::Release"));
...
HRESULT
Stream_ImageScreen_MediaFoundation_Stream::GetParameters (DWORD* flags_out,
                                                      DWORD* queue_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_MediaFoundation_Stream::GetParameters"));
...
HRESULT
Stream_ImageScreen_MediaFoundation_Stream::Invoke (IMFAsyncResult* result_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_MediaFoundation_Stream::Invoke"));
  ...
  //Stream_ImageScreen_SessionData& session_data_r =
  //  const_cast<Stream_ImageScreen_SessionData&> (inherited::sessionData_->get ());
...
bool
Stream_ImageScreen_MediaFoundation_Stream::load (Stream_ModuleList_t& modules_out,
                                             bool& delete_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_MediaFoundation_Stream::load"));
...
bool
Stream_ImageScreen_MediaFoundation_Stream::initialize (const inherited::CONFIGURATION_T& configuration_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_MediaFoundation_Stream::initialize"));
  ...
  bool setup_pipeline = configuration_in.configuration_.setupPipeline;
  bool reset_setup_pipeline = false;
  Stream_ImageScreen_MediaFoundation_SessionData* session_data_p = NULL;
  inherited::CONFIGURATION_T::ITERATOR_T iterator;
  struct Stream_ImageScreen_MediaFoundation_ModuleHandlerConfiguration* configuration_p =
    NULL;
  Stream_ImageScreen_MediaFoundation_Source* source_impl_p = NULL;
  ...
  session_data_p =
    &const_cast<Stream_ImageScreen_MediaFoundation_SessionData&> (inherited::sessionData_->getR ());
  iterator =
      const_cast<inherited::CONFIGURATION_T&> (configuration_in).find (ACE_TEXT_ALWAYS_CHAR (""));
  ...
  configuration_p =
      dynamic_cast<struct Stream_ImageScreen_MediaFoundation_ModuleHandlerConfiguration*> (&(*iterator).second.second);
  ...
  // ******************* Camera Source ************************
  source_impl_p =
    dynamic_cast<Stream_ImageScreen_MediaFoundation_Source*> (source_.writer ());
  if (!source_impl_p)
  {
    ACE_DEBUG ((LM_ERROR,
...
#else
Stream_ImageScreen_V4L_Stream::Stream_ImageScreen_V4L_Stream ()
 : inherited ()
 , source_ (this,
...
//                     ACE_TEXT_ALWAYS_CHAR (STREAM_VIS_GTK_CAIRO_DEFAULT_NAME_STRING))
 ...
 , fileWriter_ (this,
                ACE_TEXT_ALWAYS_CHAR (MODULE_FILE_SINK_DEFAULT_NAME_STRING))
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_V4L_Stream::Stream_ImageScreen_V4L_Stream"));
...
bool
Stream_ImageScreen_V4L_Stream::load (typename inherited::LAYOUT_T& layout_inout,
                                 bool& delete_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_V4L_Stream::load"));
...
bool
Stream_ImageScreen_V4L_Stream::initialize (const typename inherited::CONFIGURATION_T& configuration_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_ImageScreen_V4L_Stream::initialize"));
  ...
  bool setup_pipeline = configuration_in.configuration_.setupPipeline;
  bool reset_setup_pipeline = false;
  Stream_ImageScreen_V4L_SessionData* session_data_p = NULL;
  typename inherited::CONFIGURATION_T::ITERATOR_T iterator;
  struct Stream_ImageScreen_V4L_ModuleHandlerConfiguration* configuration_p = NULL;
  Stream_ImageScreen_V4L_Source* source_impl_p = NULL;
  ...
  session_data_p =
    &const_cast<Stream_ImageScreen_V4L_SessionData&> (inherited::sessionData_->getR ());
  iterator =
  ...
  configuration_p =
      dynamic_cast<struct Stream_ImageScreen_V4L_ModuleHandlerConfiguration*> (&(*iterator).second.second);
...
//  session_data_p->format = configuration_p->inputFormat;
  ...
  // ******************* Camera Source ************************
  source_impl_p =
    dynamic_cast<Stream_ImageScreen_V4L_Source*> (source_.writer ());
  if (!source_impl_p)
  {
    ACE_DEBUG ((LM_ERROR,
