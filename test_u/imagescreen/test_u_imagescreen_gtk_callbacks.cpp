...
void
set_capture_format (struct Stream_ImageScreen_UI_CBData* CBData_in)
{
  ...
  Stream_ImageScreen_V4L_StreamConfiguration_t::ITERATOR_T iterator_2 =
...
void
update_buffer_size (struct Stream_ImageScreen_UI_CBData* CBData_in)
{
...
#else
  struct Stream_ImageScreen_V4L_UI_CBData* ui_cb_data_p =
    static_cast<struct Stream_ImageScreen_V4L_UI_CBData*> (CBData_in);
...
stream_processing_function (void* arg_in)
{
  ...
  const Stream_ImageScreen_DirectShow_SessionData_t* directshow_session_data_container_p =
    NULL;
  const Stream_ImageScreen_DirectShow_SessionData* directshow_session_data_p = NULL;
...
//    ACE_ASSERT (progress_bar_p);
  ...
  {
    ACE_DEBUG ((LM_ERROR,
                ACE_TEXT ("failed to Stream_ImageScreen_Stream::initialize(), aborting\n")));
    goto error;
  } // end IF
...
idle_initialize_UI_cb (gpointer userData_in)
{
  ...
  switch (ui_cb_data_base_p->mediaFramework)
  {
    ...
    {
      directshow_cb_data_p =
        static_cast<struct Stream_ImageScreen_DirectShow_UI_CBData*> (ui_cb_data_base_p);
      ACE_ASSERT (directshow_cb_data_p->configuration);
      directshow_stream_iterator =
        directshow_cb_data_p->configuration->streamConfiguration.find (ACE_TEXT_ALWAYS_CHAR (""));
      ACE_ASSERT (directshow_stream_iterator != directshow_cb_data_p->configuration->streamConfiguration.end ());
      directshow_stream_iterator_2 =
        directshow_cb_data_p->configuration->streamConfiguration.find (ACE_TEXT_ALWAYS_CHAR (Stream_Visualization_Tools::rendererToModuleName (directshow_cb_data_p->configuration->streamConfiguration.configuration_.renderer).c_str ()));
    ...
    {
      mediafoundation_cb_data_p =
        static_cast<struct Stream_ImageScreen_MediaFoundation_UI_CBData*> (ui_cb_data_base_p);
      ACE_ASSERT (mediafoundation_cb_data_p->configuration);
      mediafoundation_stream_iterator =
        mediafoundation_cb_data_p->configuration->streamConfiguration.find (ACE_TEXT_ALWAYS_CHAR (""));
      ACE_ASSERT (mediafoundation_stream_iterator != mediafoundation_cb_data_p->configuration->streamConfiguration.end ());
      mediafoundation_stream_iterator_2 =
        mediafoundation_cb_data_p->configuration->streamConfiguration.find (ACE_TEXT_ALWAYS_CHAR (Stream_Visualization_Tools::rendererToModuleName (mediafoundation_cb_data_p->configuration->streamConfiguration.configuration_.renderer).c_str ()));
...
#else
  struct Stream_ImageScreen_V4L_UI_CBData* ui_cb_data_p =
    static_cast<struct Stream_ImageScreen_V4L_UI_CBData*> (ui_cb_data_base_p);
  ACE_ASSERT (ui_cb_data_p->configuration);
  Stream_ImageScreen_V4L_StreamConfiguration_t::ITERATOR_T iterator_2 =
    ui_cb_data_p->configuration->streamConfiguration.find (ACE_TEXT_ALWAYS_CHAR (""));
  ACE_ASSERT (iterator_2 != ui_cb_data_p->configuration->streamConfiguration.end ());
  Stream_ImageScreen_V4L_StreamConfiguration_t::ITERATOR_T iterator_3 =
  ...
  GtkToggleAction* toggle_action_p =
    GTK_TOGGLE_ACTION (gtk_builder_get_object ((*iterator).second.second,
                                               ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_TOGGLEACTION_SAVE_NAME)));
...
//  } // end lock scope
  ...
  GtkAction* action_p =
    GTK_ACTION (gtk_builder_get_object ((*iterator).second.second,
                                        ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_ACTION_CUT_NAME)));
  ACE_ASSERT (action_p);
...
#else
  struct Stream_ImageScreen_V4L_UI_CBData* ui_cb_data_p =
    static_cast<struct Stream_ImageScreen_V4L_UI_CBData*> (userData_in);
  ACE_ASSERT (ui_cb_data_p->configuration);
  Stream_ImageScreen_V4L_StreamConfiguration_t::ITERATOR_T iterator_2 =
    ui_cb_data_p->configuration->streamConfiguration.find (ACE_TEXT_ALWAYS_CHAR (""));
  ACE_ASSERT (iterator_2 != ui_cb_data_p->configuration->streamConfiguration.end ());
...
idle_session_end_cb (gpointer userData_in)
{
  ...
  GtkToggleAction* toggle_action_p =
    GTK_TOGGLE_ACTION (gtk_builder_get_object ((*iterator).second.second,
                                               ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_TOGGLEACTION_RECORD_NAME)));
  ACE_ASSERT (toggle_action_p);
  ...
  action_p =
    GTK_ACTION (gtk_builder_get_object ((*iterator).second.second,
                                        ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_ACTION_SNAPSHOT_NAME)));
  ACE_ASSERT (action_p);
  gtk_action_set_sensitive (action_p, false);
#elif GTK_CHECK_VERSION(2,0,0)
  GtkButton* button_p =
...
//                  ACE_TEXT (TEST_U_Stream_ImageScreen_THREAD_NAME));
...
//  Stream_ImageScreen_UI_CBData* data_p =
