...
#ifndef __TEST_U_IMAGESCREEN_UI_BASE_H__
#define __TEST_U_IMAGESCREEN_UI_BASE_H__
...
class dialog_main : public wxDialog 
{
    ...
    dialog_main( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("imagescreen"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 637,467 ), long style = wxCAPTION|wxDIALOG_NO_PARENT|wxMAXIMIZE_BOX|wxMINIMIZE_BOX|wxRESIZE_BORDER );
		~dialog_main();
	
};

#endif //__TEST_U_IMAGESCREEN_UI_BASE_H__
