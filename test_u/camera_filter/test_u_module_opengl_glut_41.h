...
#ifndef Test_U_CameraFilter_OpenGL_GLUT_41_H
#define Test_U_CameraFilter_OpenGL_GLUT_41_H
...
extern void camera_filter_glut_41_reshape (int, int);
extern void camera_filter_glut_41_key (unsigned char, int, int);
extern void camera_filter_glut_41_mouse_button (int, int, int, int);
extern void camera_filter_glut_41_mouse_move (int, int);
extern void camera_filter_glut_41_draw (void);
extern void camera_filter_glut_41_idle (void);
extern void camera_filter_glut_41_close (void);
extern void camera_filter_glut_41_visible (int);
extern void camera_filter_glut_41_timer (int);

extern const char libacestream_default_module_opengl_glut_41_name_string[];

struct Test_U_CameraFilter_OpenGL_GLUT_41_WindowData
{
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
class Test_U_CameraFilter_OpenGL_GLUT_41
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
#endif // ACE_WIN32 || ACE_WIN64
{
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  Test_U_CameraFilter_OpenGL_GLUT_41 (ISTREAM_T*); // stream handle
#else
  Test_U_CameraFilter_OpenGL_GLUT_41 (typename inherited::ISTREAM_T*); // stream handle
#endif // ACE_WIN32 || ACE_WIN64
  inline virtual ~Test_U_CameraFilter_OpenGL_GLUT_41 () {}
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_41 ())
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_41 (const Test_U_CameraFilter_OpenGL_GLUT_41&))
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_41& operator= (const Test_U_CameraFilter_OpenGL_GLUT_41&))

  // helper methods
  virtual int svc (void);

  struct Test_U_CameraFilter_OpenGL_GLUT_41_WindowData CBData_;
  bool                                                 inSession_;
...
DATASTREAM_MODULE_INPUT_ONLY (Test_U_CameraFilter_DirectShow_SessionData,                       // session data type
                              ...
                              libacestream_default_module_opengl_glut_41_name_string,
                              Stream_INotify_t,                                                 // stream notification interface type
                              Test_U_CameraFilter_OpenGL_GLUT_41);                               // writer type
#else
