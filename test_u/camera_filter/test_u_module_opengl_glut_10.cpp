...
const char libacestream_default_module_opengl_glut_10_name_string[] =
  ACE_TEXT_ALWAYS_CHAR ("OpenGL_GLUT 10");

#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_10::Test_U_CameraFilter_OpenGL_GLUT_10 (ISTREAM_T* stream_in)
#else
Test_U_CameraFilter_OpenGL_GLUT_10::Test_U_CameraFilter_OpenGL_GLUT_10 (typename inherited::ISTREAM_T* stream_in)
 ...
 , window_ (0)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_10::Test_U_CameraFilter_OpenGL_GLUT_10"));
...
bool
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_10::initialize (const struct Test_U_CameraFilter_DirectShow_ModuleHandlerConfiguration& configuration_in,
#else
Test_U_CameraFilter_OpenGL_GLUT_10::initialize (const struct Test_U_CameraFilter_V4L_ModuleHandlerConfiguration& configuration_in,
#endif // ACE_WIN32 || ACE_WIN64
                                               Stream_IAllocator* allocator_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_10::initialize"));
...
void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_10::handleDataMessage (Test_U_DirectShow_Message_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_10::handleDataMessage (Test_U_Message_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                      bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_10::handleDataMessage"));

}

void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_10::handleSessionMessage (Test_U_DirectShow_SessionMessage_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_10::handleSessionMessage (Test_U_SessionMessage_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                         bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_10::handleSessionMessage"));
  ...
  switch (message_inout->type ())
  {
    case STREAM_SESSION_MESSAGE_BEGIN:
    {
      ...
      window_ = glutCreateWindow ("OpenGL GLUT 10");
      ...
      if (!CBData_.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR (TEST_U_VERTEX_SHADER_10_FILENAME),
                                        ACE_TEXT_ALWAYS_CHAR (TEST_U_FRAGMENT_SHADER_10_FILENAME)))
      {
        ACE_DEBUG ((LM_ERROR,
      ...
      glutCloseFunc (camera_filter_glut_10_close);
      glutDisplayFunc (camera_filter_glut_10_draw);
      glutReshapeFunc (camera_filter_glut_10_reshape);
      glutVisibilityFunc (camera_filter_glut_10_visible);
      glutKeyboardFunc (camera_filter_glut_10_key);
      glutMouseFunc (camera_filter_glut_10_mouse_button);
      glutMotionFunc (camera_filter_glut_10_mouse_move);
      glutPassiveMotionFunc (camera_filter_glut_10_mouse_move);
      glutTimerFunc (100, camera_filter_glut_10_timer, 0);
...
int
Test_U_CameraFilter_OpenGL_GLUT_10::svc (void)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_10::svc"));
...
void
camera_filter_glut_10_reshape (int width_in, int height_in)
{
  glViewport (0, 0,
...
void
camera_filter_glut_10_key (unsigned char key_in, int x_in, int y_in)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_10_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_10_WindowData*> (glutGetWindowData ());
...
void
camera_filter_glut_10_mouse_button (int button, int state, int x, int y)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_10_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_10_WindowData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
camera_filter_glut_10_mouse_move (int x, int y)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_10_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_10_WindowData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
camera_filter_glut_10_draw (void)
{
...
void
camera_filter_glut_10_idle (void)
{
  //glutPostRedisplay ();
}

void
camera_filter_glut_10_close ()
{ // pressing the 'x' is the same as hitting 'Escape'
  camera_filter_glut_10_key (27, 0, 0);
}

void
camera_filter_glut_10_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (camera_filter_glut_10_idle);
  else
    glutIdleFunc (NULL);
}

void
camera_filter_glut_10_timer (int v)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_10_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_10_WindowData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
  ...
  glutTimerFunc (1000 / 60, camera_filter_glut_10_timer, v);
}
