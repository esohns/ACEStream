...
#ifndef Test_U_CameraFilter_OpenGL_GLUT_7_H
#define Test_U_CameraFilter_OpenGL_GLUT_7_H
...
extern void camera_filter_glut_7_reshape (int, int);
extern void camera_filter_glut_7_key (unsigned char, int, int);
extern void camera_filter_glut_7_mouse_button (int, int, int, int);
extern void camera_filter_glut_7_mouse_move (int, int);
extern void camera_filter_glut_7_draw (void);
extern void camera_filter_glut_7_idle (void);
extern void camera_filter_glut_7_close (void);
extern void camera_filter_glut_7_visible (int);

extern const char libacestream_default_module_opengl_glut_7_name_string[];

struct Test_U_CameraFilter_OpenGL_GLUT_7_WindowData
{
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
#error missing implementation, aborting
  ...
  GLint                                              channel1Loc;
  GLint                                              channel2Loc;
  GLint                                              channelResolutionLoc;
};

class Test_U_CameraFilter_OpenGL_GLUT_7
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
#endif // ACE_WIN32 || ACE_WIN64
{
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  Test_U_CameraFilter_OpenGL_GLUT_7 (ISTREAM_T*); // stream handle
#else
   Test_U_CameraFilter_OpenGL_GLUT_7 (typename inherited::ISTREAM_T*); // stream handle
#endif // ACE_WIN32 || ACE_WIN64
  inline virtual ~Test_U_CameraFilter_OpenGL_GLUT_7 () {}
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_7 ())
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_7 (const Test_U_CameraFilter_OpenGL_GLUT_7&))
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_7& operator= (const Test_U_CameraFilter_OpenGL_GLUT_7&))

  // helper methods
  virtual int svc (void);

  struct Test_U_CameraFilter_OpenGL_GLUT_7_WindowData CBData_;
  bool                                                inSession_;
...
DATASTREAM_MODULE_INPUT_ONLY (Test_U_CameraFilter_DirectShow_SessionData,                       // session data type
                              ...
                              libacestream_default_module_opengl_glut_7_name_string,
                              Stream_INotify_t,                                                 // stream notification interface type
                              Test_U_CameraFilter_OpenGL_GLUT_7);                               // writer type
#else
