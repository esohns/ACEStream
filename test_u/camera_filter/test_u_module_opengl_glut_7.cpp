...
const char libacestream_default_module_opengl_glut_7_name_string[] =
  ACE_TEXT_ALWAYS_CHAR ("OpenGL_GLUT 7");

#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_7::Test_U_CameraFilter_OpenGL_GLUT_7 (ISTREAM_T* stream_in)
#else
Test_U_CameraFilter_OpenGL_GLUT_7::Test_U_CameraFilter_OpenGL_GLUT_7 (typename inherited::ISTREAM_T* stream_in)
 ...
 , window_ (0)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_7::Test_U_CameraFilter_OpenGL_GLUT_7"));
...
bool
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_7::initialize (const struct Test_U_CameraFilter_DirectShow_ModuleHandlerConfiguration& configuration_in,
#else
Test_U_CameraFilter_OpenGL_GLUT_7::initialize (const struct Test_U_CameraFilter_V4L_ModuleHandlerConfiguration& configuration_in,
#endif // ACE_WIN32 || ACE_WIN64
                                               Stream_IAllocator* allocator_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_7::initialize"));
...
void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_7::handleDataMessage (Test_U_DirectShow_Message_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_7::handleDataMessage (Test_U_Message_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                      bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_7::handleDataMessage"));

}

void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_7::handleSessionMessage (Test_U_DirectShow_SessionMessage_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_7::handleSessionMessage (Test_U_SessionMessage_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                         bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_7::handleSessionMessage"));
  ...
  switch (message_inout->type ())
  {
    case STREAM_SESSION_MESSAGE_BEGIN:
    {
      ...
      window_ = glutCreateWindow ("OpenGL GLUT 7");
      ...
      if (!CBData_.texture1.load (ACE_TEXT_ALWAYS_CHAR ("shader_7_channel1.png")))
      {
        ACE_DEBUG ((LM_ERROR,
      ...
      if (!CBData_.texture2.load (ACE_TEXT_ALWAYS_CHAR ("shader_7_channel2.png")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load texture, aborting\n")));
        goto error;
      } // end IF
      CBData_.texture2.bind ();
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
      //glGenerateMipmap (GL_TEXTURE_2D);

      if (!CBData_.shader.loadFromFile (ACE_TEXT_ALWAYS_CHAR (TEST_U_VERTEX_SHADER_7_FILENAME),
                                        ACE_TEXT_ALWAYS_CHAR (TEST_U_FRAGMENT_SHADER_7_FILENAME)))
      {
        ACE_DEBUG ((LM_ERROR,
      ...
      CBData_.channel2Loc =
        glGetUniformLocation (CBData_.shader.id_, ACE_TEXT_ALWAYS_CHAR ("iChannel2"));
      ACE_ASSERT (CBData_.channel2Loc != -1);
      CBData_.channelResolutionLoc =
        glGetUniformLocation (CBData_.shader.id_, ACE_TEXT_ALWAYS_CHAR ("iChannelResolution"));
      ACE_ASSERT (CBData_.channelResolutionLoc != -1);
      ...
      glutCloseFunc (camera_filter_glut_7_close);
      glutDisplayFunc (camera_filter_glut_7_draw);
      glutReshapeFunc (camera_filter_glut_7_reshape);
      glutVisibilityFunc (camera_filter_glut_7_visible);
      glutKeyboardFunc (camera_filter_glut_7_key);
      glutMouseFunc (camera_filter_glut_7_mouse_button);
      glutPassiveMotionFunc (camera_filter_glut_7_mouse_move);
...
int
Test_U_CameraFilter_OpenGL_GLUT_7::svc (void)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_7::svc"));
  ...
  char* myargv[1];
  int myargc = 1;
  myargv[0] = ACE_OS::strdup (ACE_TEXT_ALWAYS_CHAR ("Test_U_CameraFilter_OpenGL_GLUT_7"));
  ACE_ASSERT (myargv[0]);
...
void
camera_filter_glut_7_reshape (int width_in, int height_in)
{
  glViewport (0, 0,
...
void
camera_filter_glut_7_key (unsigned char key_in, int x_in, int y_in)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_7_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_7_WindowData*> (glutGetWindowData ());
...
void
camera_filter_glut_7_mouse_button (int button, int state, int x, int y)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_7_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_7_WindowData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
camera_filter_glut_7_mouse_move (int x, int y)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_7_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_7_WindowData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
camera_filter_glut_7_draw (void)
{
...
#error missing implementation, aborting
  ...
  static GLfloat channel_resolutions_a[6] = {
#if defined (ACE_WIN32) || defined (ACE_WIN64)
    static_cast<GLfloat> (cb_data_p->resolution.cx), static_cast<GLfloat> (cb_data_p->resolution.cy),
#else
    static_cast<GLfloat> (cb_data_p->resolution.width), static_cast<GLfloat> (cb_data_p->resolution.height),
#endif // ACE_WIN32 || ACE_WIN64
    static_cast<GLfloat> (234), static_cast<GLfloat> (121),
    static_cast<GLfloat> (234), static_cast<GLfloat> (122)
  };
  glProgramUniform2fv (cb_data_p->shader.id_, cb_data_p->channelResolutionLoc,
                       3, &channel_resolutions_a[0]);

  // draw render pass to screen
...
void
camera_filter_glut_7_idle (void)
{
  glutPostRedisplay ();
}

void
camera_filter_glut_7_close ()
{ // pressing the 'x' is the same as hitting 'Escape'
  camera_filter_glut_7_key (27, 0, 0);
}

void
camera_filter_glut_7_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (camera_filter_glut_7_idle);
  else
    glutIdleFunc (NULL);
}
