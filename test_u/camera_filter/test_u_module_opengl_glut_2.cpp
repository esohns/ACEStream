...
const char libacestream_default_module_opengl_glut_2_name_string[] =
  ACE_TEXT_ALWAYS_CHAR ("OpenGL_GLUT 2");

#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_2::Test_U_CameraFilter_OpenGL_GLUT_2 (ISTREAM_T* stream_in)
#else
Test_U_CameraFilter_OpenGL_GLUT_2::Test_U_CameraFilter_OpenGL_GLUT_2 (typename inherited::ISTREAM_T* stream_in)
 ...
 , window_ (0)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_2::Test_U_CameraFilter_OpenGL_GLUT_2"));
...
bool
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_2::initialize (const struct Test_U_CameraFilter_DirectShow_ModuleHandlerConfiguration& configuration_in,
#else
Test_U_CameraFilter_OpenGL_GLUT_2::initialize (const struct Test_U_CameraFilter_V4L_ModuleHandlerConfiguration& configuration_in,
#endif // ACE_WIN32 || ACE_WIN64
                                             Stream_IAllocator* allocator_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_2::initialize"));
...
void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_2::handleDataMessage (Test_U_DirectShow_Message_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_2::handleDataMessage (Test_U_Message_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                    bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_2::handleDataMessage"));

}

void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_2::handleSessionMessage (Test_U_DirectShow_SessionMessage_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_2::handleSessionMessage (Test_U_SessionMessage_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                       bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_2::handleSessionMessage"));
  ...
  switch (message_inout->type ())
  {
    case STREAM_SESSION_MESSAGE_BEGIN:
    {
      ...
      if (!Common_GL_Tools::loadAndCompileShaderFile (ACE_TEXT_ALWAYS_CHAR (TEST_U_VERTEX_SHADER_2_FILENAME),
                                                      GL_VERTEX_SHADER,
                                                      vertex_shader_id))
      {
        ACE_DEBUG ((LM_ERROR,
      ...
      if (!Common_GL_Tools::loadAndCompileShaderFile (ACE_TEXT_ALWAYS_CHAR (TEST_U_FRAGMENT_SHADER_2_FILENAME),
                                                      GL_FRAGMENT_SHADER,
                                                      fragment_shader_id))
      {
        ACE_DEBUG ((LM_ERROR,
      ...
      CBData_.resolutionLoc =
        glGetUniformLocation (CBData_.programId, ACE_TEXT_ALWAYS_CHAR ("u_resolution"));
      ACE_ASSERT (CBData_.resolutionLoc != -1);
      CBData_.mouseLoc =
        glGetUniformLocation (CBData_.programId, ACE_TEXT_ALWAYS_CHAR ("u_mouse"));
      //ACE_ASSERT (CBData_.mouseLoc != -1);
      CBData_.timeLoc =
        glGetUniformLocation (CBData_.programId, ACE_TEXT_ALWAYS_CHAR ("u_time"));
      ACE_ASSERT (CBData_.timeLoc != -1);
      CBData_.textureLoc =
        glGetUniformLocation (CBData_.programId, ACE_TEXT_ALWAYS_CHAR ("u_img"));
      ...
      glutCloseFunc (camera_filter_glut_2_close);
      glutDisplayFunc (camera_filter_glut_2_draw);
      glutReshapeFunc (camera_filter_glut_2_reshape);
      glutVisibilityFunc (camera_filter_glut_2_visible);
      glutKeyboardFunc (camera_filter_glut_2_key);
...
int
Test_U_CameraFilter_OpenGL_GLUT_2::svc (void)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_2::svc"));
...
void
camera_filter_glut_2_reshape (int width_in, int height_in)
{
  glViewport (0, 0,
...
void
camera_filter_glut_2_key (unsigned char key_in, int x_in, int y_in)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_2_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_2_WindowData*> (glutGetWindowData ());
...
void
camera_filter_glut_2_draw (void)
{
...
void
camera_filter_glut_2_idle (void)
{
  glutPostRedisplay ();
}

void
camera_filter_glut_2_close ()
{ // pressing the 'x' is the same as hitting 'Escape'
  camera_filter_glut_2_key (27, 0, 0);
}

void
camera_filter_glut_2_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (camera_filter_glut_2_idle);
  else
    glutIdleFunc (NULL);
}
