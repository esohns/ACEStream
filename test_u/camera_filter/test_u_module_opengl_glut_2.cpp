                                                       ...
                                                       bool& passMessageDownstream_out)
{
  ...
  switch (message_inout->type ())
  {
    case STREAM_SESSION_MESSAGE_BEGIN:
    {
      ...
      if (!Common_GL_Tools::loadAndCompileShader (ACE_TEXT_ALWAYS_CHAR (TEST_U_VERTEX_SHADER_2_FILENAME),
                                                  GL_VERTEX_SHADER,
                                                  vertex_shader_id))
      {
        ACE_DEBUG ((LM_ERROR,
      ...
      if (!Common_GL_Tools::loadAndCompileShader (ACE_TEXT_ALWAYS_CHAR (TEST_U_FRAGMENT_SHADER_2_FILENAME),
                                                  GL_FRAGMENT_SHADER,
                                                  fragment_shader_id))
      {
        ACE_DEBUG ((LM_ERROR,
