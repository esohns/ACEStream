...
#ifndef TEST_U_MODULE_SOBEL_FILTER_H
#define TEST_U_MODULE_SOBEL_FILTER_H
...
extern const char libacestream_default_sobel_filter_module_name_string[];

class Test_U_CameraFilter_Sobel_Filter
...
#endif // ACE_WIN32 || ACE_WIN64
{
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  Test_U_CameraFilter_Sobel_Filter (ISTREAM_T*); // stream handle
#else
  Test_U_CameraFilter_Sobel_Filter (typename inherited::ISTREAM_T*); // stream handle
#endif // ACE_WIN32 || ACE_WIN64
  inline virtual ~Test_U_CameraFilter_Sobel_Filter () {}
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_Sobel_Filter ())
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_Sobel_Filter (const Test_U_CameraFilter_Sobel_Filter&))
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_Sobel_Filter& operator= (const Test_U_CameraFilter_Sobel_Filter&))
...
DATASTREAM_MODULE_INPUT_ONLY (Test_U_CameraFilter_DirectShow_SessionData,                       // session data type
                              ...
                              libacestream_default_sobel_filter_module_name_string,
                              Stream_INotify_t,                                                 // stream notification interface type
                              Test_U_CameraFilter_Sobel_Filter);                                // writer type
#else
