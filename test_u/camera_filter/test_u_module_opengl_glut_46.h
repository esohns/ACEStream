...
#ifndef Test_U_CameraFilter_OpenGL_GLUT_46_H
#define Test_U_CameraFilter_OpenGL_GLUT_46_H
...
extern void camera_filter_glut_46_reshape (int, int);
extern void camera_filter_glut_46_key (unsigned char, int, int);
extern void camera_filter_glut_46_mouse_button (int, int, int, int);
extern void camera_filter_glut_46_mouse_move (int, int);
extern void camera_filter_glut_46_draw (void);
extern void camera_filter_glut_46_idle (void);
extern void camera_filter_glut_46_close (void);
extern void camera_filter_glut_46_visible (int);
extern void camera_filter_glut_46_timer (int);

extern const char libacestream_default_module_opengl_glut_46_name_string[];

struct Test_U_CameraFilter_OpenGL_GLUT_46_WindowData
{
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
class Test_U_CameraFilter_OpenGL_GLUT_46
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
#endif // ACE_WIN32 || ACE_WIN64
{
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  Test_U_CameraFilter_OpenGL_GLUT_46 (ISTREAM_T*); // stream handle
#else
  Test_U_CameraFilter_OpenGL_GLUT_46 (typename inherited::ISTREAM_T*); // stream handle
#endif // ACE_WIN32 || ACE_WIN64
  inline virtual ~Test_U_CameraFilter_OpenGL_GLUT_46 () {}
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_46 ())
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_46 (const Test_U_CameraFilter_OpenGL_GLUT_46&))
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_46& operator= (const Test_U_CameraFilter_OpenGL_GLUT_46&))

  // helper methods
  virtual int svc (void);

  struct Test_U_CameraFilter_OpenGL_GLUT_46_WindowData CBData_;
  bool                                                 inSession_;
...
DATASTREAM_MODULE_INPUT_ONLY (Test_U_CameraFilter_DirectShow_SessionData,                       // session data type
                              ...
                              libacestream_default_module_opengl_glut_46_name_string,
                              Stream_INotify_t,                                                 // stream notification interface type
                              Test_U_CameraFilter_OpenGL_GLUT_46);                               // writer type
#else
