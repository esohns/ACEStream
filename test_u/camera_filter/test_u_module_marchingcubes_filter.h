...
#ifndef TEST_U_MODULE_MARCHINGCUBES_FILTER_H
#define TEST_U_MODULE_MARCHINGCUBES_FILTER_H
...
struct acestream_mc_filter_state
{
  uint8_t state;
  float   n1;
  float   n2;
...
extern const char libacestream_default_marchingcubes_filter_module_name_string[];

class Test_U_CameraFilter_MarchingCubes_Filter
 ...
 , public olc::PixelGameEngine
{
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  Test_U_CameraFilter_MarchingCubes_Filter (ISTREAM_T*); // stream handle
#else
  Test_U_CameraFilter_MarchingCubes_Filter (typename inherited::ISTREAM_T*); // stream handle
#endif // ACE_WIN32 || ACE_WIN64
  inline virtual ~Test_U_CameraFilter_MarchingCubes_Filter () {}
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_MarchingCubes_Filter ())
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_MarchingCubes_Filter (const Test_U_CameraFilter_MarchingCubes_Filter&))
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_MarchingCubes_Filter& operator= (const Test_U_CameraFilter_MarchingCubes_Filter&))
  ...
  void marchingCubes (glm::vec2&, glm::vec2&, glm::vec2&, glm::vec2&,
                      uint8_t,
...
DATASTREAM_MODULE_INPUT_ONLY (Test_U_CameraFilter_DirectShow_SessionData,                       // session data type
                              ...
                              libacestream_default_marchingcubes_filter_module_name_string,
                              Stream_INotify_t,                                                 // stream notification interface type
                              Test_U_CameraFilter_MarchingCubes_Filter);                                // writer type
#else
