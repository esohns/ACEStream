...
#ifndef Test_U_CameraFilter_OpenGL_GLUT_17_H
#define Test_U_CameraFilter_OpenGL_GLUT_17_H
...
extern void camera_filter_glut_17_reshape (int, int);
extern void camera_filter_glut_17_key (unsigned char, int, int);
extern void camera_filter_glut_17_mouse_button (int, int, int, int);
extern void camera_filter_glut_17_mouse_move (int, int);
extern void camera_filter_glut_17_draw (void);
extern void camera_filter_glut_17_idle (void);
extern void camera_filter_glut_17_close (void);
extern void camera_filter_glut_17_visible (int);
extern void camera_filter_glut_17_timer (int);

extern const char libacestream_default_module_opengl_glut_17_name_string[];

struct Test_U_CameraFilter_OpenGL_GLUT_17_WindowData
{
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
class Test_U_CameraFilter_OpenGL_GLUT_17
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
#endif // ACE_WIN32 || ACE_WIN64
{
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  Test_U_CameraFilter_OpenGL_GLUT_17 (ISTREAM_T*); // stream handle
#else
  Test_U_CameraFilter_OpenGL_GLUT_17 (typename inherited::ISTREAM_T*); // stream handle
#endif // ACE_WIN32 || ACE_WIN64
  inline virtual ~Test_U_CameraFilter_OpenGL_GLUT_17 () {}
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_17 ())
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_17 (const Test_U_CameraFilter_OpenGL_GLUT_17&))
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_17& operator= (const Test_U_CameraFilter_OpenGL_GLUT_17&))

  // helper methods
  virtual int svc (void);

  struct Test_U_CameraFilter_OpenGL_GLUT_17_WindowData CBData_;
  bool                                                 inSession_;
...
DATASTREAM_MODULE_INPUT_ONLY (Test_U_CameraFilter_DirectShow_SessionData,                       // session data type
                              ...
                              libacestream_default_module_opengl_glut_17_name_string,
                              Stream_INotify_t,                                                 // stream notification interface type
                              Test_U_CameraFilter_OpenGL_GLUT_17);                               // writer type
#else
