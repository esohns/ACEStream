...
const char libacestream_default_module_opengl_glut_5_name_string[] =
  ACE_TEXT_ALWAYS_CHAR ("OpenGL_GLUT 5");

#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_5::Test_U_CameraFilter_OpenGL_GLUT_5 (ISTREAM_T* stream_in)
#else
Test_U_CameraFilter_OpenGL_GLUT_5::Test_U_CameraFilter_OpenGL_GLUT_5 (typename inherited::ISTREAM_T* stream_in)
 ...
 , window_ (0)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_5::Test_U_CameraFilter_OpenGL_GLUT_5"));
...
bool
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_5::initialize (const struct Test_U_CameraFilter_DirectShow_ModuleHandlerConfiguration& configuration_in,
#else
Test_U_CameraFilter_OpenGL_GLUT_5::initialize (const struct Test_U_CameraFilter_V4L_ModuleHandlerConfiguration& configuration_in,
#endif // ACE_WIN32 || ACE_WIN64
                                               Stream_IAllocator* allocator_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_5::initialize"));
...
void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_5::handleDataMessage (Test_U_DirectShow_Message_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_5::handleDataMessage (Test_U_Message_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                      bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_5::handleDataMessage"));

}

void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_5::handleSessionMessage (Test_U_DirectShow_SessionMessage_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_5::handleSessionMessage (Test_U_SessionMessage_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                         bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_5::handleSessionMessage"));
  ...
  switch (message_inout->type ())
  {
    case STREAM_SESSION_MESSAGE_BEGIN:
    {
      ...
      glutCloseFunc (camera_filter_glut_5_close);
      glutDisplayFunc (camera_filter_glut_5_draw);
      glutReshapeFunc (camera_filter_glut_5_reshape);
      glutVisibilityFunc (camera_filter_glut_5_visible);
      glutKeyboardFunc (camera_filter_glut_5_key);
      glutMouseFunc (camera_filter_glut_5_mouse_button);
      glutPassiveMotionFunc (camera_filter_glut_5_mouse_move);
...
int
Test_U_CameraFilter_OpenGL_GLUT_5::svc (void)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_5::svc"));
...
void
camera_filter_glut_5_reshape (int width_in, int height_in)
{
  glViewport (0, 0,
...
void
camera_filter_glut_5_key (unsigned char key_in, int x_in, int y_in)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_5_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_5_WindowData*> (glutGetWindowData ());
...
void
camera_filter_glut_5_mouse_button (int button, int state, int x, int y)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_5_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_5_WindowData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
camera_filter_glut_5_mouse_move (int x, int y)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_5_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_5_WindowData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
camera_filter_glut_5_draw (void)
{
...
void
camera_filter_glut_5_idle (void)
{
  glutPostRedisplay ();
}

void
camera_filter_glut_5_close ()
{ // pressing the 'x' is the same as hitting 'Escape'
  camera_filter_glut_5_key (27, 0, 0);
}

void
camera_filter_glut_5_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (camera_filter_glut_5_idle);
  else
    glutIdleFunc (NULL);
}
