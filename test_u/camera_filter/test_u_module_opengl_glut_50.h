...
#ifndef Test_U_CameraFilter_OpenGL_GLUT_50_H
#define Test_U_CameraFilter_OpenGL_GLUT_50_H
...
extern void camera_filter_glut_50_reshape (int, int);
extern void camera_filter_glut_50_key (unsigned char, int, int);
extern void camera_filter_glut_50_mouse_button (int, int, int, int);
extern void camera_filter_glut_50_mouse_move (int, int);
extern void camera_filter_glut_50_draw (void);
extern void camera_filter_glut_50_idle (void);
extern void camera_filter_glut_50_close (void);
extern void camera_filter_glut_50_visible (int);
extern void camera_filter_glut_50_timer (int);

extern const char libacestream_default_module_opengl_glut_50_name_string[];

struct Test_U_CameraFilter_OpenGL_GLUT_50_WindowData
{
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
class Test_U_CameraFilter_OpenGL_GLUT_50
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
#endif // ACE_WIN32 || ACE_WIN64
{
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  Test_U_CameraFilter_OpenGL_GLUT_50 (ISTREAM_T*); // stream handle
#else
  Test_U_CameraFilter_OpenGL_GLUT_50 (typename inherited::ISTREAM_T*); // stream handle
#endif // ACE_WIN32 || ACE_WIN64
  inline virtual ~Test_U_CameraFilter_OpenGL_GLUT_50 () {}
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_50 ())
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_50 (const Test_U_CameraFilter_OpenGL_GLUT_50&))
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_50& operator= (const Test_U_CameraFilter_OpenGL_GLUT_50&))

  // helper methods
  virtual int svc (void);

  struct Test_U_CameraFilter_OpenGL_GLUT_50_WindowData CBData_;
  bool                                                 inSession_;
...
DATASTREAM_MODULE_INPUT_ONLY (Test_U_CameraFilter_DirectShow_SessionData,                       // session data type
                              ...
                              libacestream_default_module_opengl_glut_50_name_string,
                              Stream_INotify_t,                                                 // stream notification interface type
                              Test_U_CameraFilter_OpenGL_GLUT_50);                               // writer type
#else
