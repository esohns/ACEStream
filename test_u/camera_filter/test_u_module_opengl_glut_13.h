...
#ifndef Test_U_CameraFilter_OpenGL_GLUT_13_H
#define Test_U_CameraFilter_OpenGL_GLUT_13_H
...
extern void camera_filter_glut_13_reshape (int, int);
extern void camera_filter_glut_13_key (unsigned char, int, int);
extern void camera_filter_glut_13_mouse_button (int, int, int, int);
extern void camera_filter_glut_13_mouse_move (int, int);
extern void camera_filter_glut_13_draw (void);
extern void camera_filter_glut_13_idle (void);
extern void camera_filter_glut_13_close (void);
extern void camera_filter_glut_13_visible (int);
extern void camera_filter_glut_13_timer (int);

extern const char libacestream_default_module_opengl_glut_13_name_string[];

struct Test_U_CameraFilter_OpenGL_GLUT_13_WindowData
{
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
class Test_U_CameraFilter_OpenGL_GLUT_13
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
#endif // ACE_WIN32 || ACE_WIN64
{
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  Test_U_CameraFilter_OpenGL_GLUT_13 (ISTREAM_T*); // stream handle
#else
  Test_U_CameraFilter_OpenGL_GLUT_13 (typename inherited::ISTREAM_T*); // stream handle
#endif // ACE_WIN32 || ACE_WIN64
  inline virtual ~Test_U_CameraFilter_OpenGL_GLUT_13 () {}
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_13 ())
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_13 (const Test_U_CameraFilter_OpenGL_GLUT_13&))
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_13& operator= (const Test_U_CameraFilter_OpenGL_GLUT_13&))

  // helper methods
  virtual int svc (void);

  struct Test_U_CameraFilter_OpenGL_GLUT_13_WindowData CBData_;
  bool                                                 inSession_;
...
DATASTREAM_MODULE_INPUT_ONLY (Test_U_CameraFilter_DirectShow_SessionData,                       // session data type
                              ...
                              libacestream_default_module_opengl_glut_13_name_string,
                              Stream_INotify_t,                                                 // stream notification interface type
                              Test_U_CameraFilter_OpenGL_GLUT_13);                               // writer type
#else
