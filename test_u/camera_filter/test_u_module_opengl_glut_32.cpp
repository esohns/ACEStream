...
const char libacestream_default_module_opengl_glut_32_name_string[] =
  ACE_TEXT_ALWAYS_CHAR ("OpenGL_GLUT 32");

#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_32::Test_U_CameraFilter_OpenGL_GLUT_32 (ISTREAM_T* stream_in)
#else
Test_U_CameraFilter_OpenGL_GLUT_32::Test_U_CameraFilter_OpenGL_GLUT_32 (typename inherited::ISTREAM_T* stream_in)
 ...
 , window_ (0)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_32::Test_U_CameraFilter_OpenGL_GLUT_32"));
...
bool
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_32::initialize (const struct Test_U_CameraFilter_DirectShow_ModuleHandlerConfiguration& configuration_in,
#else
Test_U_CameraFilter_OpenGL_GLUT_32::initialize (const struct Test_U_CameraFilter_V4L_ModuleHandlerConfiguration& configuration_in,
#endif // ACE_WIN32 || ACE_WIN64
                                                Stream_IAllocator* allocator_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_32::initialize"));
...
void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_32::handleDataMessage (Test_U_DirectShow_Message_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_32::handleDataMessage (Test_U_Message_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                       bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_32::handleDataMessage"));

}

void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_32::handleSessionMessage (Test_U_DirectShow_SessionMessage_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_32::handleSessionMessage (Test_U_SessionMessage_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                          bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_32::handleSessionMessage"));
  ...
  switch (message_inout->type ())
  {
    case STREAM_SESSION_MESSAGE_BEGIN:
    {
      ...
      window_ = glutCreateWindow ("OpenGL GLUT 32");
      ...
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
      glGenTextures (1, &CBData_.textureS3.id_);
      ...
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
      glGenTextures (1, &CBData_.textureS4.id_);
      ...
      //if (!CBData_.texture5.load (ACE_TEXT_ALWAYS_CHAR ("shader_32_S3channel2.png")))
      if (!CBData_.texture5.load (ACE_TEXT_ALWAYS_CHAR ("shader_18_channel1.png"))) // *TODO*: use custom texture
      {
        ACE_DEBUG ((LM_ERROR,
      ...
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
      if (!CBData_.texture7.load (ACE_TEXT_ALWAYS_CHAR ("shader_32_S1channel2.png")))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("failed to load texture, aborting\n")));
        break;
      } // end IF
      CBData_.texture7.bind ();
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
      glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
      glGenerateMipmap (GL_TEXTURE_2D);

      if (!CBData_.shader1.loadFromFile (ACE_TEXT_ALWAYS_CHAR (TEST_U_VERTEX_SHADER_32_1_FILENAME),
                                         ACE_TEXT_ALWAYS_CHAR (TEST_U_FRAGMENT_SHADER_32_1_FILENAME)))
      {
        ACE_DEBUG ((LM_ERROR,
      ...
      if (!CBData_.shader2.loadFromFile (ACE_TEXT_ALWAYS_CHAR (TEST_U_VERTEX_SHADER_32_2_FILENAME),
                                         ACE_TEXT_ALWAYS_CHAR (TEST_U_FRAGMENT_SHADER_32_2_FILENAME)))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("%s: failed to load GL shader, aborting\n"),
                    inherited::mod_->name ()));
      ...
      if (!CBData_.shader3.loadFromFile (ACE_TEXT_ALWAYS_CHAR (TEST_U_VERTEX_SHADER_32_3_FILENAME),
                                         ACE_TEXT_ALWAYS_CHAR (TEST_U_FRAGMENT_SHADER_32_3_FILENAME)))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("%s: failed to load GL shader, aborting\n"),
                    inherited::mod_->name ()));
      ...
      if (!CBData_.shader4.loadFromFile (ACE_TEXT_ALWAYS_CHAR (TEST_U_VERTEX_SHADER_32_4_FILENAME),
                                         ACE_TEXT_ALWAYS_CHAR (TEST_U_FRAGMENT_SHADER_32_4_FILENAME)))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("%s: failed to load GL shader, aborting\n"),
                    inherited::mod_->name ()));
      ...
      if (!CBData_.shader5.loadFromFile (ACE_TEXT_ALWAYS_CHAR (TEST_U_VERTEX_SHADER_32_5_FILENAME),
                                         ACE_TEXT_ALWAYS_CHAR (TEST_U_FRAGMENT_SHADER_32_5_FILENAME)))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("%s: failed to load GL shader, aborting\n"),
                    inherited::mod_->name ()));
      ...
      CBData_.S2frameLoc =
        glGetUniformLocation (CBData_.shader2.id_, ACE_TEXT_ALWAYS_CHAR ("iFrame"));
      ACE_ASSERT (CBData_.S2frameLoc != -1);
      ...
      CBData_.S3frameLoc =
        glGetUniformLocation (CBData_.shader3.id_, ACE_TEXT_ALWAYS_CHAR ("iFrame"));
      ACE_ASSERT (CBData_.S3frameLoc != -1);
      CBData_.S3mouseLoc =
        glGetUniformLocation (CBData_.shader3.id_, ACE_TEXT_ALWAYS_CHAR ("iMouse"));
      //ACE_ASSERT (CBData_.S3mouseLoc != -1);
      ...
      CBData_.S3channel2Loc =
        glGetUniformLocation (CBData_.shader3.id_, ACE_TEXT_ALWAYS_CHAR ("iChannel2"));
      ACE_ASSERT (CBData_.S3channel2Loc != -1);
      CBData_.S3channel3Loc =
        glGetUniformLocation (CBData_.shader3.id_, ACE_TEXT_ALWAYS_CHAR ("iChannel3"));
      ACE_ASSERT (CBData_.S3channel3Loc != -1);

      CBData_.shader4.use ();
      CBData_.S4resolutionLoc =
        glGetUniformLocation (CBData_.shader4.id_, ACE_TEXT_ALWAYS_CHAR ("iResolution"));
      ACE_ASSERT (CBData_.S4resolutionLoc != -1);
      CBData_.S4frameLoc =
        glGetUniformLocation (CBData_.shader4.id_, ACE_TEXT_ALWAYS_CHAR ("iFrame"));
      ACE_ASSERT (CBData_.S4frameLoc != -1);
      CBData_.S4channel2Loc =
        glGetUniformLocation (CBData_.shader4.id_, ACE_TEXT_ALWAYS_CHAR ("iChannel2"));
      ACE_ASSERT (CBData_.S4channel2Loc != -1);
      CBData_.S4channel3Loc =
        glGetUniformLocation (CBData_.shader4.id_, ACE_TEXT_ALWAYS_CHAR ("iChannel3"));
      ACE_ASSERT (CBData_.S4channel3Loc != -1);

      CBData_.shader5.use ();
      CBData_.S5resolutionLoc =
        glGetUniformLocation (CBData_.shader5.id_, ACE_TEXT_ALWAYS_CHAR ("iResolution"));
      ACE_ASSERT (CBData_.S5resolutionLoc != -1);
      CBData_.S5timeLoc =
        glGetUniformLocation (CBData_.shader5.id_, ACE_TEXT_ALWAYS_CHAR ("iTime"));
      ACE_ASSERT (CBData_.S5timeLoc != -1);
      CBData_.S5mouseLoc =
        glGetUniformLocation (CBData_.shader5.id_, ACE_TEXT_ALWAYS_CHAR ("iMouse"));
      ACE_ASSERT (CBData_.S5mouseLoc != -1);
      CBData_.S5channel0Loc =
        glGetUniformLocation (CBData_.shader5.id_, ACE_TEXT_ALWAYS_CHAR ("iChannel0"));
      ACE_ASSERT (CBData_.S5channel0Loc != -1);
      CBData_.S5channel1Loc =
        glGetUniformLocation (CBData_.shader5.id_, ACE_TEXT_ALWAYS_CHAR ("iChannel1"));
      ACE_ASSERT (CBData_.S5channel1Loc != -1);
      CBData_.S5channel2Loc =
        glGetUniformLocation (CBData_.shader5.id_, ACE_TEXT_ALWAYS_CHAR ("iChannel2"));
      ACE_ASSERT (CBData_.S5channel2Loc != -1);
      CBData_.S5channel3Loc =
        glGetUniformLocation (CBData_.shader5.id_, ACE_TEXT_ALWAYS_CHAR ("iChannel3"));
      //ACE_ASSERT (CBData_.S5channel3Loc != -1);
      ...
      glGenFramebuffers (1, &CBData_.FBO3);
      ACE_ASSERT (CBData_.FBO3);
      // draw render pass 3 to framebuffer object (--> textureS3)
      glBindFramebuffer (GL_FRAMEBUFFER, CBData_.FBO3);
      glFramebufferTexture2D (GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, CBData_.textureS3.id_, 0);
      ACE_ASSERT (glCheckFramebufferStatus (GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE);
      glBindFramebuffer (GL_FRAMEBUFFER, 0);

      glGenFramebuffers (1, &CBData_.FBO4);
      ACE_ASSERT (CBData_.FBO4);
      // draw render pass 4 to framebuffer object (--> textureS4)
      glBindFramebuffer (GL_FRAMEBUFFER, CBData_.FBO4);
      glFramebufferTexture2D (GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, CBData_.textureS4.id_, 0);
      ACE_ASSERT (glCheckFramebufferStatus (GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE);
      glBindFramebuffer (GL_FRAMEBUFFER, 0);
      ...
      glutCloseFunc (camera_filter_glut_32_close);
      glutDisplayFunc (camera_filter_glut_32_draw);
      glutReshapeFunc (camera_filter_glut_32_reshape);
      glutVisibilityFunc (camera_filter_glut_32_visible);
      glutKeyboardFunc (camera_filter_glut_32_key);
      glutMouseFunc (camera_filter_glut_32_mouse_button);
      glutMotionFunc (camera_filter_glut_32_mouse_move);
      glutPassiveMotionFunc (camera_filter_glut_32_mouse_move);
...
int
Test_U_CameraFilter_OpenGL_GLUT_32::svc (void)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_32::svc"));
  ...
  char* myargv[1];
  int myargc = 1;
  myargv[0] = ACE_OS::strdup (ACE_TEXT_ALWAYS_CHAR ("Test_U_CameraFilter_OpenGL_GLUT_32"));
  ACE_ASSERT (myargv[0]);
...
void
camera_filter_glut_32_reshape (int width_in, int height_in)
{
  glViewport (0, 0,
...
void
camera_filter_glut_32_key (unsigned char key_in, int x_in, int y_in)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_32_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_32_WindowData*> (glutGetWindowData ());
  ...
  switch (key_in)
  {
    case 27: /* Escape */
    {
      ...
      cb_data_p->shader4.reset ();
      cb_data_p->shader5.reset ();

      cb_data_p->texture0.reset ();
      cb_data_p->textureS1.reset ();
      cb_data_p->textureS2.reset ();
      cb_data_p->textureS3.reset ();
      cb_data_p->textureS4.reset ();
      cb_data_p->texture5.reset ();
      cb_data_p->texture6.reset ();
      cb_data_p->texture7.reset ();

      glDeleteFramebuffers (1, &cb_data_p->FBO1); cb_data_p->FBO1 = 0;
      glDeleteFramebuffers (1, &cb_data_p->FBO2); cb_data_p->FBO2 = 0;
      glDeleteFramebuffers (1, &cb_data_p->FBO3); cb_data_p->FBO3 = 0;
      glDeleteFramebuffers (1, &cb_data_p->FBO4); cb_data_p->FBO4 = 0;
...
void
camera_filter_glut_32_mouse_button (int button, int state, int x, int y)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_32_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_32_WindowData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
camera_filter_glut_32_mouse_move (int x, int y)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_32_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_32_WindowData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
camera_filter_glut_32_draw (void)
{
...
#endif // ACE_WIN32 || ACE_WIN64
                      static_cast<GLfloat> (cb_data_p->mouse_LMB_pressed ? 1 : 0),
                      0.0f);
...
void
camera_filter_glut_32_idle (void)
{
  glutPostRedisplay ();
}

void
camera_filter_glut_32_close ()
{ // pressing the 'x' is the same as hitting 'Escape'
  camera_filter_glut_32_key (27, 0, 0);
}

void
camera_filter_glut_32_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (camera_filter_glut_32_idle);
  else
    glutIdleFunc (NULL);
}
