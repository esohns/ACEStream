...
const char libacestream_default_module_opengl_glut_43_name_string[] =
  ACE_TEXT_ALWAYS_CHAR ("OpenGL_GLUT 43");

#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_43::Test_U_CameraFilter_OpenGL_GLUT_43 (ISTREAM_T* stream_in)
#else
Test_U_CameraFilter_OpenGL_GLUT_43::Test_U_CameraFilter_OpenGL_GLUT_43 (typename inherited::ISTREAM_T* stream_in)
 ...
 , window_ (0)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_43::Test_U_CameraFilter_OpenGL_GLUT_43"));
...
bool
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_43::initialize (const struct Test_U_CameraFilter_DirectShow_ModuleHandlerConfiguration& configuration_in,
#else
Test_U_CameraFilter_OpenGL_GLUT_43::initialize (const struct Test_U_CameraFilter_V4L_ModuleHandlerConfiguration& configuration_in,
#endif // ACE_WIN32 || ACE_WIN64
                                                Stream_IAllocator* allocator_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_43::initialize"));
...
void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_43::handleDataMessage (Test_U_DirectShow_Message_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_43::handleDataMessage (Test_U_Message_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                       bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_43::handleDataMessage"));

}

void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_43::handleSessionMessage (Test_U_DirectShow_SessionMessage_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_43::handleSessionMessage (Test_U_SessionMessage_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                          bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_43::handleSessionMessage"));
  ...
  switch (message_inout->type ())
  {
    case STREAM_SESSION_MESSAGE_BEGIN:
    {
      ...
      window_ = glutCreateWindow ("OpenGL GLUT 43");
      ...
      if (!CBData_.shader1.loadFromFile (ACE_TEXT_ALWAYS_CHAR (TEST_U_VERTEX_SHADER_43_1_FILENAME),
                                         ACE_TEXT_ALWAYS_CHAR (TEST_U_FRAGMENT_SHADER_43_1_FILENAME)))
      {
        ACE_DEBUG ((LM_ERROR,
      ...
      if (!CBData_.shader2.loadFromFile (ACE_TEXT_ALWAYS_CHAR (TEST_U_VERTEX_SHADER_43_2_FILENAME),
                                         ACE_TEXT_ALWAYS_CHAR (TEST_U_FRAGMENT_SHADER_43_2_FILENAME)))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("%s: failed to load GL shader, aborting\n"),
                    inherited::mod_->name ()));
      ...
      if (!CBData_.shader3.loadFromFile (ACE_TEXT_ALWAYS_CHAR (TEST_U_VERTEX_SHADER_43_3_FILENAME),
                                         ACE_TEXT_ALWAYS_CHAR (TEST_U_FRAGMENT_SHADER_43_3_FILENAME)))
      {
        ACE_DEBUG ((LM_ERROR,
                    ACE_TEXT ("%s: failed to load GL shader, aborting\n"),
                    inherited::mod_->name ()));
      ...
      glutCloseFunc (camera_filter_glut_43_close);
      glutDisplayFunc (camera_filter_glut_43_draw);
      glutReshapeFunc (camera_filter_glut_43_reshape);
      glutVisibilityFunc (camera_filter_glut_43_visible);
      glutKeyboardFunc (camera_filter_glut_43_key);
      glutMouseFunc (camera_filter_glut_43_mouse_button);
      glutPassiveMotionFunc (camera_filter_glut_43_mouse_move);
...
int
Test_U_CameraFilter_OpenGL_GLUT_43::svc (void)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_43::svc"));
  ...
  char* myargv[1];
  int myargc = 1;
  myargv[0] = ACE_OS::strdup (ACE_TEXT_ALWAYS_CHAR ("Test_U_CameraFilter_OpenGL_GLUT_43"));
  ACE_ASSERT (myargv[0]);
...
void
camera_filter_glut_43_reshape (int width_in, int height_in)
{
  glViewport (0, 0,
...
void
camera_filter_glut_43_key (unsigned char key_in, int x_in, int y_in)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_43_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_43_WindowData*> (glutGetWindowData ());
...
void
camera_filter_glut_43_mouse_button (int button, int state, int x, int y)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_43_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_43_WindowData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
camera_filter_glut_43_mouse_move (int x, int y)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_43_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_43_WindowData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
camera_filter_glut_43_draw (void)
{
...
void
camera_filter_glut_43_idle (void)
{
  glutPostRedisplay ();
}

void
camera_filter_glut_43_close ()
{ // pressing the 'x' is the same as hitting 'Escape'
  camera_filter_glut_43_key (27, 0, 0);
}

void
camera_filter_glut_43_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (camera_filter_glut_43_idle);
  else
    glutIdleFunc (NULL);
}
