...
const char libacestream_default_module_opengl_glut_4_name_string[] =
  ACE_TEXT_ALWAYS_CHAR ("OpenGL_GLUT 4");

#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_4::Test_U_CameraFilter_OpenGL_GLUT_4 (ISTREAM_T* stream_in)
#else
Test_U_CameraFilter_OpenGL_GLUT_4::Test_U_CameraFilter_OpenGL_GLUT_4 (typename inherited::ISTREAM_T* stream_in)
 ...
 , window_ (0)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_4::Test_U_CameraFilter_OpenGL_GLUT_4"));
...
bool
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_4::initialize (const struct Test_U_CameraFilter_DirectShow_ModuleHandlerConfiguration& configuration_in,
#else
Test_U_CameraFilter_OpenGL_GLUT_4::initialize (const struct Test_U_CameraFilter_V4L_ModuleHandlerConfiguration& configuration_in,
#endif // ACE_WIN32 || ACE_WIN64
                                               Stream_IAllocator* allocator_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_4::initialize"));
...
void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_4::handleDataMessage (Test_U_DirectShow_Message_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_4::handleDataMessage (Test_U_Message_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                      bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_4::handleDataMessage"));

}

void
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Test_U_CameraFilter_OpenGL_GLUT_4::handleSessionMessage (Test_U_DirectShow_SessionMessage_t*& message_inout,
#else
Test_U_CameraFilter_OpenGL_GLUT_4::handleSessionMessage (Test_U_SessionMessage_t*& message_inout,
#endif // ACE_WIN32 || ACE_WIN64
                                                         bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_4::handleSessionMessage"));
  ...
  switch (message_inout->type ())
  {
    case STREAM_SESSION_MESSAGE_BEGIN:
    {
      ...
      window_ = glutCreateWindow ("OpenGL GLUT 4");
      ...
      glutReshapeFunc (camera_filter_glut_4_reshape);
      glutVisibilityFunc (camera_filter_glut_4_visible);
      glutKeyboardFunc (camera_filter_glut_4_key);
      glutPassiveMotionFunc (camera_filter_glut_4_mouse_move);
...
int
Test_U_CameraFilter_OpenGL_GLUT_4::svc (void)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_CameraFilter_OpenGL_GLUT_4::svc"));
...
void
camera_filter_glut_4_reshape (int width_in, int height_in)
{
  glViewport (0, 0,
...
void
camera_filter_glut_4_key (unsigned char key_in, int x_in, int y_in)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_4_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_4_WindowData*> (glutGetWindowData ());
...
void
camera_filter_glut_4_mouse_move (int x, int y)
{
  struct Test_U_CameraFilter_OpenGL_GLUT_4_WindowData* cb_data_p =
    static_cast<struct Test_U_CameraFilter_OpenGL_GLUT_4_WindowData*> (glutGetWindowData ());
  ACE_ASSERT (cb_data_p);
...
void
camera_filter_glut_4_draw (void)
{
...
void
camera_filter_glut_4_idle (void)
{
  glutPostRedisplay ();
}

void
camera_filter_glut_4_close ()
{ // pressing the 'x' is the same as hitting 'Escape'
  camera_filter_glut_4_key (27, 0, 0);
}

void
camera_filter_glut_4_visible (int vis)
{
  if (vis == GLUT_VISIBLE)
    glutIdleFunc (camera_filter_glut_4_idle);
  else
    glutIdleFunc (NULL);
}
