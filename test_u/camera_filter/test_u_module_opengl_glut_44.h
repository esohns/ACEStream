...
#ifndef Test_U_CameraFilter_OpenGL_GLUT_44_H
#define Test_U_CameraFilter_OpenGL_GLUT_44_H
...
extern void camera_filter_glut_44_reshape (int, int);
extern void camera_filter_glut_44_key (unsigned char, int, int);
extern void camera_filter_glut_44_mouse_button (int, int, int, int);
extern void camera_filter_glut_44_mouse_move (int, int);
extern void camera_filter_glut_44_draw (void);
extern void camera_filter_glut_44_idle (void);
extern void camera_filter_glut_44_close (void);
extern void camera_filter_glut_44_visible (int);

extern const char libacestream_default_module_opengl_glut_44_name_string[];

struct Test_U_CameraFilter_OpenGL_GLUT_44_WindowData
{
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
#error missing implementation, aborting
  ...
  Common_GL_Texture                                  texture0; // camera
  Common_GL_Texture                                  textureS1;
  Common_GL_Texture                                  textureS2;
  Common_GL_Texture                                  textureS3;
  Common_GL_Texture                                  textureS4;
  Common_GL_Texture                                  texture5; // random
  Common_GL_Texture                                  texture6; // cubemap
  Common_GL_Texture                                  texture7; // S1channel2
...
class Test_U_CameraFilter_OpenGL_GLUT_44
#if defined (ACE_WIN32) || defined (ACE_WIN64)
...
#endif // ACE_WIN32 || ACE_WIN64
{
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  Test_U_CameraFilter_OpenGL_GLUT_44 (ISTREAM_T*); // stream handle
#else
   Test_U_CameraFilter_OpenGL_GLUT_44 (typename inherited::ISTREAM_T*); // stream handle
#endif // ACE_WIN32 || ACE_WIN64
  inline virtual ~Test_U_CameraFilter_OpenGL_GLUT_44 () {}
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_44 ())
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_44 (const Test_U_CameraFilter_OpenGL_GLUT_44&))
  ACE_UNIMPLEMENTED_FUNC (Test_U_CameraFilter_OpenGL_GLUT_44& operator= (const Test_U_CameraFilter_OpenGL_GLUT_44&))

  // helper methods
  virtual int svc (void);

  struct Test_U_CameraFilter_OpenGL_GLUT_44_WindowData CBData_;
  bool                                                 inSession_;
...
DATASTREAM_MODULE_INPUT_ONLY (Test_U_CameraFilter_DirectShow_SessionData,                       // session data type
                              ...
                              libacestream_default_module_opengl_glut_44_name_string,
                              Stream_INotify_t,                                                 // stream notification interface type
                              Test_U_CameraFilter_OpenGL_GLUT_44);                               // writer type
#else
