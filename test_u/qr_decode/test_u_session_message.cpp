...
Test_U_DirectShow_SessionMessage::Test_U_DirectShow_SessionMessage (Stream_SessionId_t sessionId_in,
                                                                    ...
                                                                    QRDecode_DirectShow_SessionData_t*& sessionData_in,
...
Test_U_DirectShow_SessionMessage::duplicate (void) const
{
  ...
  // *WARNING*: the allocator returns a Test_U_DirectShow_SessionMessageBase<ConfigurationType>
...
Test_U_SessionMessage::Test_U_SessionMessage (Stream_SessionId_t sessionId_in,
                                              enum Stream_SessionMessageType messageType_in,
                                              QRDecode_SessionData_t*& sessionData_in,
                                              struct Stream_UserData* userData_in,
                                              bool expedited_in)
 : inherited (sessionId_in,
              messageType_in,
