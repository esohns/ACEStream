                       ...
                       bool& finished_out)
{
  ...
  renderer_e =
    cb_data_p->configuration->v4l_streamConfiguration.configuration_->renderer;
        ...
        case COMMON_UI_EVENT_RESET:
        {
          ...
          switch (CBData_in->mediaFramework)
          {
            case STREAM_MEDIAFRAMEWORK_DIRECTSHOW:
            {
              ...
              ACE_ASSERT (directshow_cb_data_p->configuration);
              //renderer_e =
              //  directshow_cb_data_p->configuration->v4l_streamConfiguration.configuration_.renderer;
              direct3DConfiguration_p =
                &directshow_cb_data_p->configuration->direct3DConfiguration;
              break;
            }
            case STREAM_MEDIAFRAMEWORK_MEDIAFOUNDATION:
            {
              ...
              ACE_ASSERT (mediafoundation_cb_data_p->configuration);
              //renderer_e =
              //  mediafoundation_cb_data_p->configuration->v4l_streamConfiguration.configuration_.renderer;
              break;
            }
            default:
            {
...
stream_processing_thread (void* arg_in)
{
  ...
  {
    ACE_DEBUG ((LM_ERROR,
                ACE_TEXT ("failed to Stream_CamSave_V4L_Stream::initialize(), aborting\n")));
    goto error;
  } // end IF
...
//wxBEGIN_EVENT_TABLE (Stream_CamSave_V4L_WxWidgetsDialog_t, wxDialog_main)
// EVT_TOGGLEBUTTON (XRCID ("togglebutton_record"), Stream_CamSave_V4L_WxWidgetsDialog_t::togglebutton_record_toggled_cb)
// EVT_BUTTON (XRCID ("button_snapshot"), Stream_CamSave_V4L_WxWidgetsDialog_t::button_snapshot_clicked_cb)
// EVT_BUTTON (XRCID ("button_cut"), Stream_CamSave_V4L_WxWidgetsDialog_t::button_cut_clicked_cb)
//#if defined (_DEBUG)
// EVT_BUTTON (XRCID ("button_report"), Stream_CamSave_V4L_WxWidgetsDialog_t::button_report_clicked_cb)
//#endif // _DEBUG
// EVT_CHOICE (XRCID ("choice_source"), Stream_CamSave_V4L_WxWidgetsDialog_t::choice_source_changed_cb)
// EVT_BUTTON (XRCID ("button_camera_properties"), Stream_CamSave_V4L_WxWidgetsDialog_t::button_camera_properties_clicked_cb)
// EVT_CHOICE (XRCID ("choice_format"), Stream_CamSave_V4L_WxWidgetsDialog_t::choice_format_changed_cb)
// EVT_CHOICE (XRCID ("choice_resolution"), Stream_CamSave_V4L_WxWidgetsDialog_t::choice_resolution_changed_cb)
// EVT_CHOICE (XRCID ("choice_framerate"), Stream_CamSave_V4L_WxWidgetsDialog_t::choice_framerate_changed_cb)
// EVT_BUTTON (XRCID ("button_reset"), Stream_CamSave_V4L_WxWidgetsDialog_t::button_reset_clicked_cb)
...
// EVT_CHOICE (XRCID ("choice_displayadapter"), Stream_CamSave_V4L_WxWidgetsDialog_t::choice_displayadapter_changed_cb)
// EVT_CHOICE (XRCID ("choice_screen"), Stream_CamSave_V4L_WxWidgetsDialog_t::choice_screen_changed_cb)
// EVT_BUTTON (XRCID ("button_display_settings"), Stream_CamSave_V4L_WxWidgetsDialog_t::button_display_settings_clicked_cb)
// EVT_CHOICE (XRCID ("choice_resolution_2"), Stream_CamSave_V4L_WxWidgetsDialog_t::choice_resolution_2_changed_cb)
// EVT_BUTTON (XRCID ("button_about"), Stream_CamSave_V4L_WxWidgetsDialog_t::button_about_clicked_cb)
// EVT_BUTTON (XRCID ("button_quit"), Stream_CamSave_V4L_WxWidgetsDialog_t::button_quit_clicked_cb)
                                 ...
                                 Stream_CamSave_V4L_Stream>::OnInit_2 (IAPPLICATION_T* iapplication_in)
{
  ...
  application_ =
    dynamic_cast<Stream_CamSave_V4L_WxWidgetsIApplication_t*> (iapplication_in);
  ACE_ASSERT (application_);
...
//  directorypicker_save = XRCCTRL (*this, "directorypicker_save", wxDirPickerCtrl);
  ...
  ACE_ASSERT (stream_iterator != cbdata_r.configuration->v4l_streamConfiguration.end ());
  Stream_CamSave_V4L_Stream::CONFIGURATION_T::ITERATOR_T stream_iterator_2 =
  ...
  ACE_ASSERT (stream_iterator_2 != cbdata_r.configuration->v4l_streamConfiguration.end ());
                                 ...
                                 Stream_CamSave_V4L_Stream>::togglebutton_record_toggled_cb (wxCommandEvent& event_in)
{
  ...
  cbdata_r.configuration->v4l_streamConfiguration.configuration_->allocatorConfiguration->defaultBufferSize =
...
//  Common_UI_Resolution_t resolution_s;
//  resolution_s.width =
//      cbdata_r.configuration->v4l_streamConfiguration.configuration_.format.width;
//  resolution_s.height =
//      cbdata_r.configuration->v4l_streamConfiguration.configuration_.format.height;
  ...
  switch (cbdata_r.configuration->v4l_streamConfiguration.configuration_->renderer)
  {
    ...
    default:
    {
      ACE_DEBUG ((LM_ERROR,
                  ...
                  cbdata_r.configuration->v4l_streamConfiguration.configuration_->renderer));
      return;
    }
  } // end SWITCH
                                 ...
                                 Stream_CamSave_V4L_Stream>::choice_source_changed_cb (wxCommandEvent& event_in)
{
  ...
  {
    int result =
      v4l2_close ((*stream_iterator).second.second->deviceIdentifier.fileDescriptor);
  ...
  converter.str (ACE_TEXT_ALWAYS_CHAR (""));
  converter.clear ();
  converter << cbdata_r.configuration->v4l_streamConfiguration.configuration_->format.format.pixelformat;
  index_i =
                                 ...
                                 Stream_CamSave_V4L_Stream>::choice_format_changed_cb (wxCommandEvent& event_in)
{
       ...
       ++iterator)
  {
    ...
    index_i = choice_resolution->Append (converter.str (),
                                         client_data_p);
    if ((cbdata_r.configuration->v4l_streamConfiguration.configuration_->format.format.width == (*iterator).width) &&
        (cbdata_r.configuration->v4l_streamConfiguration.configuration_->format.format.height == (*iterator).height))
                                 ...
                                 Stream_CamSave_V4L_Stream>::choice_resolution_changed_cb (wxCommandEvent& event_in)
{
       ...
       ++iterator)
  {
    ...
    if (cbdata_r.configuration->v4l_streamConfiguration.configuration_->format.frameRate.numerator == *iterator)
                                 ...
                                 Stream_CamSave_V4L_Stream>::choice_framerate_changed_cb (wxCommandEvent& event_in)
{
  ...
  converter.clear ();
  converter.str (client_data_p->GetData ().ToStdString ());
  converter >> cbdata_r.configuration->v4l_streamConfiguration.configuration_->format.format.width;
  converter >> cbdata_r.configuration->v4l_streamConfiguration.configuration_->format.format.height;
  converter.str (ACE_TEXT_ALWAYS_CHAR (""));
  converter.clear ();
  converter.str (choice_framerate->GetString (choice_framerate->GetSelection ()).ToStdString ());
  converter >> cbdata_r.configuration->v4l_streamConfiguration.configuration_->format.frameRate.numerator;
  ...
  spinctrl_framesize->SetValue (Stream_MediaFramework_Tools::frameSize ((*stream_iterator).second.second->deviceIdentifier.identifier,
                                                                        cbdata_r.configuration->v4l_streamConfiguration.configuration_->format));
  ...
  Stream_Device_Tools::getDefaultCaptureFormat ((*stream_iterator).second.second->deviceIdentifier.identifier,
                                                media_type_s);
  button_reset_camera->Enable (!(cbdata_r.configuration->v4l_streamConfiguration.configuration_->format == media_type_s));
}
void
Stream_CamSave_WxWidgetsDialog_T<wxDialog_main,
                                 Stream_CamSave_V4L_WxWidgetsIApplication_t,
...
//                                 Stream_CamSave_V4L_Stream>::picker_directory_save_changed_cb (wxFileDirPickerEvent& event_in)
//{
...
//void
//Stream_CamSave_WxWidgetsDialog_T<Stream_CamSave_V4L_WxWidgetsIApplication_t,
//                                 Stream_CamSave_V4L_Stream>::button_display_settings_clicked_cb (wxCommandEvent& event_in)
//{
                                 ...
                                 Stream_CamSave_V4L_Stream>::button_about_clicked_cb (wxCommandEvent& event_in)
{
  ...
  // sanity check(s)
  ACE_ASSERT (application_);
  Stream_CamSave_V4L_WxWidgetsIApplication_t::STATE_T& state_r =
    const_cast<Stream_CamSave_V4L_WxWidgetsIApplication_t::STATE_T&> (application_->getR ());
