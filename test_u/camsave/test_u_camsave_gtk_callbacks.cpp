...
//  unsigned int buffer_size_i = 0;
  ...
  switch (ui_cb_data_base_p->mediaFramework)
  {
    ...
    { ACE_ASSERT (directshow_cb_data_p);
      ...
      framerate_i =
        static_cast<unsigned int> (std::round (Stream_MediaFramework_DirectShow_Tools::toFramerate (directshow_cb_data_p->configuration->streamConfiguration.configuration_->format)));
      filename_string =
