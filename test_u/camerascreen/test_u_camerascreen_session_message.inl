...
template <typename DataMessageType,
          typename SessionDataType>
Stream_CameraScreen_SessionMessage_T<DataMessageType,
                                     SessionDataType>::Stream_CameraScreen_SessionMessage_T (const Stream_CameraScreen_SessionMessage_T<DataMessageType,
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraScreen_SessionMessage_T::duplicate"));

  OWN_TYPE_T* message_p = NULL;

  // create a new <Stream_CameraScreen_SessionMessage_T> that contains unique copies of
