...
template <typename DataType,
          typename SessionDataType>
Stream_CameraScreen_Message_T<DataType,
                              SessionDataType>::Stream_CameraScreen_Message_T (const OWN_TYPE_T& message_in)
...
template <typename DataType,
          typename SessionDataType>
Stream_CameraScreen_Message_T<DataType,
                              SessionDataType>::~Stream_CameraScreen_Message_T ()
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraScreen_Message_T::~Stream_CameraScreen_Message_T"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraScreen_Message_T::duplicate"));

  OWN_TYPE_T* message_p = NULL;

  // create a new Stream_CameraScreen_Message_T that contains unique copies of
  ...
  if (unlikely (!message_p))
  {
    ...
    if (allocator_p->block ())
      ACE_DEBUG ((LM_CRITICAL,
                  ACE_TEXT ("failed to allocate Stream_CameraScreen_Message_T: \"%m\", aborting\n")));
    return NULL;
  } // end IF
  ...
  if (inherited::cont_)
  {
    ...
    {
      ACE_DEBUG ((LM_ERROR,
                  ACE_TEXT ("failed to Stream_CameraScreen_Message_T::duplicate(): \"%m\", aborting\n")));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraScreen_Message_T::release"));
