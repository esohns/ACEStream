...
#ifndef TEST_U_CAMERACREEN_MESSAGE_H
#define TEST_U_CAMERACREEN_MESSAGE_H
...
//                                   struct Stream_AllocatorConfiguration,
  ...
  friend class Stream_MessageAllocatorHeapBase_T<ACE_MT_SYNCH,
                                                 ...
                                                 Stream_CameraScreen_Message_T<DataType,
                                                                               SessionDataType>,
                                                 Stream_CameraScreen_SessionMessage_T<Stream_CameraScreen_Message_T<DataType,
                                                                                                                    SessionDataType>,
                                                                                      SessionDataType> >;

 public:
  Stream_CameraScreen_Message_T (unsigned int); // size
 ...
 protected:
  ...
  Stream_CameraScreen_Message_T (const OWN_TYPE_T&);
...
#include "test_u_camerascreen_message.inl"
