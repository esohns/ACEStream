...
get_buffer_size (gpointer userData_in)
{
  ...
  combo_box_p =
    GTK_COMBO_BOX (gtk_builder_get_object ((*iterator).second.second,
                                           ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_COMBOBOX_FREQUENCY_NAME)));
  ACE_ASSERT (combo_box_p);
  if (!gtk_combo_box_get_active_iter (combo_box_p,
                                      &iterator_2))
    return 0; // <-- nothing selected
  list_store_p =
    GTK_LIST_STORE (gtk_builder_get_object ((*iterator).second.second,
                                            ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_LISTSTORE_FREQUENCY_NAME)));
  ACE_ASSERT (list_store_p);
  gtk_tree_model_get_value (GTK_TREE_MODEL (list_store_p),
                            &iterator_2,
                            1, &value);
  ...
  combo_box_p =
    GTK_COMBO_BOX (gtk_builder_get_object ((*iterator).second.second,
                                           ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_COMBOBOX_CHANNELS_NAME)));
  ACE_ASSERT (combo_box_p);
  if (!gtk_combo_box_get_active_iter (combo_box_p,
                                      &iterator_2))
    return 0; // <-- nothing selected
  list_store_p =
    GTK_LIST_STORE (gtk_builder_get_object ((*iterator).second.second,
                                            ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_LISTSTORE_CHANNELS_NAME)));
  ACE_ASSERT (list_store_p);
  gtk_tree_model_get_value (GTK_TREE_MODEL (list_store_p),
                            &iterator_2,
                            1, &value);
...
update_buffer_size (gpointer userData_in)
{
  ...
  // sanity check(s)
  struct Test_U_MicVisualize_UI_CBDataBase* data_base_p =
    static_cast<struct Test_U_MicVisualize_UI_CBDataBase*> (userData_in);
...
stream_processing_function (void* arg_in)
{
  ...
  switch (thread_data_base_p->mediaFramework)
  {
    ...
    {
      // sanity check(s)
      struct Test_U_MicVisualize_DirectShow_ThreadData* thread_data_p =
        static_cast<struct Test_U_MicVisualize_DirectShow_ThreadData*> (arg_in);
    ...
    {
      // sanity check(s)
      struct Test_U_MicVisualize_MediaFoundation_ThreadData* thread_data_p =
        static_cast<struct Test_U_MicVisualize_MediaFoundation_ThreadData*> (arg_in);
  ...
  struct Test_U_MicVisualize_ThreadData* thread_data_p =
    static_cast<struct Test_U_MicVisualize_ThreadData*> (arg_in);
...
//    ACE_ASSERT (progress_bar_p);
  ...
  switch (thread_data_base_p->mediaFramework)
  {
    case STREAM_MEDIAFRAMEWORK_DIRECTSHOW:
    {
      Test_U_DirectShow_Stream::IINITIALIZE_T* iinitialize_p =
        dynamic_cast<Test_U_DirectShow_Stream::IINITIALIZE_T*> (directshow_ui_cb_data_p->stream);
    ...
    case STREAM_MEDIAFRAMEWORK_MEDIAFOUNDATION:
    {
      Test_U_MediaFoundation_Stream::IINITIALIZE_T* iinitialize_p =
        dynamic_cast<Test_U_MediaFoundation_Stream::IINITIALIZE_T*> (mediafoundation_ui_cb_data_p->stream);
      ACE_ASSERT (iinitialize_p);
      result_2 =
  ...
  //{
  //  ACE_DEBUG ((LM_ERROR,
  //              ACE_TEXT ("failed to Test_U_MicVisualize_Stream::start(): \"%m\", aborting\n")));
  //  goto done;
  //} // end IF
...
idle_initialize_UI_cb (gpointer userData_in)
{
  ...
  */
  ...
  Test_U_MicVisualize_DirectShow_StreamConfiguration_t::ITERATOR_T directshow_modulehandler_configuration_iterator;
  Test_U_MicVisualize_MediaFoundation_StreamConfiguration_t::ITERATOR_T mediafoundation_modulehandler_configuration_iterator;
  Test_U_MicVisualize_DirectShow_StreamConfiguration_t::ITERATOR_T directshow_modulehandler_configuration_iterator_2; // file writer
  ...
  Test_U_MicVisualize_ALSA_StreamConfiguration_t::ITERATOR_T modulehandler_configuration_iterator_2 = // renderer
  ...
  Test_U_MicVisualize_ALSA_StreamConfiguration_t::ITERATOR_T modulehandler_configuration_iterator_3 = // file writer
  ...
  GtkSpinButton* spin_button_p =
    GTK_SPIN_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                             ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_SPINBUTTON_CAPTUREDSAMPLES_NAME)));
  ACE_ASSERT (spin_button_p);
  ...
  spin_button_p =
    GTK_SPIN_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                             ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_SPINBUTTON_DROPPEDSAMPLES_NAME)));
  ACE_ASSERT (spin_button_p);
  gtk_spin_button_set_range (spin_button_p,
                             0.0,
                             std::numeric_limits<unsigned int>::max ());
  ...
  gtk_list_store_set (list_store_p, &iterator_2,
                      ...
                      1, MICVISUALIZE_SOURCE_DEVICE,
                      -1);
  gtk_list_store_append (list_store_p, &iterator_2);
  gtk_list_store_set (list_store_p, &iterator_2,
                      0, ACE_TEXT_ALWAYS_CHAR ("Noise"),
                      1, MICVISUALIZE_SOURCE_NOISE,
                      -1);
  gtk_list_store_append (list_store_p, &iterator_2);
  gtk_list_store_set (list_store_p, &iterator_2,
                      0, ACE_TEXT_ALWAYS_CHAR ("File"),
                      1, MICVISUALIZE_SOURCE_FILE,
                      -1);
  ...
  list_store_p =
    GTK_LIST_STORE (gtk_builder_get_object ((*iterator).second.second,
                                            ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_LISTSTORE_DEVICE_NAME)));
  ACE_ASSERT (list_store_p);
...
continue_:
  ...
  combo_box_p =
    GTK_COMBO_BOX (gtk_builder_get_object ((*iterator).second.second,
                                           ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_COMBOBOX_DEVICE_NAME)));
  ACE_ASSERT (combo_box_p);
  ...
  //                                        ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_HSCALE_BOOST_NAME)));
  //  ACE_ASSERT (scale_p);
      ...
      case STREAM_MEDIAFRAMEWORK_SOUNDGENERATOR_SAWTOOTH:
        radio_button_p =
          GTK_RADIO_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                    ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_RADIOBUTTON_SAWTOOTH_NAME)));
        break;
      case STREAM_MEDIAFRAMEWORK_SOUNDGENERATOR_SINE:
        radio_button_p =
          GTK_RADIO_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                    ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_RADIOBUTTON_SINUS_NAME)));
        break;
      case STREAM_MEDIAFRAMEWORK_SOUNDGENERATOR_SQUARE:
        radio_button_p =
          GTK_RADIO_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                    ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_RADIOBUTTON_SQUARE_NAME)));
        break;
      case STREAM_MEDIAFRAMEWORK_SOUNDGENERATOR_TRIANGLE:
        radio_button_p =
          GTK_RADIO_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                    ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_RADIOBUTTON_TRIANGLE_NAME)));
        break;
      case STREAM_MEDIAFRAMEWORK_SOUNDGENERATOR_NOISE:
        radio_button_p =
          GTK_RADIO_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                    ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_RADIOBUTTON_NOISE_NAME)));
        break;
#if defined (LIBNOISE_SUPPORT)
      case STREAM_MEDIAFRAMEWORK_SOUNDGENERATOR_PERLIN_NOISE:
        radio_button_p =
          GTK_RADIO_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                    ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_RADIOBUTTON_PERLIN_NAME)));
        break;
#endif // LIBNOISE_SUPPORT
      default:
      {
  ...
  scale_p = 
    GTK_SCALE (gtk_builder_get_object ((*iterator).second.second,
                                       ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_HSCALE_SINUS_FREQUENCY_NAME)));
  ACE_ASSERT (scale_p);
  ...
  file_filter_p =
    GTK_FILE_FILTER (gtk_builder_get_object ((*iterator).second.second,
                                             ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_FILEFILTER_WAV_NAME)));
  ...
  file_filter_p =
    GTK_FILE_FILTER (gtk_builder_get_object ((*iterator).second.second,
                                             ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_FILEFILTER_MP3_NAME)));
  ACE_ASSERT (file_filter_p);
  gtk_file_filter_add_mime_type (file_filter_p,
  ...
  file_chooser_button_p =
    GTK_FILE_CHOOSER_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                     ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_FILECHOOSERBUTTON_FILE_NAME)));
  ...
  file_chooser_dialog_p =
    GTK_FILE_CHOOSER_DIALOG (gtk_builder_get_object ((*iterator).second.second,
                                                     ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_FILECHOOSERDIALOG_FILE_NAME)));
  ...
  size_group_p =
    GTK_SIZE_GROUP (gtk_builder_get_object ((*iterator).second.second,
                                            ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_SIZEGROUP_OPTIONS_NAME)));
  ACE_ASSERT (size_group_p);
  button_p =
    GTK_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                        ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_BUTTON_DEVICE_SETTINGS_NAME)));
  ACE_ASSERT (button_p);
  ...
  toggle_button_p =
    GTK_TOGGLE_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                               ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_TOGGLEBUTTON_MUTE_NAME)));
  ACE_ASSERT (toggle_button_p);
  check_button_p =
    GTK_CHECK_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                              ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_CHECKBUTTON_SAVE_NAME)));
  ACE_ASSERT (check_button_p);
  gtk_size_group_add_widget (size_group_p, GTK_WIDGET (check_button_p));
  check_button_p =
    GTK_CHECK_BUTTON (gtk_builder_get_object ((*iterator).second.second,
  ...
  combo_box_p =
    GTK_COMBO_BOX (gtk_builder_get_object ((*iterator).second.second,
                                           ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_COMBOBOX_EFFECT_NAME)));
  ACE_ASSERT (combo_box_p);
  cell_renderer_p = gtk_cell_renderer_text_new ();
  if (!cell_renderer_p)
  {
  ...
  scale_p =
    GTK_SCALE (gtk_builder_get_object ((*iterator).second.second,
                                       ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_HSCALE_VOLUME_NAME)));
  ACE_ASSERT (scale_p);
...
continue_2:
  ...
  toggle_button_p =
    GTK_TOGGLE_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                               ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_TOGGLEBUTTON_3D_NAME)));
  ACE_ASSERT (toggle_button_p);
...
//#endif // GTK_CHECK_VERSION (3,10,0)
  ...
  box_p =
    GTK_BOX (gtk_builder_get_object ((*iterator).second.second,
                                     ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_BOX_DISPLAY_NAME)));
  ACE_ASSERT (box_p);
#if GTK_CHECK_VERSION (3,0,0)
#if GTK_CHECK_VERSION (3,16,0)
  ...
  */
  ...
  drawing_area_2 =
    GTK_DRAWING_AREA (gtk_builder_get_object ((*iterator).second.second,
                                              ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_DRAWINGAREA_3D_NAME)));
...
//                             ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_GLAREA_3D_NAME),
...
continue_3:
  ...
  if (is_active_b)
  {
    ...
    if (mode_2d < STREAM_VISUALIZATION_SPECTRUMANALYZER_2DMODE_MAX)
    {
      radio_button_p =
          GTK_RADIO_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                    (mode_2d == STREAM_VISUALIZATION_SPECTRUMANALYZER_2DMODE_OSCILLOSCOPE) ? ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_RADIOBUTTON_OSCILLOSCOPE_NAME)
                                                                                                                        : ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_RADIOBUTTON_SPECTRUM_NAME)));
      ACE_ASSERT (radio_button_p);
      gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (radio_button_p), TRUE);
    } // end IF
...
idle_session_end_cb (gpointer userData_in)
{
  ...
  // sanity check(s)
  struct Test_U_MicVisualize_UI_CBDataBase* ui_data_base_p =
    static_cast<struct Test_U_MicVisualize_UI_CBDataBase*> (userData_in);
  ...
  GtkFrame* frame_p =
    GTK_FRAME (gtk_builder_get_object ((*iterator).second.second,
                                       ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_FRAME_FILE_NAME)));
  ACE_ASSERT (frame_p);
  ...
  button_p =
    GTK_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                        ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_BUTTON_DEVICE_RESET_NAME)));
  ACE_ASSERT (button_p);
  gtk_widget_set_sensitive (GTK_WIDGET (button_p), TRUE);

  GtkBox* box_p =
    GTK_BOX (gtk_builder_get_object ((*iterator).second.second,
                                     ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_VBOX_FORMAT_OPTIONS_NAME)));
  ACE_ASSERT (box_p);
  gtk_widget_set_sensitive (GTK_WIDGET (box_p), TRUE);

  box_p =
    GTK_BOX (gtk_builder_get_object ((*iterator).second.second,
                                     ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_BOX_EFFECT_2_NAME)));
  ACE_ASSERT (box_p);
  gtk_widget_set_sensitive (GTK_WIDGET (box_p), TRUE);

  button_p =
    GTK_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                        ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_BUTTON_PROPERTIES_NAME)));
  ACE_ASSERT (button_p);
  gtk_widget_set_sensitive (GTK_WIDGET (button_p), FALSE);
...
idle_update_progress_cb (gpointer userData_in)
{
  ...
  // sanity check(s)
  struct Test_U_MicVisualize_ProgressData* data_p =
      static_cast<struct Test_U_MicVisualize_ProgressData*> (userData_in);
  ACE_ASSERT (data_p);
                                ...
                                gpointer userData_in)
{
  ...
  switch (ui_cb_data_base_p->mediaFramework)
  {
    case STREAM_MEDIAFRAMEWORK_DIRECTSHOW:
    {
      ...
      is_file_source_b =
        (directshow_ui_cb_data_p->configuration->streamConfiguration.configuration_->sourceType == MICVISUALIZE_SOURCE_FILE);
      break;
    }
    case STREAM_MEDIAFRAMEWORK_MEDIAFOUNDATION:
    {
      ...
      is_file_source_b =
        (mediafoundation_ui_cb_data_p->configuration->streamConfiguration.configuration_->sourceType == MICVISUALIZE_SOURCE_FILE);
      break;
    }
    default:
    {
  ...
  is_file_source_b =
    (ui_cb_data_p->configuration->streamConfiguration.configuration_->sourceType == MICVISUALIZE_SOURCE_FILE);
#endif // ACE_WIN32 || ACE_WIN64
  ACE_ASSERT (stream_p);
  ...
  ui_cb_data_base_p->progressData.statistic = Test_U_MicVisualize_Statistic ();
  GtkProgressBar* progress_bar_p =
    GTK_PROGRESS_BAR (gtk_builder_get_object ((*iterator).second.second,
                                              ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_PROGRESSBAR_NAME)));
  ACE_ASSERT (progress_bar_p);
  ...
  switch (ui_cb_data_base_p->mediaFramework)
  {
    case STREAM_MEDIAFRAMEWORK_DIRECTSHOW:
    {
      struct Test_U_MicVisualize_DirectShow_ThreadData* thread_data_2 = NULL;
      ACE_NEW_NORETURN (thread_data_2,
                        struct Test_U_MicVisualize_DirectShow_ThreadData ());
      if (thread_data_2)
      {
    ...
    case STREAM_MEDIAFRAMEWORK_MEDIAFOUNDATION:
    {
      struct Test_U_MicVisualize_MediaFoundation_ThreadData* thread_data_2 =
        NULL;
      ACE_NEW_NORETURN (thread_data_2,
                        struct Test_U_MicVisualize_MediaFoundation_ThreadData ());
      if (thread_data_2)
      {
...
//                  ACE_TEXT (TEST_U_Test_U_MicVisualize_THREAD_NAME));
                              ...
                              gpointer userData_in)
{
  ...
  switch (ui_cb_data_base_p->mediaFramework)
  {
    case STREAM_MEDIAFRAMEWORK_DIRECTSHOW:
    {
      // sanity check(s)
      directshow_ui_cb_data_p =
        static_cast<struct Test_U_MicVisualize_DirectShow_UI_CBData*> (ui_cb_data_base_p);
      directshow_modulehandler_configuration_iterator =
        directshow_ui_cb_data_p->configuration->streamConfiguration.find (ACE_TEXT_ALWAYS_CHAR (""));
      ACE_ASSERT (directshow_modulehandler_configuration_iterator != directshow_ui_cb_data_p->configuration->streamConfiguration.end ());
    ...
    {
      mediafoundation_ui_cb_data_p =
        static_cast<struct Test_U_MicVisualize_MediaFoundation_UI_CBData*> (ui_cb_data_base_p);
...
#else
  struct Test_U_MicVisualize_UI_CBData* ui_cb_data_p =
    static_cast<struct Test_U_MicVisualize_UI_CBData*> (ui_cb_data_base_p);
...
#else
  // sanity check(s)
  struct Test_U_MicVisualize_UI_CBData* cb_data_p =
    static_cast<struct Test_U_MicVisualize_UI_CBData*> (userData_in);
                                       ...
                                       gpointer userData_in)
{
  ...
  GtkBox* box_p =
      GTK_BOX (gtk_builder_get_object ((*iterator).second.second,
                                       ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_HBOX_VISUALIZATION_NAME)));
  ACE_ASSERT (box_p);
                           ...
                           gpointer userData_in)
{
  ...
  GtkRadioButton* radio_button_p =
      GTK_RADIO_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_RADIOBUTTON_OSCILLOSCOPE_NAME)));
  ACE_ASSERT (radio_button_p);
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  switch (ui_cb_data_base_p->mediaFramework)
  {
                              ...
                              gpointer userData_in)
{
  ...
  GtkRadioButton* radio_button_2 =
    GTK_RADIO_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                              ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_RADIOBUTTON_PINK_NAME)));
  ...
  GtkBox* box_p =
    GTK_BOX (gtk_builder_get_object ((*iterator).second.second,
                                     ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_VBOX_NOISE_NAME)));
  ACE_ASSERT (box_p);
  GtkWidget* box_2 =
    GTK_WIDGET (gtk_builder_get_object ((*iterator).second.second,
                                        ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_GRID_NOISE_NAME)));
  ACE_ASSERT (box_2);
  ...
  switch (noise_type_e)
  {
    ...
    case STREAM_MEDIAFRAMEWORK_SOUNDGENERATOR_TRIANGLE:
    {
      frame_p =
        GTK_FRAME (gtk_builder_get_object ((*iterator).second.second,
                                           ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_FRAME_SINUS_NAME)));
      ACE_ASSERT (frame_p);
    ...
    case STREAM_MEDIAFRAMEWORK_SOUNDGENERATOR_PERLIN_NOISE:
    {
      frame_p =
        GTK_FRAME (gtk_builder_get_object ((*iterator).second.second,
                                           ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_FRAME_PERLIN_NAME)));
      ACE_ASSERT (frame_p);
      gtk_widget_unparent (GTK_WIDGET (frame_p));
      break;
    }
                        ...
                        gpointer userData_in)
{
  ...
  stream_p = ui_cb_data_p->stream;
  Test_U_MicVisualize_IStreamControl_t* istream_control_p =
    dynamic_cast<Test_U_MicVisualize_IStreamControl_t*> (ui_cb_data_p->stream);
  ACE_ASSERT (istream_control_p);
  status_e = istream_control_p->status ();
#endif
  ACE_ASSERT (stream_p);
                            ...
                            gpointer userData_in)
{
  ...
  GtkBox* box_p =
    GTK_BOX (gtk_builder_get_object ((*iterator).second.second,
                                     ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_BOX_EFFECT_NAME)));
  ACE_ASSERT (box_p);
  GtkWidget* box_2 =
    GTK_WIDGET (gtk_builder_get_object ((*iterator).second.second,
                                        ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_BOX_EFFECT_2_NAME)));
  ...
  switch (ui_cb_data_base_p->mediaFramework)
  {
    case STREAM_MEDIAFRAMEWORK_DIRECTSHOW:
    {
      ...
      else if (InlineIsEqualGUID (effect_GUID, GUID_DSFX_STANDARD_FLANGER))
      {
        ...
        frame_p =
          GTK_FRAME (gtk_builder_get_object ((*iterator).second.second,
                                             ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_FRAME_EFFECT_WIN32_DS_FLANGER_OPTIONS_NAME)));
        ACE_ASSERT (frame_p);
        gtk_widget_unparent (GTK_WIDGET (frame_p));
      } // end ELSE IF
                            ...
                            gpointer userData_in)
{
  ...
  gtk_tree_model_get_value (GTK_TREE_MODEL (list_store_p),
                            ...
                            1, &value);
  ACE_ASSERT (G_VALUE_TYPE (&value) == G_TYPE_UINT);
  enum Test_U_MicVisualize_SourceType source_type_e =
    static_cast<enum Test_U_MicVisualize_SourceType> (g_value_get_uint (&value));
  g_value_unset (&value);
  enum Stream_MediaFramework_SoundGeneratorType noise_type_e =
    STREAM_MEDIAFRAMEWORK_SOUNDGENERATOR_INVALID;
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  struct Test_U_MicVisualize_DirectShow_UI_CBData* directshow_ui_cb_data_p = NULL;
  struct Test_U_MicVisualize_MediaFoundation_UI_CBData* mediafoundation_ui_cb_data_p = NULL;
  Test_U_MicVisualize_MediaFoundation_StreamConfiguration_t::ITERATOR_T mediafoundation_modulehandler_configuration_iterator;
  Test_U_MicVisualize_DirectShow_StreamConfiguration_t::ITERATOR_T directshow_modulehandler_configuration_iterator;
  bool use_framework_source_b = false;
  switch (ui_cb_data_base_p->mediaFramework)
  ...
  GtkBox* box_p =
    GTK_BOX (gtk_builder_get_object ((*iterator).second.second,
                                     ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_VBOX_CONFIGURATION_NAME)));
  ACE_ASSERT (box_p);
  combo_box_p =
    GTK_COMBO_BOX (gtk_builder_get_object ((*iterator).second.second,
                                           ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_COMBOBOX_SOURCE_NAME)));
  ...
  switch (source_type_e)
  {
    case MICVISUALIZE_SOURCE_DEVICE:
    {
      ...
      frame_p =
        GTK_FRAME (gtk_builder_get_object ((*iterator).second.second,
                                           ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_FRAME_DEVICE_NAME)));
      ACE_ASSERT (frame_p);
      gtk_widget_unparent (GTK_WIDGET (frame_p));
      break;
    }
    case MICVISUALIZE_SOURCE_NOISE:
    {
      GtkBox* box_2 =
        GTK_BOX (gtk_builder_get_object ((*iterator).second.second,
                                         ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_VBOX_FORMAT_OPTIONS_NAME)));
      ...
      frame_p =
        GTK_FRAME (gtk_builder_get_object ((*iterator).second.second,
                                           ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_FRAME_NOISE_NAME)));
      ACE_ASSERT (frame_p);
      gtk_widget_unparent (GTK_WIDGET (frame_p));
      load_formats_b = true;
      break;
    }
    case MICVISUALIZE_SOURCE_FILE:
    {
      frame_p =
        GTK_FRAME (gtk_builder_get_object ((*iterator).second.second,
                                           ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_FRAME_FILE_NAME)));
                            ...
                            gpointer userData_in)
{
  ...
  Test_U_MicVisualize_DirectShow_Source* directshow_source_impl_2 = NULL;
#if COMMON_OS_WIN32_TARGET_PLATFORM(0x0601) // _WIN32_WINNT_WIN7
...
//     mode |= SND_PCM_ASYNC;
  ...
  scale_p =
    GTK_SCALE (gtk_builder_get_object ((*iterator).second.second,
                                       ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_HSCALE_DEVICE_VOLUME_NAME)));
  ACE_ASSERT (scale_p);
  scale_2 =
    GTK_SCALE (gtk_builder_get_object ((*iterator).second.second,
                                       ACE_TEXT_ALWAYS_CHAR (TEST_U_UI_GTK_HSCALE_DEVICE_BOOST_NAME)));
  ACE_ASSERT (scale_2);
#if defined (ACE_WIN32) || defined (ACE_WIN64)
                            ...
                            gpointer userData_in)
{
  ...
  switch (ui_cb_data_base_p->mediaFramework)
  {
    case STREAM_MEDIAFRAMEWORK_DIRECTSHOW:
    {
      ...
      load_all_formats_b =
        (directshow_ui_cb_data_p->configuration->streamConfiguration.configuration_->sourceType != MICVISUALIZE_SOURCE_DEVICE);
      use_framework_source_b =
        (directshow_ui_cb_data_p->configuration->streamConfiguration.configuration_->capturer == STREAM_DEVICE_CAPTURER_DIRECTSHOW);
      break;
    }
    case STREAM_MEDIAFRAMEWORK_MEDIAFOUNDATION:
    {
      ...
      load_all_formats_b =
        (mediafoundation_ui_cb_data_p->configuration->streamConfiguration.configuration_->sourceType != MICVISUALIZE_SOURCE_DEVICE);
      use_framework_source_b =
        (mediafoundation_ui_cb_data_p->configuration->streamConfiguration.configuration_->capturer == STREAM_DEVICE_CAPTURER_MEDIAFOUNDATION);
      break;
    }
                              ...
                              gpointer userData_in)
{
  ...
  ACE_ASSERT (ui_cb_data_p);
  //ACE_ASSERT (ui_cb_data_p->configuration);
  //Test_U_MicVisualize_ALSA_StreamConfiguration_t::ITERATOR_T streamconfiguration_iterator =
  //    ui_cb_data_p->configuration->streamConfiguration.find (ACE_TEXT_ALWAYS_CHAR (""));
