                                ...
                                bool& delete_out)
{
  ...
  bool add_save_branch_b = !(*iterator_4).second.second->fileIdentifier.empty ();
  ...
  {
    ACE_NEW_RETURN (module_p,
                    Test_U_MicVisualize_DirectShow_Target_Module (this,
                                                                  ACE_TEXT_ALWAYS_CHAR (STREAM_LIB_DIRECTSHOW_TARGET_DEFAULT_NAME_STRING)),
                    false);
    ACE_ASSERT (module_p);
    layout_in->append (module_p, NULL, 0);
  ...
  if (add_renderer_branch_b)
  {
    ...
    switch (inherited::configuration_->configuration_->renderer)
    {
      ...
      {
        ACE_NEW_RETURN (module_p,
                        Test_U_MicVisualize_DirectShow_WavOut_Module (this,
                                                                      ACE_TEXT_ALWAYS_CHAR (STREAM_DEV_WAVEOUT_RENDER_DEFAULT_NAME_STRING)),
                        false);
        break;
      }
...
Test_U_MediaFoundation_Stream::find (const std::string& name_in) const
{
  ...
  //  return const_cast<Test_U_MicVisualize_MediaFoundation_Module_DisplayNull_Module*> (&displayNull_);
                                     ...
                                     bool& delete_out)
{
  ...
  module_p = NULL;
  //ACE_NEW_RETURN (module_p,
  //                Test_U_MicVisualize_MediaFoundation_StatisticReport_Module (this,
  //                                                                           ACE_TEXT_ALWAYS_CHAR (MODULE_STAT_REPORT_DEFAULT_NAME_STRING)),
  //                false);
  //ACE_ASSERT (module_p);
  //layout_in->append (module_p, NULL, 0);
...
Test_U_MediaFoundation_Stream::initialize (const inherited::CONFIGURATION_T& configuration_in)
{
  ...
  if (configuration_in.configuration_->capturer != STREAM_DEVICE_CAPTURER_MEDIAFOUNDATION)
  {
    Test_U_MicVisualize_MediaFoundation_Target* writer_p =
      &const_cast<Test_U_MicVisualize_MediaFoundation_Target&> (getR_4 ());
    ...
    {
      ACE_DEBUG ((LM_ERROR,
                  ACE_TEXT ("failed to Test_U_MediaFoundation_Stream::QueryInterface(): \"%s\", aborting\n"),
                  ACE_TEXT (Common_Error_Tools::errorToString (result_2).c_str ())));
      goto error;
    } // end IF
  } // end IF
...
const Test_U_MicVisualize_MediaFoundation_Target&
Test_U_MediaFoundation_Stream::getR_4 () const
{
  STREAM_TRACE (ACE_TEXT ("Test_U_MediaFoundation_Stream::getR_4"));

  Test_U_MicVisualize_MediaFoundation_Target* writer_p = NULL;
  //  static_cast<Test_U_MicVisualize_MediaFoundation_Target*> (const_cast<Test_U_MicVisualize_MediaFoundation_MediaFoundationTarget_Module&> (mediaFoundationTarget_).writer ());
  //ACE_ASSERT (writer_p);

  return *writer_p;
}

const Test_U_MicVisualize_MediaFoundation_Source&
Test_U_MediaFoundation_Stream::getR_5 () const
{
  STREAM_TRACE (ACE_TEXT ("Test_U_MediaFoundation_Stream::getR_5"));

  Test_U_MicVisualize_MediaFoundation_Source* writer_p =
    static_cast<Test_U_MicVisualize_MediaFoundation_Source*> (const_cast<Test_U_MicVisualize_MediaFoundation_Source_Module&> (mediaFoundationSource_).writer ());
  ACE_ASSERT (writer_p);
...
Test_U_MediaFoundation_Stream::getR_6 () const
{
  STREAM_TRACE (ACE_TEXT ("Test_U_MediaFoundation_Stream::getR_6"));
                                                           ...
                                                           void** interface_out)
{
  ...
  {
    Test_U_MicVisualize_MediaFoundation_Target* writer_p = NULL;
      //static_cast<Test_U_MicVisualize_MediaFoundation_Target*> (mediaFoundationTarget_.writer ());
    ACE_ASSERT (writer_p);
...
#else
Test_U_ALSA_Stream::Test_U_ALSA_Stream ()
 : inherited ()
#if defined (GTKGL_SUPPORT)
 , inherited2 ()
#endif // GTKGL_SUPPORT
...
bool
Test_U_ALSA_Stream::load (Stream_ILayout* layout_in,
                          bool& delete_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_ALSA_Stream::load"));
  ...
  module_p = NULL;
//  ACE_NEW_RETURN (module_p,
//                  Test_U_MicVisualize_StatisticReport_Module (this,
//                                                              ACE_TEXT_ALWAYS_CHAR (MODULE_STAT_REPORT_DEFAULT_NAME_STRING)),
//                  false);
//  layout_in->append (module_p, NULL, 0);
//  module_p = NULL;
  ...
  {
    ACE_NEW_RETURN (module_p,
                    Test_U_MicVisualize_SoXEffect_Module (this,
  ...
  {
    ACE_NEW_RETURN (module_p,
                    Test_U_MicVisualize_Distributor_Module (this,
                                                            ACE_TEXT_ALWAYS_CHAR (STREAM_MISC_DISTRIBUTOR_DEFAULT_NAME_STRING)),
                    false);
    branch_p = module_p;
  ...
  if (add_save_branch_b)
  {
    ...
    ACE_NEW_RETURN (module_p,
                    Test_U_MicVisualize_ALSA_WAVEncoder_Module (this,
                                                                ACE_TEXT_ALWAYS_CHAR (STREAM_DEC_ENCODER_WAV_DEFAULT_NAME_STRING)),
                    false);
    layout_in->append (module_p, branch_p, index_i);
    module_p = NULL;
    ...
    //         itself
    //  ACE_NEW_RETURN (module_p,
    //                  Test_U_MicVisualize_Module_FileWriter_Module (this,
  ...
  if (add_display_branch_b)
  {
    ...
    ACE_NEW_RETURN (module_p,
                    Test_U_MicVisualize_StatisticAnalysis_Module (this,
                                                                  ACE_TEXT_ALWAYS_CHAR (MODULE_STAT_ANALYSIS_DEFAULT_NAME_STRING)),
                    false);
    layout_in->append (module_p, branch_p, index_i);
    module_p = NULL;
...
bool
Test_U_ALSA_Stream::initialize (const typename inherited::CONFIGURATION_T& configuration_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_U_ALSA_Stream::initialize"));
