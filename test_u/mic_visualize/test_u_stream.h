...
class Test_U_MediaFoundation_Stream
 ...
 , public Stream_Visualization_GTK_Cairo_OpenGL
#endif // GTKGL_SUPPORT
 , public Common_IGetR_5_T<Test_U_MicVisualize_MediaFoundation_Target>
 , public Common_IGetR_6_T<Test_U_MicVisualize_MediaFoundation_Source>
 ...
 , public IMFAsyncCallback
{
 ...
 public:
  ...
  virtual const Test_U_MicVisualize_MediaFoundation_Target& getR_5 () const; // return value: type
  virtual const Test_U_MicVisualize_MediaFoundation_Source& getR_6 () const; // return value: type
