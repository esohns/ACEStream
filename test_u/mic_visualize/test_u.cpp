...
do_initialize_directshow (const struct Stream_Device_Identifier& deviceIdentifier_in,
                          const struct Test_U_MicVisualize_DirectShow_Configuration& configuration_in,
...
//continue_2:
  ...
  configuration_in.filterConfiguration.pinConfiguration->format =
    &captureMediaType_out;
  Common_IInitialize_T<struct Test_U_MicVisualize_DirectShow_FilterConfiguration>* iinitialize_p = filter_p;
...
do_initialize_mediafoundation (const struct Stream_Device_Identifier& deviceIdentifier_in,
                               struct Test_U_MicVisualize_MediaFoundation_Configuration& configuration_in,
                               ...
                               bool mute_in,
                               Test_U_MediaFoundation_Stream& stream_in,
                               bool makeSession_in)
{
...
continue_2:
  ...
  if (!useMediaFoundationSource_in)
  {
    ...
    {
      ACE_DEBUG ((LM_ERROR,
                  ACE_TEXT ("failed to Test_U_MicVisualize_MediaFoundation_Stream::QueryInterface(): \"%s\", aborting\n"),
                  ACE_TEXT (Common_Error_Tools::errorToString (result).c_str ())));
      goto error;
    } // end IF
  } // end IF
...
void
do_finalize_directshow (struct Test_U_MicVisualize_DirectShow_UI_CBData& CBData_in)
{
  STREAM_TRACE (ACE_TEXT ("::do_finalize_directshow"));

  ACE_UNUSED_ARG (CBData_in);

  Test_U_MicVisualize_DirectShow_StreamConfiguration_t::ITERATOR_T iterator =
...
#else
         struct Test_U_MicVisualize_Configuration& configuration_in,
#endif // ACE_WIN32 || ACE_WIN64
         ...
         Test_U_SignalHandler& signalHandler_in)
{
  ...
  struct Test_U_MicVisualize_MediaFoundation_ModuleHandlerConfiguration mediafoundation_modulehandler_configuration_3; // renderer module
  struct Test_U_MicVisualize_MediaFoundation_ModuleHandlerConfiguration mediafoundation_modulehandler_configuration_4; // file writer module
  struct Test_U_MicVisualize_MediaFoundation_ModuleHandlerConfiguration mediafoundation_modulehandler_configuration_5; // resampler module
  struct Test_U_MicVisualize_MediaFoundation_StreamConfiguration mediafoundation_stream_configuration;
  ...
  if (!UIDefinitionFile_in.empty ())
  {
    ...
    if (useProjectM_in)
    {
      ...
      projectm_set_mesh_size (projectm_configuration.handle,
                              TEST_U_GLUT_PROJECTM_DEFAULT_PER_VERTEX_MESH_RESOLUTION_X,
                              TEST_U_GLUT_PROJECTM_DEFAULT_PER_VERTEX_MESH_RESOLUTION_Y);
      ...
      projectm_set_texel_offset (projectm_configuration.handle,
                                 ...
                                 TEST_U_GLUT_PROJECTM_DEFAULT_TEXTEL_OFFSET_Y);
           ...
           ACE_TCHAR* argv_in[])
{
...
#if defined (GTK_USE)
  UI_definition_file += ACE_TEXT_ALWAYS_CHAR (TEST_U_GLADE_FILE);
#elif defined (WXWIDGETS_USE)
  UI_definition_file += ACE_TEXT_ALWAYS_CHAR (TEST_U_WXWIDGETS_XRC_FILE);
#endif // GTK_USE || WXWIDGETS_USE
#if defined (GTK_USE)
  ...
  struct Test_U_MicVisualize_UI_CBDataBase* cb_data_base_p = NULL;
#if defined (ACE_WIN32) || defined (ACE_WIN64)
