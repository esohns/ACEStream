...
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::Stream_MessageAllocatorHeap"));

}

Stream_MessageAllocatorHeap::~Stream_MessageAllocatorHeap()
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::~Stream_MessageAllocatorHeap"));
...
void*
Stream_MessageAllocatorHeap::malloc (size_t bytes_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::malloc"));
  ...
  try
  {
    ...
    if (bytes_in)
      ACE_NEW_MALLOC_NORETURN (message,
                               static_cast<Stream_MessageBase*> (inherited::malloc (sizeof (Stream_MessageBase))),
                               Stream_MessageBase (data_block, // use the data block we just allocated
                                                   this));     // remember us upon destruction...
    else
      ACE_NEW_MALLOC_NORETURN (message,
                               static_cast<Stream_SessionMessage*> (inherited::malloc (sizeof (Stream_SessionMessage))),
                               Stream_SessionMessage (data_block, // use the data block we just allocated
                                                      this));     // remember us upon destruction...
  }
  catch (...)
  {
...
void*
Stream_MessageAllocatorHeap::calloc (size_t bytes_in,
                                     char initialValue_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::calloc"));
...
void
Stream_MessageAllocatorHeap::free (void* handle_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::free"));
...
size_t
Stream_MessageAllocatorHeap::cache_depth () const
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::cache_depth"));

  return poolSize_.value ();
}

size_t
Stream_MessageAllocatorHeap::cache_size () const
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::cache_size"));

  return dataBlockAllocator_.cache_size ();
}

void
Stream_MessageAllocatorHeap::dump (void) const
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::dump"));

  return dataBlockAllocator_.dump ();
}

void*
Stream_MessageAllocatorHeap::calloc (size_t numElements_in,
...
int
Stream_MessageAllocatorHeap::remove (void)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::remove"));
...
int
Stream_MessageAllocatorHeap::bind (const char* name_in,
                                   void* pointer_in,
                                   int duplicates_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::bind"));
...
int
Stream_MessageAllocatorHeap::trybind (const char* name_in,
                                      void*& pointer_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::trybind"));
...
int
Stream_MessageAllocatorHeap::find (const char* name_in,
                                   void*& pointer_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::find"));
...
int
Stream_MessageAllocatorHeap::unbind (const char* name_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::unbind"));
...
int
Stream_MessageAllocatorHeap::sync (ssize_t length_in,
                                   int flags_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::sync"));
...
int
Stream_MessageAllocatorHeap::sync (void* address_in,
                                   size_t length_in,
                                   int flags_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::sync"));
...
int
Stream_MessageAllocatorHeap::protect (ssize_t length_in,
                                      int protection_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::protect"));
...
int
Stream_MessageAllocatorHeap::protect (void* address_in,
                                      size_t length_in,
                                      int protection_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MessageAllocatorHeap::protect"));
