                                      ...
                                      struct Stream_UserData>
{
 ...
 private:
  ...
  Branch_SessionMessage (const Branch_SessionMessage&);
  ...
  ACE_UNIMPLEMENTED_FUNC (Branch_SessionMessage ())
  ACE_UNIMPLEMENTED_FUNC (Branch_SessionMessage& operator= (const Branch_SessionMessage&))
};
