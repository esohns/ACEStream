...
class Test_U_AudioEffect_SignalHandler
 : public Common_SignalHandler_T<Test_U_AudioEffect_SignalHandlerConfiguration>
 , public Common_ISignal
{
 ...
 private:
  typedef Common_SignalHandler_T<Test_U_AudioEffect_SignalHandlerConfiguration> inherited;
