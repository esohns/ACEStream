...
Test_U_DirectShow_Stream::initialize (const inherited::CONFIGURATION_T& configuration_in)
{
  ...
  // sanity check(s)
  session_data_p =
    &const_cast<Test_U_CaptureWindow_DirectShow_SessionData&> (session_manager_p->getR (inherited::id_));
...
Test_U_MediaFoundation_Stream::initialize (const inherited::CONFIGURATION_T& configuration_in)
{
  ...
  session_data_p =
    &const_cast<Test_U_CaptureWindow_MediaFoundation_SessionData&> (session_manager_p->getR (inherited::id_));
  // *TODO*: remove type inferences
  //session_data_p->targetFileName = (*iterator).second.second->targetFileName;
...
Test_U_Stream::initialize (const typename inherited::CONFIGURATION_T& configuration_in)
{
  ...
  session_data_p =
    &const_cast<Test_U_CaptureWindow_SessionData&> (session_manager_p->getR (inherited::id_));
  // *TODO*: remove type inferences
  ACE_ASSERT (session_data_p->formats.empty ());
