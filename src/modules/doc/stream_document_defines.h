...
#define STREAM_DOCUMENT_PDF_FILENAME_EXTENSION                        "pdf"
...
#define STREAM_DOCUMENT_DEFAULT_LIBREOFFICE_ENV_UNO_HOME              "UNO_HOME"
#if defined (ACE_WIN32) || defined (ACE_WIN64)
#define STREAM_DOCUMENT_LIBREOFFICE_BOOTSTRAP_FILE_SUFFIX             ".ini"
#define STREAM_DOCUMENT_DEFAULT_LIBREOFFICE_FILE_UNO_INI              "uno.ini"
#else
#define STREAM_DOCUMENT_LIBREOFFICE_BOOTSTRAP_FILE_SUFFIX             "rc"
#define STREAM_DOCUMENT_DEFAULT_LIBREOFFICE_FILE_UNO_INI              "unorc"
#endif // ACE_WIN32 || ACE_WIN64
...
#define STREAM_DOCUMENT_LIBREOFFICE_PROPERTY_FILE_FILTERNAME          "FilterName"
...
#define STREAM_DOCUMENT_LIBREOFFICE_CALC_PDF_EXPORT_FILTER_NAME       "calc_pdf_Export"
