...
elseif (WIN32)
 if (DEFINED ENV{UNO_HOME})
  set (UNO_HOME $ENV{UNO_HOME})
 elseif (DEFINED ENV{OO_SDK_HOME})
  message (WARNING "UNO_HOME not set, falling back to OO_SDK_HOME (was: \"$ENV{OO_SDK_HOME}\")")
  set (UNO_HOME $ENV{OO_SDK_HOME}/../program)
 else ()
  message (WARNING "%OO_SDK_HOME%/%UNO_HOME% not set, falling back")
  set (UNO_HOME ${CMAKE_CURRENT_SOURCE_DIR}/../../../../openoffice/program)
 endif ()
 if (DEFINED ENV{OO_SDK_HOME})
  set (OO_SDK_DIRECTORY $ENV{OO_SDK_HOME})
 elseif (DEFINED ENV{UNO_HOME})
  message (WARNING "OO_SDK_HOME not set, falling back to UNO_HOME (was: \"$ENV{UNO_HOME}\")")
 ...
 if (LIBREOFFICE_SAL_LIBRARY AND LIBREOFFICE_ICPPU_LIBRARY AND LIBREOFFICE_ICPPUHELPER_LIBRARY)
  ...
  set (LIBREOFFICE_LIB_DIRS "${UNO_HOME};${OO_SDK_DIRECTORY}/bin")
