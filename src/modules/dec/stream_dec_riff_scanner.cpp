...
static const yy_state_type yy_NUL_trans[55] =
    {   0,
       ...
       26,   26,   27,   27,   28,   28,   29,   29,    0,    0,
        0,   32,   33,   34,   35,   36,    0,    0,   37,   37,
        0,   40,   41,   42,   43,   44,   45,   45,    0,   48,
       49,   50,   51,   52,   53,   53,    0,    0,    0,    0,
        0,    0,    0,    0
    } ;

static const flex_int32_t yy_rule_linenum[12] =
    {   0,
       99,  108,  117,  126,  133,  143,  152,  161,  171,  195,
      202
    } ;
...
{ ACE_ASSERT (yyleng == 4);
                             ...
                             yylval->chunk_meta.size =
                               ((ACE_BYTE_ORDER == ACE_LITTLE_ENDIAN) ? *reinterpret_cast<ACE_UINT32*> (yytext)
                                                                      : ACE_SWAP_LONG (*reinterpret_cast<ACE_UINT32*> (yytext)));
