...
// *TODO*: move these into the individual decoder/encoder classes
...
#define STREAM_DEC_DECODER_SAPI_DECODER_DEFAULT_NAME_STRING          "SAPI"
...
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_FLASH_ATTENTION     false
//#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_SAMPLING_STRATEGY   WHISPER_SAMPLING_BEAM_SEARCH
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_SAMPLING_STRATEGY   WHISPER_SAMPLING_GREEDY
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_NAME_STRING         "WhisperCpp"
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_USE_BUFFER          true
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_MINIMUM_BUFFER_LENGTH_MS    100 // *NOTE*: WhisperCpp input needs to be >100ms
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_BUFFER_LENGTH_MS    1000
// *NOTE*: these values should reduce repetitions
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_NO_CONTEXT          false
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_MAX_TOKEN_CONTEXT   64
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_AUDIO_CONTEXT       768
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_LENGTH_PENALTY_F    0.6f
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_ENTROPY_THRESHOLD_F 2.8f
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_BEAM_SIZE           5
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_SUPPORT_VAD         false
...
#define STREAM_DEC_AVI_AUDIO_STRH_SUGGESTED_BUFFER_SIZE              2048 // bytes
