...
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_MINIMUM_BUFFER_LENGTH_MS    100 // *NOTE*: input needs to be >100ms
#define STREAM_DEC_DECODER_WHISPERCPP_DECODER_DEFAULT_BUFFER_LENGTH_MS    200
