...
template <ACE_SYNCH_DECL,
          ...
          typename SessionMessageType,
          typename MediaType>
Stream_Decoder_LibAVEncoder_2<ACE_SYNCH_USE,
                              TimePolicyType,
                              ConfigurationType,
                              ControlMessageType,
                              DataMessageType,
                              SessionMessageType,
#if defined (ACE_WIN32) || defined (ACE_WIN64)
                              MediaType>::Stream_Decoder_LibAVEncoder_2 (ISTREAM_T* stream_in)
#else 
                              MediaType>::Stream_Decoder_LibAVEncoder_2 (typename inherited::ISTREAM_T* stream_in)
#endif // ACE_WIN32 || ACE_WIN64
 : inherited (stream_in)
 , inherited2 ()
 , audioCodecContext_ (NULL)
 ...
 , numberOfStreamsInitialized_ (0)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Decoder_LibAVEncoder_2::Stream_Decoder_LibAVEncoder_2"));
...
Stream_Decoder_LibAVEncoder_2<ACE_SYNCH_USE,
                              ...
                              DataMessageType,
                              SessionMessageType,
                              MediaType>::~Stream_Decoder_LibAVEncoder_2 ()
{
  STREAM_TRACE (ACE_TEXT ("Stream_Decoder_LibAVEncoder_2::~Stream_Decoder_LibAVEncoder_2"));
...
Stream_Decoder_LibAVEncoder_2<ACE_SYNCH_USE,
                              ...
                              MediaType>::initialize (const ConfigurationType& configuration_in,
                                                      Stream_IAllocator* allocator_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Decoder_LibAVEncoder_2::initialize"));
...
Stream_Decoder_LibAVEncoder_2<ACE_SYNCH_USE,
                              ...
                              MediaType>::handleDataMessage (DataMessageType*& message_inout,
                                                             bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Decoder_LibAVEncoder_2::handleDataMessage"));
...
Stream_Decoder_LibAVEncoder_2<ACE_SYNCH_USE,
                              ...
                              MediaType>::handleSessionMessage (SessionMessageType*& message_inout,
                                                                bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Decoder_LibAVEncoder_2::handleSessionMessage"));
