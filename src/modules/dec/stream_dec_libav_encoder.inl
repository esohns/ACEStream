...
//          videoFrame_->format = AV_PIX_FMT_RGB24;
          ...
          videoFrame_->width = static_cast<unsigned int> (media_type_4.resolution.cx);
#else
          videoFrame_->height = media_type_4.resolution.height;
          videoFrame_->width = media_type_4.resolution.width;
#endif // ACE_WIN32 || ACE_WIN64
