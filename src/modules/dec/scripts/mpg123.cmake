...
#  cmake_policy (SET CMP0074 OLD)
  ...
  if (mpg123_FOUND)
   set (MPG123_FOUND TRUE)
   set (MPG123_INCLUDE_DIRS ${VCPKG_INCLUDE_DIR})
   set (MPG123_LIBRARIES "${VCPKG_LIB_DIR}/mpg123.lib")
   set (MPG123_LIB_DIR ${VCPKG_BIN_DIR})
  endif (mpg123_FOUND)
 endif (VCPKG_USE)
 if (NOT MPG123_FOUND)
...
if (MPG123_FOUND)
 ...
 if (MPG123_SUPPORT)
  ...
  if (VCPKG_USE)
   add_definitions (-DMPG123_NO_LARGENAME)
  endif (VCPKG_USE)
