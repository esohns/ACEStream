...
#  cmake_policy (SET CMP0074 OLD)
  ...
  if (opencv_FOUND)
   ...
   if (CMAKE_BUILD_TYPE STREQUAL "Debug" OR
    ...
    set (OPENCV_LIB_DIR "${VCPKG_ROOT}/installed/${VCPKG_TARGET_TRIPLET}/debug/bin")
   else ()
    set (OPENCV_LIB_DIR "${VCPKG_ROOT}/installed/${VCPKG_TARGET_TRIPLET}/bin")
   endif ()
  endif (opencv_FOUND)
 else ()
  ...
  if (OPENCV_CORE_LIBRARY AND OPENCV_HIGHGUI_LIBRARY AND OPENCV_IMGCODECS_LIBRARY AND OPENCV_IMGPROC_LIBRARY AND OPENCV_VIDEOIO_LIBRARY)
   set (OPENCV_FOUND TRUE)
   set (OPENCV_INCLUDE_DIRS "$ENV{LIB_ROOT}/opencv/include;$ENV{LIB_ROOT}/opencv/modules/core/include;$ENV{LIB_ROOT}/opencv/modules/highgui/include;$ENV{LIB_ROOT}/opencv/modules/imgcodecs/include;$ENV{LIB_ROOT}/opencv/modules/imgproc/include;$ENV{LIB_ROOT}/opencv/modules/videoio/include;$ENV{LIB_ROOT}/opencv/build")
   set (OPENCV_LIBRARIES "${OPENCV_CORE_LIBRARY};${OPENCV_HIGHGUI_LIBRARY};${OPENCV_IMGCODECS_LIBRARY};${OPENCV_IMGPROC_LIBRARY};${OPENCV_VIDEOIO_LIBRARY}")
   set (OPENCV_LIB_DIR "$ENV{LIB_ROOT}/opencv/bin/${CMAKE_BUILD_TYPE}")
  endif (OPENCV_CORE_LIBRARY AND OPENCV_HIGHGUI_LIBRARY AND OPENCV_IMGCODECS_LIBRARY AND OPENCV_IMGPROC_LIBRARY AND OPENCV_VIDEOIO_LIBRARY)
 endif (VCPKG_SUPPORT)
endif ()
if (OPENCV_FOUND)
