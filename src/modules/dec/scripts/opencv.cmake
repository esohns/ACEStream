...
#  cmake_policy (SET CMP0074 OLD)
  ...
  if (opencv_FOUND)
   set (OPENCV_FOUND TRUE)
   set (OPENCV_INCLUDE_DIRS ${VCPKG_INCLUDE_DIR}/opencv4)
   set (OPENCV_LIBRARIES "${VCPKG_LIB_DIR}/opencv_core4${LIB_FILE_SUFFIX}.lib;${VCPKG_LIB_DIR}/opencv_highgui4${LIB_FILE_SUFFIX}.lib;${VCPKG_LIB_DIR}/opencv_imgcodecs4${LIB_FILE_SUFFIX}.lib;${VCPKG_LIB_DIR}/opencv_imgproc4${LIB_FILE_SUFFIX}.lib;${VCPKG_LIB_DIR}/opencv_objdetect4${LIB_FILE_SUFFIX}.lib;${VCPKG_LIB_DIR}/opencv_videoio4${LIB_FILE_SUFFIX}.lib")
   set (OPENCV_LIB_DIR ${VCPKG_LIB_DIR})
  endif (opencv_FOUND)
 endif (VCPKG_USE)
 if (NOT OPENCV_FOUND)
  set (LIB_FILE_SUFFIX "")
