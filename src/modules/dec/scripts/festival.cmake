...
#   message (STATUS "Found ${SPEECHTOOLS_BASE_LIB_FILE} library \"${SPEECHTOOLS_BASE_LIBRARY}\"")
#   message (STATUS "Found ${SPEECHTOOLS_LIB_FILE} library \"${SPEECHTOOLS_LIBRARY}\"")
#   message (STATUS "Found ${SPEECHTOOLS_STRING_LIB_FILE} library \"${SPEECHTOOLS_STRING_LIBRARY}\"")
#   message (STATUS "Found ${FESTIVAL_LIB_FILE} library \"${FESTIVAL_LIBRARY}\"")
   set (FESTIVAL_FOUND TRUE)
   set (FESTIVAL_INCLUDE_DIRS "/usr/include/speech_tools")
   set (FESTIVAL_LIBRARIES "${FESTIVAL_LIBRARY};${SPEECHTOOLS_BASE_LIBRARY};${SPEECHTOOLS_LIBRARY};${SPEECHTOOLS_STRING_LIBRARY}")
