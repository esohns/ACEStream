set (VORBIS_SUPPORT_DEFAULT ON)
if (UNIX)
 include (FindPkgConfig)
 pkg_check_modules (PKG_OGG ogg)
 pkg_check_modules (PKG_VORBIS vorbis)
 if (PKG_OGG_FOUND AND PKG_VORBIS_FOUND)
  set (VORBIS_FOUND TRUE)
  set (VORBIS_INCLUDE_DIRS "${PKG_OGG_INCLUDE_DIRS};${PKG_VORBIS_INCLUDE_DIRS}")
  set (VORBIS_LIBRARIES "${PKG_OGG_LIBRARIES};${PKG_VORBIS_LIBRARIES}")
endif (PKG_OGG_FOUND AND PKG_VORBIS_FOUND)
elseif (WIN32)
 if (VCPKG_USE)
...
if (VORBIS_FOUND)
 option (VORBIS_SUPPORT "enable OGG/Vorbis support" ${VORBIS_SUPPORT_DEFAULT})
 if (VORBIS_SUPPORT)
