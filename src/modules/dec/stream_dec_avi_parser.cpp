...
static const char *const yytname[] =
{
  ...
  "\"chunk\"", "\"data\"", "$accept", "buffer", "chunks", "rest", YY_NULLPTR
};
#endif
...
# define YYBACKUP(Token, Value)                                              \
  ...
  switch (yyn)
    ...
    { ((*yyvalp).size) = 4 + 4 + 4 + (((yyGLRStackItem const *)yyvsp)[YYFILL (-1)].yystate.yysemantics.yysval.chunk_header).size;
                                                         ...
                                                         ACE_DEBUG ((LM_DEBUG,
                                                                     ...
                                                                     (((yyGLRStackItem const *)yyvsp)[YYFILL (-1)].yystate.yysemantics.yysval.chunk_header).fourcc, (((yyGLRStackItem const *)yyvsp)[YYFILL (-1)].yystate.yysemantics.yysval.chunk_header).size));
                                                       }
  ...
  case 5:
    ...
    { ((*yyvalp).size) = 4 + 4 + (((yyGLRStackItem const *)yyvsp)[YYFILL (0)].yystate.yysemantics.yysval.size);
                                                         ...
                                                         ACE_DEBUG ((LM_DEBUG,
                                                                     ...
                                                                     (((yyGLRStackItem const *)yyvsp)[YYFILL (-1)].yystate.yysemantics.yysval.chunk_header).fourcc, (((yyGLRStackItem const *)yyvsp)[YYFILL (-1)].yystate.yysemantics.yysval.chunk_header).size));
                                                         if ((((yyGLRStackItem const *)yyvsp)[YYFILL (-1)].yystate.yysemantics.yysval.chunk_header).fourcc == MAKEFOURCC ('r', 'e', 'c', ' '))
                                                           YYACCEPT;
                                                       }
...
yy_reduce_print (int yynormal, yyGLRStackItem* yyvsp, size_t yyk,
                 yyRuleNum yyrule, Stream_Decoder_AVIParserDriver* driver, yyscan_t yyscanner)
{
