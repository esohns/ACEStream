...
//template <typename AllocatorConfigurationType>
//void
//Stream_MediaFramework_DirectShow_MessageBase_T<AllocatorConfigurationType>::initialize (DataType& data_in,
//                                                                                        ACE_Data_Block* dataBlock_in)
//{
//  STREAM_TRACE (ACE_TEXT ("Stream_MediaFramework_DirectShow_MessageBase_T::initialize"));
//
//  data_ = data_in;
//
