 ...
 , public IMFAsyncCallback
{
 ...
 public:
  ...
  //         E_NOTIMPL. ..."
  virtual inline STDMETHODIMP GetParameters (DWORD* flags_out, DWORD* queue_out) { ACE_UNUSED_ARG (flags_out); ACE_UNUSED_ARG (queue_out); return E_NOTIMPL; }
 ...
 private:
  ...
  // helper methods
  bool initializeMediaSession (const struct Stream_Device_Identifier&, // device identifier
