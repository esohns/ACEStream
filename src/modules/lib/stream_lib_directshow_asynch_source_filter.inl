                                                                                    ...
                                                                                    HRESULT* result_out)
{
  ...
  *result_out = S_OK;
  ...
  ACE_NEW_NORETURN (unknown_p,
                    OWN_TYPE_T (NAME (MODULE_LIB_DIRECTSHOW_FILTER_NAME_ASYNCH_SOURCE),
                                IUnknown_in,
...
Stream_MediaFramework_DirectShow_Asynch_Source_Filter_T<TimePolicyType,
 ...
 : inherited (NAME (MODULE_LIB_DS_WIN32_FILTER_NAME_ASYNCH_SOURCE), // name
              NULL,                                                 // owner
...
Stream_MediaFramework_DirectShow_Asynch_Source_Filter_T<TimePolicyType,
                                                        ...
                                                        ConfigurationType,
                                                        PinConfigurationType,
                                                        MediaType>::Stream_MediaFramework_DirectShow_Asynch_Source_Filter_T::initialize (const ConfigurationType& configuration_in)
{
  ...
  IPin* ipin_p = Stream_Module_Device_DirectShow_Tools::pin (this, PINDIR_OUTPUT);
  if (!ipin_p)
  {
    ACE_DEBUG ((LM_ERROR,
                                                        ...
                                                        MediaType>::initialize (const MediaType* mediaType_in)
{
  ...
  // *NOTE*: the pin will inherited::AddPin() itself to 'this'
  IPin* ipin_p =
    Stream_Module_Device_DirectShow_Tools::pin (this, PINDIR_OUTPUT);
  if (!ipin_p)
  {
    ACE_DEBUG ((LM_ERROR,
                ACE_TEXT ("%s has no output pin, aborting\n"),
                                                                 ...
                                                                 MediaType>::InitAllocator (IMemAllocator** allocator_out)
{
  ...
  *allocator_out = NULL;
  ...
  ACE_NEW_NORETURN (allocator_p,
                    CMemAllocator (NAME (MODULE_LIB_DIRECTSHOW_ALLOCATOR_NAME),
                                   NULL,
                                   &result));
  if (!allocator_p ||
      FAILED (result))
...
continue_:
  ...
  IBaseFilter* filter_p =
    Stream_Module_Device_DirectShow_Tools::pinToFilter (this);
  ACE_ASSERT (filter_p);
                                                                                      ...
                                                                                      DWORD_PTR userContext_in)
{
  ...
  if (flushing_) return VFW_E_WRONG_STATE;
                                                                                               ...
                                                                                               IMemAllocator** allocator_out)
{
  ...
  ACE_ASSERT (ipin_p);
  ibase_filter_2 = Stream_Module_Device_DirectShow_Tools::pinToFilter (ipin_p);
...
continue_:
  ACE_DEBUG ((LM_DEBUG,
            ...
            ACE_TEXT (MODULE_LIB_DIRECTSHOW_FILTER_NAME_ASYNCH_SOURCE),
            ACE_TEXT_WCHAR_TO_TCHAR (MODULE_LIB_DIRECTSHOW_FILTER_PIN_OUTPUT_NAME),
