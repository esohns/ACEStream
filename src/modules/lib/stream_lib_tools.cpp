...
WORD
Stream_MediaFramework_Tools::AVSampleFormatToBitCount (enum AVSampleFormat sampleFormat_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MediaFramework_Tools::AVSampleFormatToBitCount"));
...
enum AVCodecID
Stream_MediaFramework_Tools::v4lFormatToffmpegCodecId (__u32 format_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MediaFramework_Tools::v4lFormatToffmpegCodecId"));
  ...
  switch (format_in)
  {
    ...
    case V4L2_PIX_FMT_JPEG:
      result = AV_CODEC_ID_LJPEG; break;
    case V4L2_PIX_FMT_DV:
      result = AV_CODEC_ID_DVVIDEO; break;
    case V4L2_PIX_FMT_MPEG:
      result = AV_CODEC_ID_MPEG2VIDEO; break;
    case V4L2_PIX_FMT_H264:
    case V4L2_PIX_FMT_H264_NO_SC:
    case V4L2_PIX_FMT_H264_MVC:
      result = AV_CODEC_ID_H264; break;
    case V4L2_PIX_FMT_H263:
      result = AV_CODEC_ID_H263; break;
    case V4L2_PIX_FMT_MPEG1:
      result = AV_CODEC_ID_MPEG1VIDEO; break;
    case V4L2_PIX_FMT_MPEG2:
    case V4L2_PIX_FMT_MPEG2_SLICE:
      result = AV_CODEC_ID_MPEG2VIDEO; break;
    case V4L2_PIX_FMT_MPEG4:
      result = AV_CODEC_ID_MPEG4; break;
    case V4L2_PIX_FMT_XVID:
      result = AV_CODEC_ID_MPEG4; break;
    case V4L2_PIX_FMT_VC1_ANNEX_G:
    case V4L2_PIX_FMT_VC1_ANNEX_L:
      result = AV_CODEC_ID_VC1; break;
    case V4L2_PIX_FMT_VP8:
    case V4L2_PIX_FMT_VP8_FRAME:
      result = AV_CODEC_ID_VP8; break;
    case V4L2_PIX_FMT_VP9:
      result = AV_CODEC_ID_VP9; break;
    case V4L2_PIX_FMT_HEVC:
      result = AV_CODEC_ID_HEVC; break;
    case V4L2_PIX_FMT_FWHT:
    case V4L2_PIX_FMT_FWHT_STATELESS:
      break;
    case V4L2_PIX_FMT_H264_SLICE:
...
Stream_MediaFramework_Tools::v4lFormatToPipewireFormat (__u32 format_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MediaFramework_Tools::v4lFormatToPipewireFormat"));
...
//    case V4L2_PIX_FMT_YYUV:
    case V4L2_PIX_FMT_YVYU:
      return SPA_VIDEO_FORMAT_YVYU;
    case V4L2_PIX_FMT_UYVY:
      return SPA_VIDEO_FORMAT_UYVY;
    case V4L2_PIX_FMT_VYUY:
      return SPA_VIDEO_FORMAT_VYUY;
    case V4L2_PIX_FMT_Y41P:
      return SPA_VIDEO_FORMAT_Y41B;
//    case V4L2_PIX_FMT_YUV444:
//    case V4L2_PIX_FMT_YUV555:
//    case V4L2_PIX_FMT_YUV565:
//    case V4L2_PIX_FMT_YUV24:
...
//    case V4L2_PIX_FMT_M420:
    ...
    case V4L2_PIX_FMT_NV16:
      return SPA_VIDEO_FORMAT_NV16;
    case V4L2_PIX_FMT_NV61:
      return SPA_VIDEO_FORMAT_NV61;
//    case V4L2_PIX_FMT_NV24:
//    case V4L2_PIX_FMT_NV42:
//    case V4L2_PIX_FMT_HM12:
...
#if defined (FFMPEG_SUPPORT)
bool
Stream_MediaFramework_Tools::isFloat (enum AVSampleFormat sampleFormat_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MediaFramework_Tools::isFloat"));
...
bool
Stream_MediaFramework_Tools::isAudioCodecId (enum AVCodecID codecId_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_MediaFramework_Tools::isAudioCodecId"));

  return (avcodec_get_type (codecId_in) == AVMEDIA_TYPE_AUDIO);
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_MediaFramework_Tools::AVHWDeviceTypeToPixelFormat"));
