...
{
  STREAM_TRACE (ACE_TEXT ("Stream_MediaFramework_DirectSound_Tools::getAudioRendererFormat"));
  ...
  {
    ACE_DEBUG ((LM_ERROR,
                ACE_TEXT ("failed to retrieve render device handle (id was: \"%s\"), returning\n"),
