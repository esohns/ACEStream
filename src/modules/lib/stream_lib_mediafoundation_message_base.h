...
#ifndef STREAM_LIB_MEDIAFOUNDATION_MESSAGE_BASE_H
#define STREAM_LIB_MEDIAFOUNDATION_MESSAGE_BASE_H
 ...
 //, public IMFSample
{
 ...
 protected:
  Stream_MediaFramework_MediaFoundation_MessageBase_T (unsigned int); // size
...
#include "stream_lib_mediafoundation_message_base.inl"
