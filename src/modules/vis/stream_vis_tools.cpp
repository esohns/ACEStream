...
Stream_Visualization_Tools::rendererToModuleName (enum Stream_Visualization_AudioRenderer renderer_in)
{
  ...
  switch (renderer_in)
  {
    case STREAM_VISUALIZATION_AUDIORENDERER_CONSOLE:
      result = ACE_TEXT_ALWAYS_CHAR (STREAM_VIS_CONSOLE_AUDIO_DEFAULT_NAME_STRING);
      break;
    case STREAM_VISUALIZATION_AUDIORENDERER_GTK_CAIRO_SPECTRUMANALYZER:
      result = ACE_TEXT_ALWAYS_CHAR (STREAM_VIS_GTK_SPECTRUM_ANALYZER_DEFAULT_NAME_STRING);
      break;
    case STREAM_VISUALIZATION_VIDEORENDERER_INVALID:
...
Stream_Visualization_Tools::rendererToModuleName (enum Stream_Visualization_VideoRenderer renderer_in)
{
  ...
  switch (renderer_in)
  {
    case STREAM_VISUALIZATION_VIDEORENDERER_CONSOLE:
      result = ACE_TEXT_ALWAYS_CHAR (STREAM_VIS_CONSOLE_VIDEO_DEFAULT_NAME_STRING); break;
    ...
    case STREAM_VISUALIZATION_VIDEORENDERER_DIRECTDRAW_3D_12:
      result = ACE_TEXT_ALWAYS_CHAR (STREAM_VIS_DIRECT3D_12_DEFAULT_NAME_STRING); break;
