...
Stream_Module_Vis_Curses_Window_T<ACE_SYNCH_USE,
                                  ...
                                  SessionMessageType,
                                  SessionDataContainerType,
                                  MediaType>::classifyPixelGrey (float red_in,
                                                                 float green_in,
                                                                 float blue_in,
                                                                 chtype& symbol_out,
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Module_Vis_Curses_Window_T::classifyPixelGrey"));
...
Stream_Module_Vis_Curses_Window_T<ACE_SYNCH_USE,
                                  ...
                                  SessionMessageType,
                                  SessionDataContainerType,
                                  MediaType>::classifyPixelHSV (float red_in,
                                                                float green_in,
                                                                float blue_in,
                                                                chtype& symbol_out,
                                                                ACE_INT32& foreGroundColor_out,
                                                                ACE_INT32& backGroundColor_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Module_Vis_Curses_Window_T::classifyPixelHSV"));
...
Stream_Module_Vis_Curses_Window_T<ACE_SYNCH_USE,
                                  ...
                                  SessionMessageType,
                                  SessionDataContainerType,
                                  MediaType>::classifyPixelOLC (float red_in,
                                                                float green_in,
                                                                float blue_in,
                                                                chtype& symbol_out,
                                                                ACE_INT32& foreGroundColor_out,
                                                                ACE_INT32& backGroundColor_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Module_Vis_Curses_Window_T::classifyPixelOLC"));
