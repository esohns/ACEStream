...
//#endif // COMMON_OS_WIN32_TARGET_PLATFORM(0x0602)
      ...
      HWND window_h = inherited2::convert (inherited::configuration_->window);
      ACE_ASSERT (window_h);
      ...
      //  goto error;
      //} // end IF
      //get_service_p->Release (); get_service_p = NULL;

      video_display_control_p->Release (); video_display_control_p = NULL;
...
error:
      ...
      //if (videoSampleAllocator_)
      //{
      //  videoSampleAllocator_->Release (); videoSampleAllocator_ = NULL;
      //} // end IF
      //if (streamSink_)
      //{
      //  streamSink_->Release (); streamSink_ = NULL;
      //} // end IF
      if (mediaSession_)
      {
...
continue_:
    ...
    case STREAM_SESSION_MESSAGE_END:
    {
      ...
      //if (videoDisplayControl_)
      //{
      //  videoDisplayControl_->Release (); videoDisplayControl_ = NULL;
      //} // end IF
      //if (streamSink_)
      //{
      //  streamSink_->Release (); streamSink_ = NULL;
                                                               ...
                                                               Stream_IAllocator* allocator_in)
{
  ...
  //{
  //  ULONG reference_count = configuration_in.direct3DDevice->AddRef ();
                                    ...
                                    UserDataType>::initialize (const struct _AMMediaType& mediaType_in)
{
  ...
  if (FAILED (result))
  {
    ACE_DEBUG ((LM_ERROR,
                ...
                inherited::mod_->name (),
                ACE_TEXT (Common_Error_Tools::errorToString (result).c_str ())));
    delete[] stream_descriptors_pp; stream_descriptors_pp = NULL;
    return false;
  } // end IF
  ...
  for (unsigned int i = 0; i < number_of_streams; ++i)
  {
    ...
    if (FAILED (result))
    {
      ...
      delete [] media_types_pp; media_types_pp = NULL;
      return false;
    } // end IF
...
Stream_Vis_Target_MediaFoundation_T<ACE_SYNCH_USE,
                                    ...
                                    SessionDataType,
                                    SessionDataContainerType,
                                    UserDataType>::initialize_Session (HWND windowHandle_in,
                                                                       ...
                                                                       IMFMediaSession* IMFMediaSession_in)
{
  ...
  ACE_Time_Value timeout (STREAM_LIB_MEDIAFOUNDATION_TOPOLOGY_GET_TIMEOUT_S,
                          0);
  ...
  if (!node_id || !window_handle)
  {
    ...
    window_handle =
      CreateWindowEx (window_style_ex,                                  // dwExStyle
                      ...
                      COMMON_UI_WINDOW_DEFAULT_WIDTH, COMMON_UI_WINDOW_DEFAULT_HEIGHT, // width, height
...
continue_:
  ...
  if (FAILED (result))
  {
    ACE_DEBUG ((LM_ERROR,
                ...
                inherited::mod_->name (),
                ACE_TEXT (Common_Error_Tools::errorToString (result).c_str ())));
    video_presenter_p->Release (); video_presenter_p = NULL;
    goto error;
  } // end IF
  video_presenter_p->Release (); video_presenter_p = NULL;
  result =
...
error:
  ...
  if (IMFMediaSink_out)
  {
    IMFMediaSink_out->Release (); IMFMediaSink_out = NULL;
  } // end IF
