...
{
  STREAM_VISUALIZATION_FRAMEWORK_CONSOLE = 0,
...
{
  STREAM_VISUALIZATION_AUDIORENDERER_CONSOLE = 0,
  STREAM_VISUALIZATION_AUDIORENDERER_GTK_CAIRO_SPECTRUMANALYZER,
  ////////////////////////////////////////
  STREAM_VISUALIZATION_AUDIORENDERER_MAX,
  STREAM_VISUALIZATION_AUDIORENDERER_INVALID = -1
};

enum Stream_Visualization_VideoRenderer
{
  STREAM_VISUALIZATION_VIDEORENDERER_CONSOLE = 0,
  STREAM_VISUALIZATION_VIDEORENDERER_CURSES,
  ...
  STREAM_VISUALIZATION_VIDEORENDERER_DIRECTDRAW_3D_12,
...
#endif // ACE_WIN32 || ACE_WIN64
  STREAM_VISUALIZATION_VIDEORENDERER_OPENGL_GLUT,
  ////////////////////////////////////////
  STREAM_VISUALIZATION_VIDEORENDERER_MAX,
  STREAM_VISUALIZATION_VIDEORENDERER_INVALID = -1
};
...
enum Stream_Visualization_WindowFunctionType
{
  STREAM_VISUALIZATION_WINDOWFUNCTION_NONE = 0,
  STREAM_VISUALIZATION_WINDOWFUNCTION_BLACKMAN,
  STREAM_VISUALIZATION_WINDOWFUNCTION_HAMMING,
  STREAM_VISUALIZATION_WINDOWFUNCTION_HANN,
  ////////////////////////////////////////
