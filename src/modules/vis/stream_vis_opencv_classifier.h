...
#ifndef STREAM_VIS_OPENCV_CLASSIFIER_T_H
#define STREAM_VIS_OPENCV_CLASSIFIER_T_H
...
extern const char libacestream_default_vis_opencv_classifier_module_name_string[];
...
#endif // ACE_WIN32 || ACE_WIN64
{
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
  Stream_Visualization_OpenCVClassifier_T (ISTREAM_T*); // stream handle
#else
  Stream_Visualization_OpenCVClassifier_T (typename inherited::ISTREAM_T*); // stream handle
#endif // ACE_WIN32 || ACE_WIN64
  inline virtual ~Stream_Visualization_OpenCVClassifier_T () {}
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Stream_Visualization_OpenCVClassifier_T ())
...
#include "stream_vis_opencv_classifier.inl"
