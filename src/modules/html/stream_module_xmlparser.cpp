...
const char libacestream_default_xml_parser_module_name_string[] =
...
void
stream_xml_parser_sax_default_error_cb (void* userData_in,
                                        const char* message_in,
                                        ...)
{
  STREAM_TRACE (ACE_TEXT ("::stream_xml_parser_sax_default_error_cb"));
                                                   ...
                                                   xmlErrorPtr error_in)
{
  ...
  ACE_DEBUG ((LM_ERROR,
              ACE_TEXT ("stream_xml_parser_sax_default_structured_error_cb: %s"),
