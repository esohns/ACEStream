...
#ifndef STREAM_MODULE_ML_TOOLS_H
#define STREAM_MODULE_ML_TOOLS_H
...
class Stream_Module_MachineLearning_Tools
{
 ...
 private:
  ...
  ACE_UNIMPLEMENTED_FUNC (Stream_Module_MachineLearning_Tools& operator= (const Stream_Module_MachineLearning_Tools&))
};
