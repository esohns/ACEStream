...
#ifndef STREAM_MODULE_TCPIO_H
#define STREAM_MODULE_TCPIO_H
...
class Stream_Module_TCPWriter_T // --> output
...
{
 public:
  Stream_Module_TCPWriter_T ();
  virtual ~Stream_Module_TCPWriter_T ();
...
private:
  ...
  ACE_UNIMPLEMENTED_FUNC (Stream_Module_TCPWriter_T& operator= (const Stream_Module_TCPWriter_T&))
...
{
 public:
   Stream_Module_TCPReader_T ();
   virtual ~Stream_Module_TCPReader_T ();
 ...
 private:
  ...
  ACE_UNIMPLEMENTED_FUNC (Stream_Module_TCPReader_T (const Stream_Module_TCPReader_T&))
  ACE_UNIMPLEMENTED_FUNC (Stream_Module_TCPReader_T& operator= (const Stream_Module_TCPReader_T&))

  typename ConnectionManagerType::CONNECTION_T* connection_;
  bool                                          isInitialized_;
};

#include "stream_module_tcpio.inl"
