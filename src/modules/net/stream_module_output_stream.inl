...
Stream_Module_Output_Stream_T<TaskSynchType,
                              TimePolicyType,
                              StatusType,
                              StateType,
                              ConfigurationType,
                              ...
                              SessionMessageType,
                              ProtocolMessageType>::Stream_Module_Output_Stream_T ()
 : inherited ()
 , queueReader_ (ACE_TEXT_ALWAYS_CHAR ("QueueReader"),
                 NULL,
                 false)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Module_Output_Stream_T::Stream_Module_Output_Stream_T"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Module_Output_Stream_T::ping"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Module_Output_Stream_T::initialize"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Module_Output_Stream_T::collect"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Module_Output_Stream_T::report"));
