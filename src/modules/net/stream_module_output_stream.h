...
#ifndef STREAM_MODULE_OUTPUT_STREAM_H
#define STREAM_MODULE_OUTPUT_STREAM_H
...
class Stream_Module_Output_Stream_T
...
{
 public:
  Stream_Module_Output_Stream_T ();
  virtual ~Stream_Module_Output_Stream_T ();
 ...
 private:
  ...
  // convenient types
  typedef Stream_Module_Output_Stream_T<TaskSynchType,
                                        TimePolicyType,
                                        /////////////////
                                        StatusType,
                                        StateType,
  ...
  ACE_UNIMPLEMENTED_FUNC (Stream_Module_Output_Stream_T (const Stream_Module_Output_Stream_T&))
  ACE_UNIMPLEMENTED_FUNC (Stream_Module_Output_Stream_T& operator= (const Stream_Module_Output_Stream_T&))
