...
#ifndef STREAM_MODULE_TCPSOURCE_H
#define STREAM_MODULE_TCPSOURCE_H
...
class Stream_Module_TCPSource_T
...
//  ACE_UNIMPLEMENTED_FUNC (Stream_Module_TCPSource_T ())
  ACE_UNIMPLEMENTED_FUNC (Stream_Module_TCPSource_T (const Stream_Module_TCPSource_T&))
