...
const char libacestream_default_dev_mic_source_gstreamer_module_name_string[] =
  ACE_TEXT_ALWAYS_CHAR (STREAM_DEV_MIC_SOURCE_GSTREAMER_DEFAULT_NAME_STRING);

//////////////////////////////////////////

gboolean
acestream_dev_mic_source_gstreamer_bus_cb (GstBus* bus_in,
                                           GstMessage* message_in,
                                           gpointer data_in)
{
  STREAM_TRACE (ACE_TEXT ("acestream_dev_mic_source_gstreamer_bus_cb"));

  // sanity check(s)
  struct ACEStream_Device_Mic_Source_GStreamer_CBData* cb_data_p =
    static_cast<struct ACEStream_Device_Mic_Source_GStreamer_CBData*> (data_in);
...
GstFlowReturn
acestream_dev_mic_source_gstreamer_new_sample_cb (GstElement* sink_in,
                                                  gpointer userData_in)
{
  // sanity check(s)
  struct ACEStream_Device_Mic_Source_GStreamer_CBData* cb_data_p =
    static_cast<struct ACEStream_Device_Mic_Source_GStreamer_CBData*> (userData_in);
  ACE_ASSERT (cb_data_p);
