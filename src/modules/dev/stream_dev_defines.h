...
// WASAPI
#define STREAM_DEV_WASAPI_CAPTURE_DEFAULT_SHAREMODE               AUDCLNT_SHAREMODE_EXCLUSIVE
#define STREAM_DEV_WASAPI_RENDER_DEFAULT_SHAREMODE                AUDCLNT_SHAREMODE_SHARED
