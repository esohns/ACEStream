...
Stream_Module_CamSource_T<SessionMessageType,
                          MessageType,
                          ModuleHandlerConfigurationType,
                          SessionDataType>::Stream_Module_CamSource_T ()
 : inherited ()
 , isInitialized_ (false)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Module_CamSource_T::Stream_Module_CamSource_T"));
...
//{
//  STREAM_TRACE (ACE_TEXT ("Stream_Module_CamSource_T::handleDataMessage"));
//
...
Stream_Module_CamSource_T<SessionMessageType,
                            ...
                            SessionDataType>::handleSessionMessage (SessionMessageType*& message_inout,
                                                                    bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Module_CamSource_T::handleSessionMessage"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Module_CamSource_T::initialize"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Module_CamSource_T::get"));
