...
#ifndef STREAM_MODULE_CAMSOURCE_H
#define STREAM_MODULE_CAMSOURCE_H
...
class Stream_Module_CamSource_T
...
{
 public:
  Stream_Module_CamSource_T ();
  virtual ~Stream_Module_CamSource_T ();
 ...
 private:
  ...
  ACE_UNIMPLEMENTED_FUNC (Stream_Module_CamSource_T (const Stream_Module_CamSource_T&))
  ACE_UNIMPLEMENTED_FUNC (Stream_Module_CamSource_T& operator= (const Stream_Module_CamSource_T&))
