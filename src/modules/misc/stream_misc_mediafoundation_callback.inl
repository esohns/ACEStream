...
Stream_Misc_MediaFoundation_Callback_T<ConfigurationType>::Stream_Misc_MediaFoundation_Callback_T ()
 ...
 , referenceCount_ (1)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_MediaFoundation_Callback_T::Stream_Misc_MediaFoundation_Callback_T"));
...
template <typename ConfigurationType>
bool
Stream_Misc_MediaFoundation_Callback_T<ConfigurationType>::initialize (const ConfigurationType& configuration_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_MediaFoundation_Callback_T::initialize"));
...
template <typename ConfigurationType>
HRESULT
Stream_Misc_MediaFoundation_Callback_T<ConfigurationType>::QueryInterface (REFIID IID_in,
                                                                           void** interface_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_MediaFoundation_Callback_T::QueryInterface"));
...
template <typename ConfigurationType>
ULONG
Stream_Misc_MediaFoundation_Callback_T<ConfigurationType>::Release ()
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_MediaFoundation_Callback_T::Release"));
...
template <typename ConfigurationType>
HRESULT
Stream_Misc_MediaFoundation_Callback_T<ConfigurationType>::GetParameters (DWORD* flags_out,
                                                                          DWORD* queue_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_MediaFoundation_Callback_T::GetParameters"));
...
template <typename ConfigurationType>
HRESULT
Stream_Misc_MediaFoundation_Callback_T<ConfigurationType>::Invoke (IMFAsyncResult* asyncResult_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_MediaFoundation_Callback_T::Invoke"));
