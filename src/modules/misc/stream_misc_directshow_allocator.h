...
class Stream_Misc_DirectShow_AllocatorBase_T
...
{
 public:
   Stream_Misc_DirectShow_AllocatorBase_T (TCHAR*,                                                   // name
  ...
  virtual ~Stream_Misc_DirectShow_AllocatorBase_T ();
 ...
 private:
  ...
  //ACE_UNIMPLEMENTED_FUNC (Stream_Misc_DirectShow_AllocatorBase_T ())
  ACE_UNIMPLEMENTED_FUNC (Stream_Misc_DirectShow_AllocatorBase_T (const Stream_Misc_DirectShow_AllocatorBase_T&))
  ACE_UNIMPLEMENTED_FUNC (Stream_Misc_DirectShow_AllocatorBase_T& operator= (const Stream_Misc_DirectShow_AllocatorBase_T&))
...
//          typename MessageType,
//          typename SessionMessageType>
//class Stream_Misc_DirectShow_HeapAllocatorBase_T
...
//{
// public:
//  Stream_Misc_DirectShow_HeapAllocatorBase_T ();
//  virtual ~Stream_Misc_DirectShow_HeapAllocatorBase_T ();
//
//  // implement Common_IInitialize_T
//  virtual bool initialize (const ConfigurationType&);
//
...
//
//  //ACE_UNIMPLEMENTED_FUNC (Stream_Misc_DirectShow_HeapAllocatorBase_T ())
//  ACE_UNIMPLEMENTED_FUNC (Stream_Misc_DirectShow_HeapAllocatorBase_T (const Stream_Misc_DirectShow_HeapAllocatorBase_T&))
//  ACE_UNIMPLEMENTED_FUNC (Stream_Misc_DirectShow_HeapAllocatorBase_T& operator= (const Stream_Misc_DirectShow_HeapAllocatorBase_T&))
//};

// include template implementation
#include "stream_misc_directshow_allocator.inl"
