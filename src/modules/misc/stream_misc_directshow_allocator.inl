...
Stream_Misc_DirectShow_AllocatorBase_T<ConfigurationType,
                                       MessageType,
                                       SessionMessageType>::Stream_Misc_DirectShow_AllocatorBase_T (TCHAR* name_in,
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::Stream_Misc_DirectShow_AllocatorBase_T"));
...
Stream_Misc_DirectShow_AllocatorBase_T<ConfigurationType,
                                       MessageType,
                                       SessionMessageType>::~Stream_Misc_DirectShow_AllocatorBase_T ()
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::~Stream_Misc_DirectShow_AllocatorBase_T"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::SetProperties"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::GetProperties"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::Commit"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::Decommit"));
...
Stream_Misc_DirectShow_AllocatorBase_T<ConfigurationType,
                                       ...
                                       SessionMessageType>::GetBuffer (IMediaSample** mediaSample_out,
                                                                       ...
                                                                       DWORD flags_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::GetBuffer"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::ReleaseBuffer"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::block"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::malloc"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::calloc"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::free"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::cache_depth"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::cache_size"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::initialize"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::dump_state"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::remove"));
...
Stream_Misc_DirectShow_AllocatorBase_T<ConfigurationType,
                                       ...
                                       SessionMessageType>::bind (const char* name_in,
                                                                  ...
                                                                  int duplicates_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::bind"));
...
Stream_Misc_DirectShow_AllocatorBase_T<ConfigurationType,
                                       ...
                                       SessionMessageType>::trybind (const char* name_in,
                                                                     void*& pointer_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::trybind"));
...
Stream_Misc_DirectShow_AllocatorBase_T<ConfigurationType,
                                       ...
                                       SessionMessageType>::find (const char* name_in,
                                                                  void*& pointer_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::find"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::unbind"));
...
Stream_Misc_DirectShow_AllocatorBase_T<ConfigurationType,
                                       ...
                                       SessionMessageType>::sync (ssize_t length_in,
                                                                  int flags_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::sync"));
...
Stream_Misc_DirectShow_AllocatorBase_T<ConfigurationType,
                                       ...
                                       SessionMessageType>::protect (ssize_t length_in,
                                                                     int protection_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_Misc_DirectShow_AllocatorBase_T::protect"));
