...
if test "x$1" = "x--debugger"; then
	...
	if test "xYES" = "xYES"; then
		...
		/usr/bin/gdb -batch -command=$bindir/gdbscript --return-child-result /mnt/win_d/projects/ACEStream/clang/test_i/filestream/filetarget 
	else
		"/mnt/win_d/projects/ACEStream/clang/test_i/filestream/filetarget" -l -t 
	fi
else
	"/mnt/win_d/projects/ACEStream/clang/test_i/filestream/filetarget" -l -t 
fi
