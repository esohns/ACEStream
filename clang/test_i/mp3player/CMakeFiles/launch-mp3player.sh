...
if test "x$1" = "x--debugger"; then
	...
	if test "xYES" = "xYES"; then
		...
		/usr/bin/gdb -batch -command=$bindir/gdbscript --return-child-result /mnt/win_d/projects/ACEStream/clang/test_i/mp3player/mp3player 
	else
		"/mnt/win_d/projects/ACEStream/clang/test_i/mp3player/mp3player" -c.\..\..\..\test_i\http_get\etc\options.cnf -d news -e articles -f output.txt -l -p 80 -t -u http://www.heise.de/newsticker.html 
	fi
else
	"/mnt/win_d/projects/ACEStream/clang/test_i/mp3player/mp3player" -c.\..\..\..\test_i\http_get\etc\options.cnf -d news -e articles -f output.txt -l -p 80 -t -u http://www.heise.de/newsticker.html 
fi
