...
Stream_POPReceive_SignalHandler::Stream_POPReceive_SignalHandler ()
: inherited (this) // event handler handle
{
  STREAM_TRACE (ACE_TEXT ("Stream_POPReceive_SignalHandler::Stream_POPReceive_SignalHandler"));
...
//check_shutdown:
  ...
  if (shutdown)
  {
    ...
    POP_IConnection_Manager_t* connection_manager_p =
      POP_CONNECTIONMANAGER_SINGLETON::instance ();
