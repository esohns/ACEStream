...
Stream_POPReceive_EventHandler_T<NotificationType,
...
#endif // GUI_SUPPORT
#if defined (GUI_SUPPORT)
                                 SessionMessageType>::Stream_POPReceive_EventHandler_T (struct Stream_POPReceive_UI_CBData* CBData_in
#if defined (GTK_USE)
                                                                                       )
#elif defined (QT_USE)
                                                                                       )
...
#endif // GTK_USE
#else
                                 SessionMessageType>::Stream_POPReceive_EventHandler_T ()
#endif // GUI_SUPPORT
#if defined (GUI_SUPPORT)
 : CBData_ (CBData_in)
#if defined (WXWIDGETS_USE)
 ...
 , sessionData_ (NULL)
{
  STREAM_TRACE (ACE_TEXT ("Stream_POPReceive_EventHandler_T::Stream_POPReceive_EventHandler_T"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_POPReceive_EventHandler_T::start"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_POPReceive_EventHandler_T::end"));
