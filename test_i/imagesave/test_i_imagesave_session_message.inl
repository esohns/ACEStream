...
Test_I_SessionMessage_T<DataMessageType,
                        SessionDataType>::Test_I_SessionMessage_T (Stream_SessionId_t sessionId_in,
...
template <typename DataMessageType,
          typename SessionDataType>
Test_I_SessionMessage_T<DataMessageType,
                        SessionDataType>::Test_I_SessionMessage_T (const Test_I_SessionMessage_T<DataMessageType,
