...
continue_:
  ...
  session_data_p =
    &const_cast<Stream_CameraAR_DirectShow_SessionData&> (inherited::sessionData_->getR ());
...
Stream_CameraAR_MediaFoundation_Stream::initialize (const inherited::CONFIGURATION_T& configuration_in)
{
  ...
  session_data_p =
    &const_cast<Stream_CameraAR_MediaFoundation_SessionData&> (inherited::sessionData_->getR ());
  iterator =
      const_cast<inherited::CONFIGURATION_T&> (configuration_in).find (ACE_TEXT_ALWAYS_CHAR (""));
...
//  Stream_CameraAR_V4L_Source* source_impl_p = NULL;
  ...
  session_data_p =
    &const_cast<Stream_CameraAR_V4L_SessionData&> (inherited::sessionData_->getR ());
  iterator =
  ...
  // ******************* Camera Source ************************
//  source_impl_p =
//    dynamic_cast<Stream_CameraAR_V4L_Source*> (source_.writer ());
//  if (!source_impl_p)
//  {
//    ACE_DEBUG ((LM_ERROR,
