...
Stream_CameraAR_EventHandler_T<NotificationType,
                               DataMessageType,
                               SessionMessageType>::Stream_CameraAR_EventHandler_T ()
 : sessionData_ (NULL)
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraAR_EventHandler_T::Stream_CameraAR_EventHandler_T"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraAR_EventHandler_T::start"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraAR_EventHandler_T::notify"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraAR_EventHandler_T::end"));
