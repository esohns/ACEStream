...
#ifndef TEST_I_CAMERA_AR_MODULE_PGE_H
...
template <typename TaskType, // Stream_TaskBaseSynch_T || Stream_TaskBaseAsynch_T
          typename MediaType>
class Test_I_CameraAR_Module_PGE_T
 : public TaskType
 ...
 , public olc::PixelGameEngine
{
 ...
 public:
  ...
  Test_I_CameraAR_Module_PGE_T (typename TaskType::ISTREAM_T*); // stream handle
#else
  Test_I_CameraAR_Module_PGE_T (typename inherited::ISTREAM_T*); // stream handle
#endif // ACE_WIN32 || ACE_WIN64
  inline virtual ~Test_I_CameraAR_Module_PGE_T () {}
...
#include "test_i_camera_ar_module_pge.inl"
