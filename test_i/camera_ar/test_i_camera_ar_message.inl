...
Stream_CameraAR_Message_T<DataType,
                          SessionDataType>::Stream_CameraAR_Message_T (Stream_SessionId_t sessionId_in,
                                                                       unsigned int size_in)
 : inherited (sessionId_in,
              size_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraAR_Message_T::Stream_CameraAR_Message_T"));
...
template <typename DataType,
          typename SessionDataType>
Stream_CameraAR_Message_T<DataType,
                          SessionDataType>::Stream_CameraAR_Message_T (const OWN_TYPE_T& message_in)
...
template <typename DataType,
          typename SessionDataType>
Stream_CameraAR_Message_T<DataType,
                          SessionDataType>::~Stream_CameraAR_Message_T ()
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraAR_Message_T::~Stream_CameraAR_Message_T"));
...
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraAR_Message_T::duplicate"));

  OWN_TYPE_T* message_p = NULL;

  // create a new Stream_CameraAR_Message_T that contains unique copies of
