...
Test_I_LibreOffice_DocumentHandler::Test_I_LibreOffice_DocumentHandler ()
 : inherited ()
 , resolver_ ()
{
  STREAM_TRACE (ACE_TEXT ("Test_I_LibreOffice_DocumentHandler::Test_I_LibreOffice_DocumentHandler"));

}

void
Test_I_LibreOffice_DocumentHandler::initialize (::com::sun::star::uno::Reference<::com::sun::star::uno::XComponentContext>& context_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_LibreOffice_DocumentHandler::initialize"));
...
void SAL_CALL
Test_I_LibreOffice_DocumentHandler::handle (const ::com::sun::star::uno::Reference<::com::sun::star::task::XInteractionRequest>& request_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_LibreOffice_DocumentHandler::handle"));
...
Test_I_LibreOffice_SpreadsheetWriter::Test_I_LibreOffice_SpreadsheetWriter (ISTREAM_T* stream_in)
 : inherited (stream_in)
 , document_ ()
 , handler_2 (NULL)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_LibreOffice_SpreadsheetWriter::Test_I_LibreOffice_SpreadsheetWriter"));

//  ACE_NEW_NORETURN (handler_,
//                    Test_I_LibreOffice_DocumentHandler ());
  handler_2 = new Test_I_LibreOffice_DocumentHandler ();
  if (!handler_2)
  {
...
Test_I_LibreOffice_SpreadsheetWriter::~Test_I_LibreOffice_SpreadsheetWriter ()
{
  STREAM_TRACE (ACE_TEXT ("Test_I_LibreOffice_SpreadsheetWriter::~Test_I_LibreOffice_SpreadsheetWriter"));
...
void
Test_I_LibreOffice_SpreadsheetWriter::handleSessionMessage (Test_I_Stream_SessionMessage*& message_inout,
                                                            bool& passMessageDownstream_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_LibreOffice_SpreadsheetWriter::handleSessionMessage"));
...
//      ACE_ASSERT (result_4);
      ...
      ACE_TCHAR host_address_a[BUFSIZ];
      ACE_OS::memset (host_address_a, 0, sizeof (ACE_TCHAR[BUFSIZ]));
      result_p =
        inherited::configuration_->libreOfficeHost.get_host_addr (host_address_a,
      ...
      connection_string += ACE_TEXT_ALWAYS_CHAR (host_address_a);
...
//                                                                inherited::componentContext_);
      ...
      if (Common_File_Tools::isReadable (inherited::configuration_->fileName))
      {
        ...
        absolute_filename_url = ::rtl::OUString::createFromAscii (ACE_TEXT_ALWAYS_CHAR (STREAM_DOCUMENT_LIBREOFFICE_FRAME_SPREADSHEET_NEW)); // <-- new file
      try {
      ...
      ::com::sun::star::uno::Reference<::com::sun::star::sheet::XSpreadsheetDocument> xSpreadsheetDocument (inherited::component_,
                                                                                                            ::com::sun::star::uno::UNO_QUERY);
...
error:
    ...
    case STREAM_SESSION_MESSAGE_END:
    {
      ...
      //::com::sun::star::uno::Reference<::com::sun::star::container::XIndexAccess> index_p;
...
//      {
//        ::com::sun::star::uno::Reference<::com::sun::star::lang::XComponent> component_p = NULL;
//        try {
//          component_p =
//            ::com::sun::star::uno::Reference<::com::sun::star::lang::XComponent>::query (inherited::componentContext_);
//        } catch (::com::sun::star::uno::Exception& exception_in) {
//            ACE_DEBUG ((LM_ERROR,
