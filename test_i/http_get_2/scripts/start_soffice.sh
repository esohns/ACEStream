...
soffice --accept="socket,host=localhost,port=2083;urp;StarOffice.ServiceManager" --nofirststartwizard --nologo --headless --norestore --invisible >>/var/tmp/libreoffice.log 2>&1
