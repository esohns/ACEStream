...
#ifndef TEST_I_SMTP_SEND_STREAM_H
#define TEST_I_SMTP_SEND_STREAM_H
                        ...
                        SMTP_SessionMessage_t>
{
 ...
 public:
  ...
  inline virtual ~Test_I_SMTPSend_Stream () { inherited::shutdown (); }
  ...
  virtual bool collect (SMTP_Statistic_t&); // return value: statistic data
 ...
 private:
  typedef SMTP_Module_Streamer_T<ACE_MT_SYNCH,
                                 ...
                                 Stream_ControlMessage_t,
                                 SMTP_Message_t,
                                 SMTP_SessionMessage_t> STREAMER_T;
  //typedef SMTP_Module_Parser_T<ACE_MT_SYNCH,
  //                             Common_TimePolicy_t,
  //                             SMTP_SessionMessage_t,
  //                             SMTP_Message_t> PARSER_T;
  typedef SMTP_Module_Parser_T<ACE_MT_SYNCH,
                               Common_TimePolicy_t,
                               struct Stream_SMTPSend_ModuleHandlerConfiguration,
                               Stream_ControlMessage_t,
                               SMTP_Message_t,
                               SMTP_SessionMessage_t> PARSER_T;
  ...
  ACE_UNIMPLEMENTED_FUNC (Test_I_SMTPSend_Stream (const Test_I_SMTPSend_Stream&))
  ACE_UNIMPLEMENTED_FUNC (Test_I_SMTPSend_Stream& operator= (const Test_I_SMTPSend_Stream&))

  // modules
  Stream_SMTPSend_NetSource_Module       source_;
  Stream_SMTPSend_AsynchNetSource_Module asynchSource_;
#if defined (SSL_SUPPORT)
  Stream_SMTPSend_SSLNetSource_Module    SSLSource_;
#endif // SSL_SUPPORT
