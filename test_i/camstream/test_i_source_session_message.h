                                      ...
                                      struct Test_I_Source_DirectShow_UserData>
{
 ...
 private:
  ...
  Test_I_Source_DirectShow_SessionMessage (const Test_I_Source_DirectShow_SessionMessage&);
  ...
  ACE_UNIMPLEMENTED_FUNC (Test_I_Source_DirectShow_SessionMessage ())
  ACE_UNIMPLEMENTED_FUNC (Test_I_Source_DirectShow_SessionMessage& operator= (const Test_I_Source_DirectShow_SessionMessage&))
};
                                      ...
                                      struct Test_I_Source_MediaFoundation_UserData>
{
 ...
 private:
  // copy ctor to be used by duplicate()
  Test_I_Source_MediaFoundation_SessionMessage (const Test_I_Source_MediaFoundation_SessionMessage&);
                                      ...
                                      struct Test_I_Source_V4L2_UserData>
{
 ...
 public:
  // *NOTE*: assumes responsibility for the second argument !
  // *TODO*: (using gcc) cannot pass reference to pointer for some reason
  Test_I_Source_V4L2_SessionMessage (Stream_SessionId_t,
                                     enum Stream_SessionMessageType,
                                     Test_I_Source_V4L2_SessionData_t*&,   // session data container handle
                                     struct Test_I_Source_V4L2_UserData*);
  inline virtual ~Test_I_Source_V4L2_SessionMessage () {}
 ...
 private:
  // copy ctor to be used by duplicate()
  Test_I_Source_V4L2_SessionMessage (const Test_I_Source_V4L2_SessionMessage&);
  ...
  ACE_UNIMPLEMENTED_FUNC (Test_I_Source_V4L2_SessionMessage ())
  ACE_UNIMPLEMENTED_FUNC (Test_I_Source_V4L2_SessionMessage& operator= (const Test_I_Source_V4L2_SessionMessage&))
};
#endif
