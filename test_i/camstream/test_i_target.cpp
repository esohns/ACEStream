...
do_initialize_directshow (IMFMediaType*& mediaType_inout,
                          bool coInitialize_in)
{
         ...
         Stream_Target_SignalHandler& signalHandler_in)
{
  ...
  if (!do_initialize_directshow (configuration.moduleHandlerConfiguration.format,
                                 true))
  {
    ACE_DEBUG ((LM_ERROR,
  ...
  Test_I_Target_Stream_Module_EventHandler_Module event_handler (ACE_TEXT_ALWAYS_CHAR ("EventHandler"),
                                                                 NULL,
                                                                 true);
  Test_I_Target_Stream_Module_EventHandler* event_handler_p =
  ...
  result =
    configuration.moduleHandlerConfiguration.format->SetUINT32 (MF_MT_SAMPLE_SIZE,
                                                                frameSize_in);
  if (FAILED (result))
  {
    ACE_DEBUG ((LM_ERROR,
