...
Test_I_Target_DirectShow_Stream_Message::Test_I_Target_DirectShow_Stream_Message (const Test_I_Target_DirectShow_Stream_Message& message_in)
...
Test_I_Target_DirectShow_Stream_Message::Test_I_Target_DirectShow_Stream_Message (ACE_Data_Block* dataBlock_in,
...
Test_I_Target_DirectShow_Stream_Message::Test_I_Target_DirectShow_Stream_Message (ACE_Allocator* messageAllocator_in)
...
{
  STREAM_TRACE (ACE_TEXT ("Test_I_Target_DirectShow_Stream_Message::duplicate"));

  Test_I_Target_DirectShow_Stream_Message* message_p = NULL;

  // create a new Test_I_Target_DirectShow_Stream_MessageBase that contains unique copies of
  ...
  if (!message_p)
  {
    ...
    if (allocator_p->block ())
      ACE_DEBUG ((LM_CRITICAL,
                  ACE_TEXT ("failed to allocate Test_I_Target_DirectShow_Stream_MessageBase: \"%m\", aborting\n")));
    return NULL;
  } // end IF
  ...
  if (inherited::cont_)
  {
    ...
    {
      ACE_DEBUG ((LM_ERROR,
                  ACE_TEXT ("failed to Test_I_Target_DirectShow_Stream_MessageBase::duplicate(): \"%m\", aborting\n")));
...
ACE_Message_Block*
Test_I_Target_DirectShow_Stream_Message::release (void)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_Target_DirectShow_Stream_Message::release"));
...
std::string
Test_I_Target_DirectShow_Stream_Message::CommandType2String (Test_I_CommandType_t command_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_Target_DirectShow_Stream_Message::CommandType2String"));
...
Test_I_Target_MediaFoundation_Stream_Message::Test_I_Target_MediaFoundation_Stream_Message (const Test_I_Target_MediaFoundation_Stream_Message& message_in)
 : inherited (message_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_Target_MediaFoundation_Stream_Message::Test_I_Target_MediaFoundation_Stream_Message"));
...
Test_I_Target_MediaFoundation_Stream_Message::Test_I_Target_MediaFoundation_Stream_Message (ACE_Data_Block* dataBlock_in,
                                                                                            ACE_Allocator* messageAllocator_in,
                                                                                            bool incrementMessageCounter_in)
 : inherited (dataBlock_in,        // use (don't own (!) memory of-) this data block
              messageAllocator_in, // re-use the same allocator
...
Test_I_Target_MediaFoundation_Stream_Message::Test_I_Target_MediaFoundation_Stream_Message (ACE_Allocator* messageAllocator_in)
 : inherited (messageAllocator_in) // message block allocator
{
  STREAM_TRACE (ACE_TEXT ("Test_I_Target_MediaFoundation_Stream_Message::Test_I_Target_MediaFoundation_Stream_Message"));
...
ACE_Message_Block*
Test_I_Target_MediaFoundation_Stream_Message::duplicate (void) const
{
  STREAM_TRACE (ACE_TEXT ("Test_I_Target_MediaFoundation_Stream_Message::duplicate"));

  Test_I_Target_MediaFoundation_Stream_Message* message_p = NULL;

  // create a new Test_I_Target_MediaFoundation_Stream_MessageBase that contains unique copies of
  // the message block fields, but a (reference counted) shallow duplicate of
  // the ACE_Data_Block.
  ...
  if (inherited::message_block_allocator_ == NULL)
    ACE_NEW_NORETURN (message_p,
                      Test_I_Target_MediaFoundation_Stream_Message (*this));
  else // otherwise, use the existing message_block_allocator
  {
    // *NOTE*: the argument to malloc doesn't matter, as this will be
    //         a shallow copy which just references the same data block
    ACE_NEW_MALLOC_NORETURN (message_p,
                             static_cast<Test_I_Target_MediaFoundation_Stream_Message*> (inherited::message_block_allocator_->calloc (inherited::capacity (),
                                                                                                                                      '\0')),
                             Test_I_Target_MediaFoundation_Stream_Message (*this));
  } // end ELSE
  if (!message_p)
  {
    ...
    if (allocator_p->block ())
      ACE_DEBUG ((LM_CRITICAL,
                  ACE_TEXT ("failed to allocate Test_I_Target_MediaFoundation_Stream_MessageBase: \"%m\", aborting\n")));
    return NULL;
  } // end IF
  ...
  if (inherited::cont_)
  {
    ...
    {
      ACE_DEBUG ((LM_ERROR,
                  ACE_TEXT ("failed to Test_I_Target_MediaFoundation_Stream_MessageBase::duplicate(): \"%m\", aborting\n")));
...
ACE_Message_Block*
Test_I_Target_MediaFoundation_Stream_Message::release (void)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_Target_MediaFoundation_Stream_Message::release"));
...
std::string
Test_I_Target_MediaFoundation_Stream_Message::CommandType2String (Test_I_CommandType_t command_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_Target_MediaFoundation_Stream_Message::CommandType2String"));
