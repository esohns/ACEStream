...
#ifndef TEST_I_AVSAVE_EVENTHANDLER_H
#define TEST_I_AVSAVE_EVENTHANDLER_H
 ...
 : public NotificationType
{
 public:
#if defined (GUI_SUPPORT)
  Stream_AVSave_EventHandler_T (struct Stream_AVSave_UI_CBData* // UI callback data
#if defined (GTK_USE)
                                );
#elif defined (QT_USE)
                                );
...
#endif // GUI_SUPPORT
  inline virtual ~Stream_AVSave_EventHandler_T () {}
 ...
 private:
#if defined (GUI_SUPPORT)
  ACE_UNIMPLEMENTED_FUNC (Stream_AVSave_EventHandler_T ())
#endif // GUI_SUPPORT
  ACE_UNIMPLEMENTED_FUNC (Stream_AVSave_EventHandler_T (const Stream_AVSave_EventHandler_T&))
...
#include "test_i_avsave_eventhandler.inl"
