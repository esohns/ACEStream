                                ...
                                Stream_AVSave_DirectShow_Stream>::choice_resolution_changed_cb (wxCommandEvent& event_in)
{
  ...
  unsigned int framerate_i =
    static_cast<unsigned int> (std::ceil (Stream_MediaFramework_DirectShow_Tools::toFramerate (cb_data_r.configuration->videoStreamConfiguration.configuration_->format.video)));
