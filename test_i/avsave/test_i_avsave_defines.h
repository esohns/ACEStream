...
#define TEST_I_UI_GTK_SPINBUTTON_AUDIO_DATAMESSAGES_NAME "spinbutton_audio_data_messages"
#define TEST_I_UI_GTK_SPINBUTTON_VIDEO_DATAMESSAGES_NAME "spinbutton_video_data_messages"
