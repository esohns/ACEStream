...
void
process_stream_events (struct Stream_AVSave_UI_CBData* CBData_in,
                       bool& finished_out)
{
...
{
  return &Stream_AVSave_DirectShow_WxWidgetsDialog_t::ms_classInfo;
}

wxObject*
Stream_AVSave_DirectShow_WxWidgetsDialog_t::wxCreateObject ()
{
  return new Stream_AVSave_DirectShow_WxWidgetsDialog_t;
}
...
{
  return &Stream_AVSave_MediaFoundation_WxWidgetsDialog_t::ms_classInfo;
}
...
wxBEGIN_EVENT_TABLE (Stream_AVSave_DirectShow_WxWidgetsDialog_t, wxDialog_main)
 ...
 EVT_IDLE (Stream_AVSave_DirectShow_WxWidgetsDialog_t::dialog_main_idle_cb)
...
wxBEGIN_EVENT_TABLE (Stream_AVSave_MediaFoundation_WxWidgetsDialog_t, wxDialog_main)
 ...
 EVT_IDLE (Stream_AVSave_MediaFoundation_WxWidgetsDialog_t::dialog_main_idle_cb)
 EVT_CHAR_HOOK (Stream_AVSave_MediaFoundation_WxWidgetsDialog_t::dialog_main_keydown_cb)
wxEND_EVENT_TABLE ()
#else
...
{
  return &Stream_AVSave_V4L_WxWidgetsDialog_t::ms_classInfo;
}

wxObject*
Stream_AVSave_V4L_WxWidgetsDialog_t::wxCreateObject ()
{
  return new Stream_AVSave_V4L_WxWidgetsDialog_t;
}

//wxBEGIN_EVENT_TABLE (Stream_AVSave_V4L_WxWidgetsDialog_t, wxDialog_main)
// EVT_TOGGLEBUTTON (XRCID ("togglebutton_record"), Stream_AVSave_V4L_WxWidgetsDialog_t::togglebutton_record_toggled_cb)
// EVT_BUTTON (XRCID ("button_snapshot"), Stream_AVSave_V4L_WxWidgetsDialog_t::button_snapshot_clicked_cb)
// EVT_BUTTON (XRCID ("button_cut"), Stream_AVSave_V4L_WxWidgetsDialog_t::button_cut_clicked_cb)
//#if defined (_DEBUG)
// EVT_BUTTON (XRCID ("button_report"), Stream_AVSave_V4L_WxWidgetsDialog_t::button_report_clicked_cb)
//#endif // _DEBUG
// EVT_CHOICE (XRCID ("choice_source"), Stream_AVSave_V4L_WxWidgetsDialog_t::choice_source_changed_cb)
// EVT_BUTTON (XRCID ("button_camera_properties"), Stream_AVSave_V4L_WxWidgetsDialog_t::button_camera_properties_clicked_cb)
// EVT_CHOICE (XRCID ("choice_format"), Stream_AVSave_V4L_WxWidgetsDialog_t::choice_format_changed_cb)
// EVT_CHOICE (XRCID ("choice_resolution"), Stream_AVSave_V4L_WxWidgetsDialog_t::choice_resolution_changed_cb)
// EVT_CHOICE (XRCID ("choice_framerate"), Stream_AVSave_V4L_WxWidgetsDialog_t::choice_framerate_changed_cb)
// EVT_BUTTON (XRCID ("button_reset"), Stream_AVSave_V4L_WxWidgetsDialog_t::button_reset_clicked_cb)
// EVT_TOGGLEBUTTON (XRCID ("togglebutton_save"), Stream_AVSave_V4L_WxWidgetsDialog_t::togglebutton_save_toggled_cb)
// EVT_DIRPICKER_CHANGED (XRCID ("directorypicker_save"), Stream_AVSave_V4L_WxWidgetsDialog_t::picker_directory_save_changed_cb)
// EVT_TOGGLEBUTTON (XRCID ("togglebutton_display"), Stream_AVSave_V4L_WxWidgetsDialog_t::togglebutton_display_toggled_cb)
// EVT_TOGGLEBUTTON (XRCID ("togglebutton_fullscreen"), Stream_AVSave_V4L_WxWidgetsDialog_t::togglebutton_fullscreen_toggled_cb)
// EVT_CHOICE (XRCID ("choice_displayadapter"), Stream_AVSave_V4L_WxWidgetsDialog_t::choice_displayadapter_changed_cb)
// EVT_CHOICE (XRCID ("choice_screen"), Stream_AVSave_V4L_WxWidgetsDialog_t::choice_screen_changed_cb)
// EVT_BUTTON (XRCID ("button_display_settings"), Stream_AVSave_V4L_WxWidgetsDialog_t::button_display_settings_clicked_cb)
// EVT_CHOICE (XRCID ("choice_resolution_2"), Stream_AVSave_V4L_WxWidgetsDialog_t::choice_resolution_2_changed_cb)
// EVT_BUTTON (XRCID ("button_about"), Stream_AVSave_V4L_WxWidgetsDialog_t::button_about_clicked_cb)
// EVT_BUTTON (XRCID ("button_quit"), Stream_AVSave_V4L_WxWidgetsDialog_t::button_quit_clicked_cb)
// EVT_IDLE (Stream_AVSave_V4L_WxWidgetsDialog_t::dialog_main_idle_cb)
// EVT_CHAR_HOOK (Stream_AVSave_V4L_WxWidgetsDialog_t::dialog_main_keydown_cb)
//wxEND_EVENT_TABLE ()
#endif // ACE_WIN32 || ACE_WIN64
...
//  directorypicker_save = XRCCTRL (*this, "directorypicker_save", wxDirPickerCtrl);
  ...
  ACE_ASSERT (stream_iterator != cbdata_r.configuration->videoStreamConfiguration.end ());
  Stream_AVSave_V4L_Stream::CONFIGURATION_T::ITERATOR_T stream_iterator_2 =
  ...
  ACE_ASSERT (stream_iterator_2 != cbdata_r.configuration->videoStreamConfiguration.end ());
...
//                                                                     ACE_DIRECTORY_SEPARATOR_CHAR)));
  ...
  { ACE_ASSERT (!(*stream_iterator_2).second.second->display.device.empty ());
    ...
    ACE_ASSERT (event_p);
    event_p->SetInt ((*stream_iterator_2).second.second->display.device.empty () ? 0 : 1);
    this->QueueEvent (event_p);
    event_p = NULL;
    ...
    ACE_ASSERT (event_p);
    event_p->SetInt (0/*(*stream_iterator_2).second.second->fullScreen ? 1 : 0*/);
    this->QueueEvent (event_p);
    event_p = NULL;
  } // end IF
                                 ...
                                 Stream_AVSave_V4L_Stream>::dialog_main_idle_cb (wxIdleEvent& event_in)
{
  ...
  process_stream_events (&cbdata_r,
                         finished_b);
  if (!finished_b                        &&
      cbdata_r.audioStream->isRunning () &&
      cbdata_r.videoStream->isRunning ())
                                 ...
                                 Stream_AVSave_V4L_Stream>::dialog_main_keydown_cb (wxKeyEvent& event_in)
{
  ...
  switch (event_in.GetUnicodeKey ())
  {
    ...
    {
      // sanity check(s)
      if (!cbdata_r.audioStream->isRunning () ||
          !cbdata_r.videoStream->isRunning ())
                                 ...
                                 Stream_AVSave_V4L_Stream>::togglebutton_record_toggled_cb (wxCommandEvent& event_in)
{
  ...
  Stream_IStreamControlBase* stream_p = cbdata_r.audioStream;
  Stream_IStreamControlBase* stream_2 = cbdata_r.videoStream;
  ACE_ASSERT (stream_p && stream_2);
  ...
  ACE_OS::memset (&cbdata_r.progressData.statistic,
                  0,
                  sizeof (struct Stream_AVSave_StatisticData));

  // step2: update configuration
  // step2a: update capture device configuration
  cbdata_r.configuration->audioStreamConfiguration.configuration_->allocatorConfiguration->defaultBufferSize =
    spinctrl_framesize->GetValue ();
  cbdata_r.configuration->videoStreamConfiguration.configuration_->allocatorConfiguration->defaultBufferSize =
    spinctrl_framesize->GetValue ();
...
continue_:
  ...
  // step3: set up device ?
  switch (cbdata_r.configuration->videoStreamConfiguration.configuration_->renderer)
  {
    case STREAM_VISUALIZATION_VIDEORENDERER_NULL:
      break;
    ...
    default:
    {
      ACE_DEBUG ((LM_ERROR,
                  ...
                  cbdata_r.configuration->videoStreamConfiguration.configuration_->renderer));
      return;
    }
  } // end SWITCH
                                 ...
                                 Stream_AVSave_V4L_Stream>::choice_source_changed_cb (wxCommandEvent& event_in)
{
  ...
  converter.str (ACE_TEXT_ALWAYS_CHAR (""));
  converter.clear ();
  converter << cbdata_r.configuration->videoStreamConfiguration.configuration_->format.video.format.pixelformat;
  index_i =
                                 ...
                                 Stream_AVSave_V4L_Stream>::choice_format_changed_cb (wxCommandEvent& event_in)
{
  ...
  for (Common_Image_ResolutionsIterator_t iterator = resolutions_a.begin ();
       ...
       ++iterator)
  {
    ...
    index_i = choice_resolution->Append (converter.str (),
                                         client_data_p);
    if ((cbdata_r.configuration->videoStreamConfiguration.configuration_->format.video.format.width == (*iterator).width) &&
        (cbdata_r.configuration->videoStreamConfiguration.configuration_->format.video.format.height == (*iterator).height))
                                 ...
                                 Stream_AVSave_V4L_Stream>::choice_resolution_changed_cb (wxCommandEvent& event_in)
{
       ...
       ++iterator)
  {
    ...
    if (cbdata_r.configuration->videoStreamConfiguration.configuration_->format.video.frameRate.numerator == *iterator)
                                 ...
                                 Stream_AVSave_V4L_Stream>::choice_framerate_changed_cb (wxCommandEvent& event_in)
{
  ...
  converter.clear ();
  converter.str (client_data_p->GetData ().ToStdString ());
  converter >> cbdata_r.configuration->videoStreamConfiguration.configuration_->format.video.format.width;
  converter >> cbdata_r.configuration->videoStreamConfiguration.configuration_->format.video.format.height;
  converter.str (ACE_TEXT_ALWAYS_CHAR (""));
  converter.clear ();
  converter.str (choice_framerate->GetString (choice_framerate->GetSelection ()).ToStdString ());
  converter >> cbdata_r.configuration->videoStreamConfiguration.configuration_->format.video.frameRate.numerator;

  // update controls
  if (initializing_)
    togglebutton_record->Enable (true);
  spinctrl_framesize->SetValue (Stream_MediaFramework_Tools::frameSize ((*stream_iterator).second.second->deviceIdentifier.identifier,
                                                                        cbdata_r.configuration->videoStreamConfiguration.configuration_->format.video));
  struct Stream_MediaFramework_V4L_MediaType media_type_s;
  Stream_Device_Tools::getDefaultCaptureFormat ((*stream_iterator).second.second->deviceIdentifier.identifier,
                                                media_type_s);
  button_reset_camera->Enable (!(cbdata_r.configuration->videoStreamConfiguration.configuration_->format.video == media_type_s));
}
void
Stream_AVSave_WxWidgetsDialog_T<wxDialog_main,
                                 Stream_AVSave_ALSA_V4L_WxWidgetsIApplication_t,
                                 ...
                                 Stream_AVSave_V4L_Stream>::togglebutton_fullscreen_toggled_cb (wxCommandEvent& event_in)
{
  ...
  std::string module_name_string =
    Stream_Visualization_Tools::rendererToModuleName (cbdata_r.configuration->videoStreamConfiguration.configuration_->renderer);
  switch (cbdata_r.configuration->videoStreamConfiguration.configuration_->renderer)
  {
    case STREAM_VISUALIZATION_VIDEORENDERER_NULL:
      break;
  ...
  if (!cbdata_r.videoStream->isRunning ())
    return;
  Stream_Module_t* module_p =
    const_cast<Stream_Module_t*> (cbdata_r.videoStream->find (module_name_string.c_str ()));
  ACE_ASSERT (module_p);
  ...
  if (!ifullscreen_p)
  {
    ACE_DEBUG ((LM_ERROR,
                ...
                ACE_TEXT (cbdata_r.videoStream->name ().c_str ()),
...
//  button_display_settings->Enable (togglebutton_display->IsEnabled ());
  ...
  Common_UI_Resolution_t resolution_s;
  resolution_s.width =
      (*stream_iterator).second.second->outputFormat.video.format.width;
  resolution_s.height =
      (*stream_iterator).second.second->outputFormat.video.format.height;
