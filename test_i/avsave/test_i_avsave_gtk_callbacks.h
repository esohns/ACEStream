...
gboolean key_cb (GtkWidget*, GdkEventKey*, gpointer);
...
G_MODULE_EXPORT void button_display_settings_clicked_cb (GtkButton*, gpointer);
G_MODULE_EXPORT void button_display_reset_clicked_cb (GtkButton*, gpointer);
G_MODULE_EXPORT void button_video_format_reset_clicked_cb (GtkButton*, gpointer);
G_MODULE_EXPORT void button_video_hw_settings_clicked_cb (GtkButton*, gpointer);
...
//G_MODULE_EXPORT gboolean window_fullscreen_draw_cb (GtkWidget*, cairo_t*, gpointer);
#else
...
//G_MODULE_EXPORT gboolean window_fullscreen_expose_event_cb (GtkWidget*, GdkEvent*, gpointer);
...
//G_MODULE_EXPORT void window_fullscreen_size_allocate_event_cb (GtkWindow*, GdkEvent*, gpointer);
G_MODULE_EXPORT gboolean drawingarea_audio_key_press_event_cb (GtkWidget*, GdkEventKey*, gpointer);
G_MODULE_EXPORT void filechooserbutton_save_current_folder_changed_cb (GtkFileChooser*, gpointer);
#ifdef __cplusplus
}
#endif /* __cplusplus */
