...
Test_I_DirectShow_Stream::initialize (const CONFIGURATION_T& configuration_in)
{
  ...
  Test_I_ChatBot_DirectShow_SessionData& session_data_r =
    const_cast<Test_I_ChatBot_DirectShow_SessionData&> (session_manager_p->getR (inherited::id_));
...
//#endif // GTKGL_SUPPORT
  ...
  //  Test_I_ChatBot_DirectShowFilter_t* filter_p = NULL;
  ...
  //                                                             0);
  //  ACE_ASSERT (pin_p);
  //  typename Test_I_ChatBot_DirectShowFilter_t::OUTPUT_PIN_T* pin_2 =
  //    dynamic_cast<typename Test_I_ChatBot_DirectShowFilter_t::OUTPUT_PIN_T*> (pin_p);
  //  ACE_ASSERT (pin_2);
...
Test_I_MediaFoundation_Stream::initialize (const CONFIGURATION_T& configuration_in)
{
  ...
  // sanity check(s)
  Test_I_ChatBot_MediaFoundation_SessionData& session_data_r =
    const_cast<Test_I_ChatBot_MediaFoundation_SessionData&> (session_manager_p->getR (inherited::id_));
  inherited::CONFIGURATION_T::ITERATOR_T iterator =
    const_cast<inherited::CONFIGURATION_T&> (configuration_in).find (ACE_TEXT_ALWAYS_CHAR (""));
  ACE_ASSERT (iterator != configuration_in.end ());
  inherited::CONFIGURATION_T::ITERATOR_T iterator_2 =
...
Test_I_MediaFoundation_Stream::getR_7 () const
{
  STREAM_TRACE (ACE_TEXT ("Test_I_MediaFoundation_Stream::getR_7"));
...
Test_I_ALSA_Stream::initialize (const CONFIGURATION_T& configuration_in)
{
  ...
  bool setup_pipeline = configuration_in.configuration_->setupPipeline;
  bool reset_setup_pipeline = false;
  Test_I_ChatBot_ALSA_SessionData* session_data_p = NULL;
  typename inherited::CONFIGURATION_T::ITERATOR_T iterator =
  ...
  session_data_p =
    &const_cast<Test_I_ChatBot_ALSA_SessionData&> (session_manager_p->getR (inherited::id_));
