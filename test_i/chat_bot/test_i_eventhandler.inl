...
Test_I_EventHandler_T<NotificationType,
                      ...
                      InterfaceType,
#endif // WXWIDGETS_USE
                      SessionMessageType>::Test_I_EventHandler_T (struct Test_I_ChatBot_UI_CBData* CBData_in
#if defined (GTK_USE)
                                                                  )
#elif defined (QT_USE)
                                                                  )
...
Test_I_InputHandler_T<NotificationType,
                      ...
                      InterfaceType,
#endif // WXWIDGETS_USE
                      SessionMessageType>::Test_I_InputHandler_T (struct Test_I_ChatBot_UI_CBData* CBData_in
#if defined (GTK_USE)
                                                                  )
#elif defined (QT_USE)
                                                                  )
                                                   ...
                                                   const DataMessageType& message_in)
{
  ...
  enum Test_I_ChatBot_InputCommand command_e =
