...
G_MODULE_EXPORT void button_clear_llm_clicked_cb (GtkWidget*, gpointer);
G_MODULE_EXPORT void button_clear_stt_clicked_cb (GtkWidget*, gpointer);
...
G_MODULE_EXPORT void combobox_tts_changed_cb (GtkWidget*, gpointer);
...
G_MODULE_EXPORT void entry_stt_language_icon_press_cb (GtkEntry*, GtkEntryIconPosition, GdkEvent*, gpointer);
