...
stream_processing_function (void* arg_in)
{
  ...
  struct Test_I_MediaFoundation_UI_CBData* mediafoundation_ui_cb_data_p =
    NULL;
  Test_I_ChatBot_DirectShow_SessionData* directshow_session_data_p =
    NULL;
  Test_I_ChatBot_MediaFoundation_SessionData* mediafoundation_session_data_p =
    NULL;
  ...
  switch (thread_data_base_p->mediaFramework)
  {
    case STREAM_MEDIAFRAMEWORK_DIRECTSHOW:
    {
      ...
      Common_IGetR_2_T<Test_I_ChatBot_DirectShow_SessionData>* iget_p =
        dynamic_cast<Common_IGetR_2_T<Test_I_ChatBot_DirectShow_SessionData>*> (directshow_ui_cb_data_p->stream);
      ACE_ASSERT (iget_p);
      directshow_session_data_p =
        &const_cast<Test_I_ChatBot_DirectShow_SessionData&> (iget_p->getR_2 ());
    ...
    case STREAM_MEDIAFRAMEWORK_MEDIAFOUNDATION:
    {
      ...
      Common_IGetR_2_T<Test_I_ChatBot_MediaFoundation_SessionData>* iget_p =
        dynamic_cast<Common_IGetR_2_T<Test_I_ChatBot_MediaFoundation_SessionData>*> (mediafoundation_ui_cb_data_p->stream);
      ACE_ASSERT (iget_p);
      mediafoundation_session_data_p =
        &const_cast<Test_I_ChatBot_MediaFoundation_SessionData&> (iget_p->getR_2 ());
  ...
  Common_IGetR_2_T<Test_I_ChatBot_ALSA_SessionData>* iget_p =
    dynamic_cast<Common_IGetR_2_T<Test_I_ChatBot_ALSA_SessionData>*> (ui_cb_data_p->stream);
  ACE_ASSERT (iget_p);
  session_data_p =
    &const_cast<Test_I_ChatBot_ALSA_SessionData&> (iget_p->getR_2 ());
                                ...
                                gpointer userData_in)
{
  ...
  struct Test_I_ChatBot_UI_ProgressData* progress_data_p = NULL;
//  GtkSpinButton* spin_button_p = NULL;
