...
{
 public:
   Test_I_EventHandler_T (struct Test_I_ChatBot_UI_CBData* // UI callback data
#if defined (GTK_USE)
                          );
#elif defined (QT_USE)
                          );
 ...
 private:
  ...
  struct Test_I_ChatBot_UI_CBData*             CBData_;
#if defined (WXWIDGETS_USE)
...
{
 public:
  Test_I_InputHandler_T (struct Test_I_ChatBot_UI_CBData* // UI callback data
#if defined (GTK_USE)
                         );
#elif defined (QT_USE)
                         );
