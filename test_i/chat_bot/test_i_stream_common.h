...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
class Test_I_ChatBot_DirectShow_SessionData;
struct Test_I_ChatBot_DirectShow_StreamState
 : Stream_State
{
  Test_I_ChatBot_DirectShow_StreamState ()
   : Stream_State ()
   , sessionData (NULL)
  {}

  Test_I_ChatBot_DirectShow_SessionData* sessionData;
};
                                        ...
                                        struct Stream_UserData>
{
 public:
  ...
  Test_I_ChatBot_DirectShow_SessionData& operator+= (const Test_I_ChatBot_DirectShow_SessionData& rhs_in)
  {
...
typedef Stream_SessionData_T<Test_I_ChatBot_DirectShow_SessionData> Test_I_ChatBot_DirectShow_SessionData_t;

class Test_I_ChatBot_MediaFoundation_SessionData;
 ...
 : Stream_State
{
  ...
  Test_I_ChatBot_MediaFoundation_SessionData* sessionData;
};
                                        ...
                                        struct Stream_UserData>
{
 public:
  ...
  Test_I_ChatBot_MediaFoundation_SessionData& operator+= (const Test_I_ChatBot_MediaFoundation_SessionData& rhs_in)
  {
    // *NOTE*: the idea is to 'merge' the data
    Stream_SessionDataMediaBase_T<struct Test_I_SessionData,
                                  IMFMediaType*,
...
typedef Stream_SessionData_T<Test_I_ChatBot_MediaFoundation_SessionData> Test_I_ChatBot_MediaFoundation_SessionData_t;
#else
class Test_I_ChatBot_ALSA_SessionData;
struct Test_I_ChatBot_ALSA_StreamState
 : Stream_State
{
    Test_I_ChatBot_ALSA_StreamState ()
     : Stream_State ()
     , sessionData (NULL)
    {}

    Test_I_ChatBot_ALSA_SessionData* sessionData;
};
                                        ...
                                        struct Stream_UserData>
{
 public:
  ...
  Test_I_ChatBot_ALSA_SessionData& operator+= (const Test_I_ChatBot_ALSA_SessionData& rhs_in)
  {
    // *NOTE*: the idea is to 'merge' the data
    Stream_SessionDataMediaBase_T<struct Test_I_SessionData,
                                  struct Stream_MediaFramework_ALSA_MediaType,
...
typedef Stream_SessionData_T<Test_I_ChatBot_ALSA_SessionData> Test_I_ChatBot_ALSA_SessionData_t;
#endif // ACE_WIN32 || ACE_WIN64

#if defined (ACE_WIN32) || defined (ACE_WIN64)
typedef Test_I_SessionMessage_T<Test_I_ChatBot_DirectShow_SessionData_t,
                                struct Stream_UserData> Test_I_DirectShow_SessionMessage_t;
typedef Test_I_SessionMessage_T<Test_I_ChatBot_MediaFoundation_SessionData_t,
...
typedef Stream_ISessionDataNotify_T<Test_I_ChatBot_DirectShow_SessionData,
                                    enum Stream_SessionMessageType,
                                    Test_I_DirectShow_Message,
                                    Test_I_DirectShow_SessionMessage_t> Test_I_DirectShow_ISessionNotify_t;
typedef Stream_ISessionDataNotify_T<Test_I_ChatBot_MediaFoundation_SessionData,
                                    enum Stream_SessionMessageType,
                                    Test_I_MediaFoundation_Message,
...
#else
typedef Test_I_SessionMessage_T<Test_I_ChatBot_ALSA_SessionData_t,
...
typedef Stream_ISessionDataNotify_T<Test_I_ChatBot_ALSA_SessionData,
                                    enum Stream_SessionMessageType,
                                    Test_I_Message,
...
{
  Test_I_ChatBot_DirectShow_ModuleHandlerConfiguration ()
   : Test_I_DirectShow_ModuleHandlerConfiguration ()
...
{
  Test_I_ChatBot_MediaFoundation_ModuleHandlerConfiguration ()
   : Test_I_MediaFoundation_ModuleHandlerConfiguration ()
   , bufferSize (MODULE_STAT_ANALYSIS_DEFAULT_BUFFER_SIZE)
   , deviceIdentifier ()
   , dispatch (NULL)
...
{
  Test_I_ChatBot_ALSA_ModuleHandlerConfiguration ()
   : Test_I_ALSA_ModuleHandlerConfiguration ()
   , bufferSize (MODULE_STAT_ANALYSIS_DEFAULT_BUFFER_SIZE)
   , deviceIdentifier ()
   , dispatch (NULL)
...
typedef Stream_Configuration_T<//stream_name_string_,
                               struct Test_I_DirectShow_StreamConfiguration,
                               struct Test_I_ChatBot_DirectShow_ModuleHandlerConfiguration> Test_I_DirectShow_StreamConfiguration_t;
typedef Stream_IStreamControlBase_T<enum Stream_ControlType,
                                    enum Stream_StateMachine_ControlState,
                                    struct Test_I_ChatBot_DirectShow_StreamState> Test_I_DirectShow_IStreamControlBase_t;

typedef Stream_Configuration_T<//stream_name_string_,
                               struct Test_I_MediaFoundation_StreamConfiguration,
                               struct Test_I_ChatBot_MediaFoundation_ModuleHandlerConfiguration> Test_I_MediaFoundation_StreamConfiguration_t;
typedef Stream_IStreamControlBase_T<enum Stream_ControlType,
                                    enum Stream_StateMachine_ControlState,
                                    struct Test_I_ChatBot_MediaFoundation_StreamState> Test_I_MediaFoundation_IStreamControlBase_t;
#else
...
typedef Stream_Configuration_T<//stream_name_string_,
                               struct Test_I_ALSA_StreamConfiguration,
                               struct Test_I_ChatBot_ALSA_ModuleHandlerConfiguration> Test_I_ALSA_StreamConfiguration_t;

typedef Stream_IStreamControlBase_T<enum Stream_ControlType,
                                    enum Stream_StateMachine_ControlState,
                                    struct Test_I_ChatBot_ALSA_StreamState> Test_I_ALSA_IStreamControlBase_t;
#endif // ACE_WIN32 || ACE_WIN64
