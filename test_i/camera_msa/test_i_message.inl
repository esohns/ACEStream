...
Test_I_Message_T<DataType,
                 SessionDataType>::Test_I_Message_T (Stream_SessionId_t sessionId_in,
                                                     size_t size_in)
...
template <typename DataType,
          typename SessionDataType>
Test_I_Message_T<DataType,
                 SessionDataType>::Test_I_Message_T (const OWN_TYPE_T& message_in)
...
template <typename DataType,
          typename SessionDataType>
Test_I_Message_T<DataType,
                 SessionDataType>::~Test_I_Message_T ()
{
  STREAM_TRACE (ACE_TEXT ("Test_I_Message_T::~Test_I_Message_T"));
                 ...
                 SessionDataType>::duplicate (void) const
{
  ...
  // create a new Test_I_Message_T that contains unique copies of
  ...
  if (unlikely (!message_p))
  {
    ...
    if (allocator_p->block ())
      ACE_DEBUG ((LM_CRITICAL,
                  ACE_TEXT ("failed to allocate Test_I_Message_T: \"%m\", aborting\n")));
    return NULL;
  } // end IF
  ...
  if (inherited::cont_)
  {
    ...
    {
      ACE_DEBUG ((LM_ERROR,
                  ACE_TEXT ("failed to Test_I_Message_T::duplicate(): \"%m\", aborting\n")));
...
{
  STREAM_TRACE (ACE_TEXT ("Test_I_Message_T::release"));
