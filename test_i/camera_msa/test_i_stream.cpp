...
bool
Test_I_DirectShow_Stream::initialize (const inherited::CONFIGURATION_T& configuration_in)
{
  ...
  Test_I_CameraMSA_DirectShow_SessionData* session_data_p = NULL;
  inherited::CONFIGURATION_T::ITERATOR_T iterator, iterator_2;
  Test_I_DirectShow_Source* source_impl_p = NULL;
...
continue_:
  ...
  // ******************* Camera Source ************************
  source_impl_p =
    dynamic_cast<Test_I_DirectShow_Source*> (source_.writer ());
  if (!source_impl_p)
  {
    ACE_DEBUG ((LM_ERROR,
...
Test_I_MediaFoundation_Stream::find (const std::string& name_in) const
{
  STREAM_TRACE (ACE_TEXT ("Test_I_MediaFoundation_Stream::find"));

  //if (!ACE_OS::strcmp (name_in.c_str (),
  //                     ACE_TEXT_ALWAYS_CHAR (STREAM_VIS_RENDERER_NULL_MODULE_NAME)))
  //  return const_cast<Test_I_MediaFoundation_DisplayNull_Module*> (&displayNull_);
...
ULONG
Test_I_MediaFoundation_Stream::AddRef ()
{
  STREAM_TRACE (ACE_TEXT ("Test_I_MediaFoundation_Stream::AddRef"));

  return InterlockedIncrement (&referenceCount_);
}
ULONG
Test_I_MediaFoundation_Stream::Release ()
{
  STREAM_TRACE (ACE_TEXT ("Test_I_MediaFoundation_Stream::Release"));
...
HRESULT
Test_I_MediaFoundation_Stream::GetParameters (DWORD* flags_out,
                                              DWORD* queue_out)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_MediaFoundation_Stream::GetParameters"));
...
bool
Test_I_MediaFoundation_Stream::initialize (const inherited::CONFIGURATION_T& configuration_in)
{
  ...
  // ******************* Camera Source ************************
  source_impl_p =
    dynamic_cast<Test_I_MediaFoundation_Source*> (source_.writer ());
  if (!source_impl_p)
  {
    ACE_DEBUG ((LM_ERROR,
...
bool
Test_I_Stream::initialize (const typename inherited::CONFIGURATION_T& configuration_in)
{
