...
struct Test_I_CommandSpeech_DirectShow_MessageData
 : Test_I_DirectShow_MessageData
{
  Test_I_CommandSpeech_DirectShow_MessageData ()
   : Test_I_DirectShow_MessageData ()
   , index (-1)
  {}
...
//typedef Stream_DataBase_T<struct Test_I_CommandSpeech_DirectShow_MessageData> Test_I_CommandSpeech_DirectShow_MessageData_t;

struct Test_I_CommandSpeech_MediaFoundation_MessageData
 : Test_I_MediaFoundation_MessageData
{
  Test_I_CommandSpeech_MediaFoundation_MessageData ()
   : Test_I_MediaFoundation_MessageData ()
   , index (-1)
  {}
...
//typedef Stream_DataBase_T<struct Test_I_CommandSpeech_MediaFoundation_MessageData> Test_I_CommandSpeech_MediaFoundation_MessageData_t;
#else
struct Test_I_CommandSpeech_ALSA_MessageData
 : Test_I_ALSA_MessageData
{
  Test_I_CommandSpeech_ALSA_MessageData ()
   : Test_I_ALSA_MessageData ()
  {}
};
//typedef Stream_DataBase_T<struct Test_I_CommandSpeech_ALSA_MessageData> Test_I_CommandSpeech_ALSA_MessageData_t;
...
class Test_I_DirectShow_Message
 : public Stream_DataMessageBase_T<struct Test_I_CommandSpeech_DirectShow_MessageData,
                                   enum Stream_MessageType,
                                   int>
{
  typedef Stream_DataMessageBase_T<struct Test_I_CommandSpeech_DirectShow_MessageData,
                                   enum Stream_MessageType,
                                   int> inherited;
...
class Test_I_MediaFoundation_Message
 : public Stream_DataMessageBase_T<struct Test_I_CommandSpeech_MediaFoundation_MessageData,
                                   enum Stream_MessageType,
                                   int>
{
  typedef Stream_DataMessageBase_T<struct Test_I_CommandSpeech_MediaFoundation_MessageData,
                                   enum Stream_MessageType,
                                   int> inherited;
...
class Test_I_Message
 : public Stream_DataMessageBase_T<struct Test_I_CommandSpeech_ALSA_MessageData,
                                   enum Stream_MessageType,
                                   int>
{
  typedef Stream_DataMessageBase_T<struct Test_I_CommandSpeech_ALSA_MessageData,
                                   enum Stream_MessageType,
                                   int> inherited;
