...
G_MODULE_EXPORT gboolean drawingarea_key_press_event (GtkWidget*, GdkEventKey, gpointer);
...
G_MODULE_EXPORT gboolean textview_key_press_event (GtkWidget*, GdkEventKey, gpointer);
