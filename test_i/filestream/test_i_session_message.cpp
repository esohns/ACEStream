...
Test_I_Source_SessionMessage::Test_I_Source_SessionMessage (const Test_I_Source_SessionMessage& message_in)
...
ACE_Message_Block*
Test_I_Source_SessionMessage::duplicate (void) const
{
  STREAM_TRACE (ACE_TEXT ("Test_I_Source_SessionMessage::duplicate"));

  Test_I_Source_SessionMessage* message_p = NULL;

  // create a new <Test_I_Source_SessionMessage> that contains unique copies of
  ...
  if (inherited::message_block_allocator_ == NULL)
    ACE_NEW_RETURN (message_p,
                    Test_I_Source_SessionMessage (*this),
                    NULL);

  // *WARNING*: the allocator returns a Test_I_Source_SessionMessageBase<ConfigurationType>
  //            when passing 0 as argument to malloc()
  ACE_NEW_MALLOC_RETURN (message_p,
                         static_cast<Test_I_Source_SessionMessage*> (inherited::message_block_allocator_->malloc (0)),
                         Test_I_Source_SessionMessage (*this),
                         NULL);
