...
typedef Net_UDPSocketHandler_T<ACE_MT_SYNCH,
                               Net_SOCK_Dgram,
                               struct Test_I_Target_SocketHandlerConfiguration> Test_I_InboundUDPSocketHandler_t;
typedef Net_AsynchUDPSocketHandler_T<Net_SOCK_Dgram,
                                     struct Test_I_Target_SocketHandlerConfiguration> Test_I_InboundAsynchUDPSocketHandler_t;
...
typedef Net_UDPConnectionBase_T<ACE_MT_SYNCH,
                                Test_I_InboundUDPSocketHandler_t,
                                Test_I_Target_ConnectionConfiguration_t,
                                struct Test_I_Target_ConnectionState,
                                Test_I_Statistic_t,
                                struct Test_I_Target_SocketHandlerConfiguration,
...
typedef Net_AsynchUDPConnectionBase_T<Test_I_InboundAsynchUDPSocketHandler_t,
                                      Test_I_Target_ConnectionConfiguration_t,
                                      struct Test_I_Target_ConnectionState,
                                      Test_I_Statistic_t,
                                      struct Test_I_Target_SocketHandlerConfiguration,
