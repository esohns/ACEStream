...
if test "x$1" = "x--debugger"; then
	shift
	if test "x" = "xYES"; then
		echo "r -g./test_i/filestream/etc/source.glade -l -t " > $bindir/gdbscript
		echo "bt" >> $bindir/gdbscript
		 -batch -command=$bindir/gdbscript  /mnt/win_d/projects/libACEStream/cmake/test_i/filestream/filesource 
	else
		"/mnt/win_d/projects/libACEStream/cmake/test_i/filestream/filesource" -g./test_i/filestream/etc/source.glade -l -t 
	fi
else
	"/mnt/win_d/projects/libACEStream/cmake/test_i/filestream/filesource" -g./test_i/filestream/etc/source.glade -l -t 
fi
