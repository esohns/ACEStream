...
#ifndef TEST_I_STREAM_2_H
#define TEST_I_STREAM_2_H
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
class Stream_CameraML_DirectShow_Stream_2
                        ...
                        Stream_CameraML_DirectShow_SessionMessage_t>
{
 ...
 public:
  ...
  inline virtual ~Stream_CameraML_DirectShow_Stream_2 () { inherited::shutdown (); }
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Stream_CameraML_DirectShow_Stream_2 (const Stream_CameraML_DirectShow_Stream_2&))
  ACE_UNIMPLEMENTED_FUNC (Stream_CameraML_DirectShow_Stream_2& operator= (const Stream_CameraML_DirectShow_Stream_2&))
  ...
  Stream_CameraML_DirectShow_MediaPipe_Module          mediapipe_;
...
class Stream_CameraML_MediaFoundation_Stream_2
 : public Stream_Base_T<ACE_MT_SYNCH,
                        Common_TimePolicy_t,
                        stream_name_string_,
                        enum Stream_ControlType,
 ...
 , public IMFAsyncCallback
{
 ...
 public:
  ...
  virtual ~Stream_CameraML_MediaFoundation_Stream_2 ();
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Stream_CameraML_MediaFoundation_Stream_2 (const Stream_CameraML_MediaFoundation_Stream_2&))
  ACE_UNIMPLEMENTED_FUNC (Stream_CameraML_MediaFoundation_Stream_2& operator= (const Stream_CameraML_MediaFoundation_Stream_2&))
...
#else
class Stream_CameraML_Stream_2
 : public Stream_Base_T<ACE_MT_SYNCH,
                        Common_TimePolicy_t,
                        stream_name_string_,
                        enum Stream_ControlType,
                        ...
                        Stream_CameraML_SessionMessage_t>
{
 ...
 public:
  ...
  inline virtual ~Stream_CameraML_Stream_2 () { inherited::shutdown (); }
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Stream_CameraML_Stream_2 (const Stream_CameraML_Stream_2&))
  ACE_UNIMPLEMENTED_FUNC (Stream_CameraML_Stream_2& operator= (const Stream_CameraML_Stream_2&))
...
//  Stream_CameraML_StatisticReport_Module statisticReport_;
  ...
  Stream_CameraML_MediaPipe_Module       mediapipe_;
#if defined (GTK_SUPPORT)
