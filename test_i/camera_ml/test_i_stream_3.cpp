...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
Stream_CameraML_DirectShow_Stream_3::Stream_CameraML_DirectShow_Stream_3 ()
 : inherited ()
 , source_ (this,
...
bool
Stream_CameraML_DirectShow_Stream_3::load (Stream_ILayout* layout_in,
                                           bool& delete_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_DirectShow_Stream_3::load"));
...
bool
Stream_CameraML_DirectShow_Stream_3::initialize (const inherited::CONFIGURATION_T& configuration_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_DirectShow_Stream_3::initialize"));
  ...
  Stream_CameraML_DirectShow_SessionData* session_data_p = NULL;
  inherited::CONFIGURATION_T::ITERATOR_T iterator, iterator_2;
  Stream_CameraML_DirectShow_Source* source_impl_p = NULL;
...
continue_:
  ...
  // ******************* Camera Source ************************
  source_impl_p =
    dynamic_cast<Stream_CameraML_DirectShow_Source*> (source_.writer ());
  if (!source_impl_p)
  {
    ACE_DEBUG ((LM_ERROR,
...
Stream_CameraML_MediaFoundation_Stream_3::Stream_CameraML_MediaFoundation_Stream_3 ()
 : inherited ()
 , source_ (this,
 ...
 , referenceCount_ (1)
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_MediaFoundation_Stream_3::Stream_CameraML_MediaFoundation_Stream_3"));
...
Stream_CameraML_MediaFoundation_Stream_3::find (const std::string& name_in) const
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_MediaFoundation_Stream_3::find"));

  //if (!ACE_OS::strcmp (name_in.c_str (),
  //                     ACE_TEXT_ALWAYS_CHAR (STREAM_VIS_RENDERER_NULL_MODULE_NAME)))
  //  return const_cast<Stream_CameraML_MediaFoundation_DisplayNull_Module*> (&displayNull_);

  return inherited::find (name_in);
}

void
Stream_CameraML_MediaFoundation_Stream_3::start ()
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_MediaFoundation_Stream_3::start"));
...
void
Stream_CameraML_MediaFoundation_Stream_3::stop (bool waitForCompletion_in,
                                                  bool recurseUpstream_in,
                                                  bool highPriority_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_MediaFoundation_Stream_3::stop"));
...
HRESULT
Stream_CameraML_MediaFoundation_Stream_3::QueryInterface (const IID& IID_in,
                                                            void** interface_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_MediaFoundation_Stream_3::QueryInterface"));

  static const QITAB query_interface_table[] =
  {
    QITABENT (Stream_CameraML_MediaFoundation_Stream_3, IMFAsyncCallback),
    { 0 },
  };
...
ULONG
Stream_CameraML_MediaFoundation_Stream_3::AddRef ()
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_MediaFoundation_Stream_3::AddRef"));

  return InterlockedIncrement (&referenceCount_);
}
ULONG
Stream_CameraML_MediaFoundation_Stream_3::Release ()
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_MediaFoundation_Stream_3::Release"));
...
HRESULT
Stream_CameraML_MediaFoundation_Stream_3::GetParameters (DWORD* flags_out,
                                                           DWORD* queue_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_MediaFoundation_Stream_3::GetParameters"));
...
HRESULT
Stream_CameraML_MediaFoundation_Stream_3::Invoke (IMFAsyncResult* result_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_MediaFoundation_Stream_3::Invoke"));
...
bool
Stream_CameraML_MediaFoundation_Stream_3::load (Stream_ILayout* layout_in,
                                                bool& delete_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_MediaFoundation_Stream_3::load"));
...
bool
Stream_CameraML_MediaFoundation_Stream_3::initialize (const inherited::CONFIGURATION_T& configuration_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_MediaFoundation_Stream_3::initialize"));
  ...
  // ******************* Camera Source ************************
  source_impl_p =
    dynamic_cast<Stream_CameraML_MediaFoundation_Source*> (source_.writer ());
  if (!source_impl_p)
  {
    ACE_DEBUG ((LM_ERROR,
...
#else
Stream_CameraML_Stream_3::Stream_CameraML_Stream_3 ()
 : inherited ()
 , source_ (this,
...
bool
Stream_CameraML_Stream_3::load (Stream_ILayout* layout_in,
                                bool& delete_out)
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_Stream_3::load"));
...
bool
Stream_CameraML_Stream_3::initialize (const typename inherited::CONFIGURATION_T& configuration_in)
{
  STREAM_TRACE (ACE_TEXT ("Stream_CameraML_Stream_3::initialize"));
  ...
  bool setup_pipeline = configuration_in.configuration_->setupPipeline;
  bool reset_setup_pipeline = false;
  Stream_CameraML_V4L_SessionData* session_data_p = NULL;
  typename inherited::CONFIGURATION_T::ITERATOR_T iterator;
//  Stream_CameraML_V4L_Source* source_impl_p = NULL;
  ...
  session_data_p =
    &const_cast<Stream_CameraML_V4L_SessionData&> (inherited::sessionData_->getR ());
  iterator =
  ...
  // ******************* Camera Source ************************
//  source_impl_p =
//    dynamic_cast<Stream_CameraML_V4L_Source*> (source_.writer ());
//  if (!source_impl_p)
//  {
//    ACE_DEBUG ((LM_ERROR,
