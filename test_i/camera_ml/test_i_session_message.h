                                      ...
                                      struct Stream_UserData>
{
 ...
 public:
  ...
  Stream_CameraML_SessionMessage_T (Stream_SessionId_t,
                                    enum Stream_SessionMessageType,
                                    SessionDataType*&,   // session data container handle
                                    struct Stream_UserData*,
                                    bool); // expedited ?
  inline virtual ~Stream_CameraML_SessionMessage_T () {}
 ...
 private:
  // convenient types
  typedef Stream_CameraML_SessionMessage_T<DataMessageType,
                                           SessionDataType> OWN_TYPE_T;

  // copy ctor to be used by duplicate()
  Stream_CameraML_SessionMessage_T (const Stream_CameraML_SessionMessage_T<DataMessageType,
                                                                           SessionDataType>&);
  ...
  ACE_UNIMPLEMENTED_FUNC (Stream_CameraML_SessionMessage_T ())
  ACE_UNIMPLEMENTED_FUNC (Stream_CameraML_SessionMessage_T& operator= (const Stream_CameraML_SessionMessage_T&))
};
