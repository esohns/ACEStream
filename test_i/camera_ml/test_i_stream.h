...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
class Stream_CameraML_DirectShow_Stream
                        ...
                        Stream_CameraML_DirectShow_SessionMessage_t>
{
 ...
 public:
  Stream_CameraML_DirectShow_Stream ();
  inline virtual ~Stream_CameraML_DirectShow_Stream () { inherited::shutdown (); }
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Stream_CameraML_DirectShow_Stream (const Stream_CameraML_DirectShow_Stream&))
 ...
 , public IMFAsyncCallback
{
 ...
 public:
  Stream_CameraML_MediaFoundation_Stream ();
  virtual ~Stream_CameraML_MediaFoundation_Stream ();
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Stream_CameraML_MediaFoundation_Stream (const Stream_CameraML_MediaFoundation_Stream&))
  ACE_UNIMPLEMENTED_FUNC (Stream_CameraML_MediaFoundation_Stream& operator= (const Stream_CameraML_MediaFoundation_Stream&))
                        ...
                        Stream_CameraML_SessionMessage_t>
{
 ...
 public:
  Stream_CameraML_Stream ();
  inline virtual ~Stream_CameraML_Stream () { inherited::shutdown (); }
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Stream_CameraML_Stream (const Stream_CameraML_Stream&))
  ACE_UNIMPLEMENTED_FUNC (Stream_CameraML_Stream& operator= (const Stream_CameraML_Stream&))
